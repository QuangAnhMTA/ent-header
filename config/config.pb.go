...
var file_config_proto_rawDesc = []byte{
	...
	0x32, 0x82, 0x0a, 0x0a, 0x0d, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x72, 0x6f, 0x75, 0x70, 0x73, 0x42, 0x2a, 0x5a, 0x28, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_config_proto_depIdxs = []int32{
	...
	16, // 55: config.ConfigService.CheckRegisterAccount:output_type -> config.CheckRegisterAccountResponse
	18, // 56: config.ConfigService.VerifyOtpRegister:output_type -> config.VerifyOtpRegisterResponse
	13, // 57: config.ConfigService.RegisterAccount:output_type -> config.Account
	22, // 58: config.ConfigService.Login:output_type -> config.LoginAccountResponse
	23, // 59: config.ConfigService.MemberLogin:output_type -> config.LoginMemberResponse
	26, // 60: config.ConfigService.ChangeMemberPassword:output_type -> config.Member
	14, // 61: config.ConfigService.ListAccounts:output_type -> config.Accounts
	13, // 62: config.ConfigService.UpdateAccount:output_type -> config.Account
	27, // 63: config.ConfigService.ListMembers:output_type -> config.Members
	26, // 64: config.ConfigService.CreateMember:output_type -> config.Member
	26, // 65: config.ConfigService.GetMember:output_type -> config.Member
	30, // 66: config.ConfigService.ListCategories:output_type -> config.Categories
	37, // 67: config.ConfigService.CreateMemberCategory:output_type -> config.MemberCategory
	37, // 68: config.ConfigService.GetMemberCategory:output_type -> config.MemberCategory
	39, // 69: config.ConfigService.ListMemberCategories:output_type -> config.MemberCategories
	59, // 70: config.ConfigService.ListMemberPractice:output_type -> config.MemberPractices
	57, // 71: config.ConfigService.CreateMemberPractice:output_type -> config.MemberPractice
	42, // 72: config.ConfigService.ListGroup:output_type -> config.Groups
	48, // 73: config.ConfigService.ListMemberGroup:output_type -> config.MemberGroups
