...
var file_config_proto_rawDesc = []byte{
	...
	0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x32, 0xc3,
	0x08, 0x0a, 0x0d, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	0x6f, 0x72, 0x69, 0x65, 0x73, 0x12, 0x4d, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x4d, 0x65, 0x6d,
	0x62, 0x65, 0x72, 0x50, 0x72, 0x61, 0x63, 0x74, 0x69, 0x63, 0x65, 0x73, 0x12, 0x1d, 0x2e, 0x63,
	...
	0x69, 0x63, 0x65, 0x73, 0x42, 0x2a, 0x5a, 0x28, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_config_proto_depIdxs = []int32{
	...
	53, // 45: config.ConfigService.ListMemberPractices:input_type -> config.MemberPracticeRequest
	14, // 46: config.ConfigService.CheckRegisterAccount:output_type -> config.CheckRegisterAccountResponse
	16, // 47: config.ConfigService.VerifyOtpRegister:output_type -> config.VerifyOtpRegisterResponse
	11, // 48: config.ConfigService.RegisterAccount:output_type -> config.Account
	20, // 49: config.ConfigService.Login:output_type -> config.LoginAccountResponse
	21, // 50: config.ConfigService.MemberLogin:output_type -> config.LoginMemberResponse
	24, // 51: config.ConfigService.ChangeMemberPassword:output_type -> config.Member
	12, // 52: config.ConfigService.ListAccounts:output_type -> config.Accounts
	11, // 53: config.ConfigService.UpdateAccount:output_type -> config.Account
	25, // 54: config.ConfigService.ListMembers:output_type -> config.Members
	24, // 55: config.ConfigService.CreateMember:output_type -> config.Member
	24, // 56: config.ConfigService.GetMember:output_type -> config.Member
	28, // 57: config.ConfigService.ListCategories:output_type -> config.Categories
	35, // 58: config.ConfigService.CreateMemberCategory:output_type -> config.MemberCategory
	35, // 59: config.ConfigService.GetMemberCategory:output_type -> config.MemberCategory
	37, // 60: config.ConfigService.ListMemberCategories:output_type -> config.MemberCategories
	54, // 61: config.ConfigService.ListMemberPractices:output_type -> config.MemberPractices
