...
type GroupParagraph_Status int32

const (
	GroupParagraph_default_state GroupParagraph_Status = 0
	GroupParagraph_deactive      GroupParagraph_Status = 1
	GroupParagraph_active        GroupParagraph_Status = 2
)

// Enum value maps for GroupParagraph_Status.
var (
	GroupParagraph_Status_name = map[int32]string{
		0: "default_state",
		1: "deactive",
		2: "active",
	}
	GroupParagraph_Status_value = map[string]int32{
		"default_state": 0,
		"deactive":      1,
		"active":        2,
	}
...
func (x GroupParagraph_Status) Enum() *GroupParagraph_Status {
	p := new(GroupParagraph_Status)
	*p = x
	return p
}

func (x GroupParagraph_Status) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (GroupParagraph_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_config_proto_enumTypes[14].Descriptor()
}

func (GroupParagraph_Status) Type() protoreflect.EnumType {
	return &file_config_proto_enumTypes[14]
}

func (x GroupParagraph_Status) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use GroupParagraph_Status.Descriptor instead.
func (GroupParagraph_Status) EnumDescriptor() ([]byte, []int) {
	return file_config_proto_rawDescGZIP(), []int{55, 0}
}

type GroupParagraph_ApproveProcess int32

const (
	GroupParagraph_default_approved GroupParagraph_ApproveProcess = 0
	GroupParagraph_not_approved     GroupParagraph_ApproveProcess = 1
	GroupParagraph_yes_approved     GroupParagraph_ApproveProcess = 2
	GroupParagraph_again_approved   GroupParagraph_ApproveProcess = 3
)

// Enum value maps for GroupParagraph_ApproveProcess.
var (
	GroupParagraph_ApproveProcess_name = map[int32]string{
		0: "default_approved",
		1: "not_approved",
		2: "yes_approved",
		3: "again_approved",
	}
	GroupParagraph_ApproveProcess_value = map[string]int32{
		"default_approved": 0,
		"not_approved":     1,
		"yes_approved":     2,
		"again_approved":   3,
...
func (x GroupParagraph_ApproveProcess) Enum() *GroupParagraph_ApproveProcess {
	p := new(GroupParagraph_ApproveProcess)
	*p = x
	return p
}

func (x GroupParagraph_ApproveProcess) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (GroupParagraph_ApproveProcess) Descriptor() protoreflect.EnumDescriptor {
	return file_config_proto_enumTypes[15].Descriptor()
}

func (GroupParagraph_ApproveProcess) Type() protoreflect.EnumType {
	return &file_config_proto_enumTypes[15]
}

func (x GroupParagraph_ApproveProcess) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use GroupParagraph_ApproveProcess.Descriptor instead.
func (GroupParagraph_ApproveProcess) EnumDescriptor() ([]byte, []int) {
...
type GroupParagraph struct {
	...
	Id             int64                         `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty" gorm:"primaryKey;not null;autoIncrement"`
	GroupId        int64                         `protobuf:"varint,2,opt,name=group_id,json=groupId,proto3" json:"group_id,omitempty"`
	ParagraphId    int64                         `protobuf:"varint,3,opt,name=paragraph_id,json=paragraphId,proto3" json:"paragraph_id,omitempty"`
	Title          string                        `protobuf:"bytes,4,opt,name=title,proto3" json:"title,omitempty"`
	Status         GroupParagraph_Status         `protobuf:"varint,5,opt,name=status,proto3,enum=config.GroupParagraph_Status" json:"status,omitempty"`
	ApproveProcess GroupParagraph_ApproveProcess `protobuf:"varint,6,opt,name=approve_process,json=approveProcess,proto3,enum=config.GroupParagraph_ApproveProcess" json:"approve_process,omitempty"`
	// `gorm:"-"`
	Group *Group `protobuf:"bytes,7,opt,name=group,proto3" json:"group,omitempty" gorm:"-"`
	// `gorm:"-"`
	Paragraph *library.Paragraph `protobuf:"bytes,8,opt,name=paragraph,proto3" json:"paragraph,omitempty" gorm:"-"`
	Position  int32              `protobuf:"varint,9,opt,name=position,proto3" json:"position,omitempty"`
	CreatedAt int64              `protobuf:"varint,10,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"`
	UpdatedAt int64              `protobuf:"varint,11,opt,name=updated_at,json=updatedAt,proto3" json:"updated_at,omitempty"`
}

func (x *GroupParagraph) Reset() {
	*x = GroupParagraph{}
	if protoimpl.UnsafeEnabled {
...
func (x *GroupParagraph) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GroupParagraph) ProtoMessage() {}

func (x *GroupParagraph) ProtoReflect() protoreflect.Message {
	mi := &file_config_proto_msgTypes[55]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GroupParagraph.ProtoReflect.Descriptor instead.
func (*GroupParagraph) Descriptor() ([]byte, []int) {
	return file_config_proto_rawDescGZIP(), []int{55}
}

func (x *GroupParagraph) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *GroupParagraph) GetGroupId() int64 {
	if x != nil {
		return x.GroupId
	}
	return 0
...
func (x *GroupParagraph) GetParagraphId() int64 {
	if x != nil {
		return x.ParagraphId
	}
	return 0
...
func (x *GroupParagraph) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *GroupParagraph) GetStatus() GroupParagraph_Status {
	if x != nil {
		return x.Status
	}
	return GroupParagraph_default_state
}

func (x *GroupParagraph) GetApproveProcess() GroupParagraph_ApproveProcess {
	if x != nil {
		return x.ApproveProcess
	}
	return GroupParagraph_default_approved
}

func (x *GroupParagraph) GetGroup() *Group {
	if x != nil {
		return x.Group
	}
	return nil
...
func (x *GroupParagraph) GetParagraph() *library.Paragraph {
	if x != nil {
		return x.Paragraph
	}
	return nil
...
func (x *GroupParagraph) GetPosition() int32 {
	if x != nil {
		return x.Position
	}
	return 0
...
func (x *GroupParagraph) GetCreatedAt() int64 {
	if x != nil {
		return x.CreatedAt
	}
	return 0
...
func (x *GroupParagraph) GetUpdatedAt() int64 {
	if x != nil {
		return x.UpdatedAt
	}
	return 0
...
type GroupParagraphRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GroupParagraphRequest) Reset() {
	*x = GroupParagraphRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GroupParagraphRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GroupParagraphRequest) ProtoMessage() {}

func (x *GroupParagraphRequest) ProtoReflect() protoreflect.Message {
	mi := &file_config_proto_msgTypes[56]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GroupParagraphRequest.ProtoReflect.Descriptor instead.
func (*GroupParagraphRequest) Descriptor() ([]byte, []int) {
	return file_config_proto_rawDescGZIP(), []int{56}
}

func (x *GroupParagraphRequest) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *GroupParagraphRequest) GetGroupId() int64 {
	if x != nil {
		return x.GroupId
	}
	return 0
...
func (x *GroupParagraphRequest) GetParagraphId() int64 {
	if x != nil {
		return x.ParagraphId
	}
	return 0
...
func (x *GroupParagraphRequest) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *GroupParagraphRequest) GetStatus() int32 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *GroupParagraphRequest) GetApproveProcess() int32 {
	if x != nil {
		return x.ApproveProcess
	}
	return 0
...
func (x *GroupParagraphRequest) GetLimit() int32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
func (x *GroupParagraphRequest) GetOffset() int32 {
	if x != nil {
		return x.Offset
	}
	return 0
...
func (x *GroupParagraphRequest) GetIds() []int64 {
	if x != nil {
		return x.Ids
	}
	return nil
...
func (x *GroupParagraphRequest) GetCols() []string {
	if x != nil {
		return x.Cols
	}
	return nil
...
func (x *GroupParagraphRequest) GetIncludes() []string {
	if x != nil {
		return x.Includes
	}
	return nil
...
func (x *GroupParagraphRequest) GetGroupIds() []int64 {
	if x != nil {
		return x.GroupIds
	}
	return nil
...
func (x *GroupParagraphRequest) GetParagraphIds() []int64 {
	if x != nil {
		return x.ParagraphIds
	}
	return nil
...
type GroupParagraphs struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	GroupParagraphs []*GroupParagraph `protobuf:"bytes,1,rep,name=group_paragraphs,json=groupParagraphs,proto3" json:"group_paragraphs,omitempty"`
	Total           int32             `protobuf:"varint,2,opt,name=total,proto3" json:"total,omitempty"`
}

func (x *GroupParagraphs) Reset() {
	*x = GroupParagraphs{}
	if protoimpl.UnsafeEnabled {
...
func (x *GroupParagraphs) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GroupParagraphs) ProtoMessage() {}

func (x *GroupParagraphs) ProtoReflect() protoreflect.Message {
	mi := &file_config_proto_msgTypes[57]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GroupParagraphs.ProtoReflect.Descriptor instead.
func (*GroupParagraphs) Descriptor() ([]byte, []int) {
	return file_config_proto_rawDescGZIP(), []int{57}
}

func (x *GroupParagraphs) GetGroupParagraphs() []*GroupParagraph {
	if x != nil {
		return x.GroupParagraphs
	}
	return nil
}

func (x *GroupParagraphs) GetTotal() int32 {
	if x != nil {
		return x.Total
	}
	return 0
...
var file_config_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x5f, 0x0a, 0x06, 0x43, 0x6c, 0x61, 0x69, 0x6d, 0x73, 0x12,
	0x1b, 0x0a, 0x09, 0x61, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x08, 0x61, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x1b, 0x0a, 0x09,
	0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x08, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x49, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x6d, 0x65, 0x6d,
	0x62, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x6d, 0x65,
	0x6d, 0x62, 0x65, 0x72, 0x49, 0x64, 0x22, 0xc6, 0x02, 0x0a, 0x0e, 0x41, 0x63, 0x63, 0x6f, 0x75,
	...
	0x49, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x66, 0x75, 0x6c, 0x6c, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x03,
	...
	0xc0, 0x02, 0x0a, 0x07, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	0x75, 0x6c, 0x6c, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x76, 0x61, 0x74, 0x61,
	...
	0x32, 0x16, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	...
	0x03, 0x52, 0x06, 0x72, 0x6f, 0x6c, 0x65, 0x49, 0x64, 0x12, 0x20, 0x0a, 0x04, 0x72, 0x6f, 0x6c,
	0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	0x2e, 0x52, 0x6f, 0x6c, 0x65, 0x52, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x22, 0x35, 0x0a, 0x06, 0x53,
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x49, 0x64, 0x22, 0xf6, 0x01,
	...
	0x76, 0x69, 0x63, 0x65, 0x49, 0x64, 0x22, 0xf3, 0x01, 0x0a, 0x13, 0x4c, 0x6f, 0x67, 0x69, 0x6e,
	...
	,
	...
	0x74, 0x75, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x08, 0x20, 0x01,
	...
	0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x73, 0x12, 0x10, 0x0a, 0x03, 0x69, 0x64, 0x73, 0x18, 0x0d,
	0x20, 0x03, 0x28, 0x03, 0x52, 0x03, 0x69, 0x64, 0x73, 0x12, 0x1a, 0x0a, 0x08, 0x6e, 0x69, 0x63,
	0x6b, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x6e, 0x69, 0x63,
	0x6b, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x17, 0x0a, 0x07, 0x69, 0x73, 0x5f, 0x6d, 0x61, 0x69, 0x6e,
	0x18, 0x0f, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x69, 0x73, 0x4d, 0x61, 0x69, 0x6e, 0x12, 0x1d,
	0x0a, 0x0a, 0x69, 0x73, 0x5f, 0x6f, 0x6e, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x18, 0x10, 0x20, 0x01,
	0x28, 0x05, 0x52, 0x09, 0x69, 0x73, 0x4f, 0x6e, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x22, 0x8a, 0x03,
	...
	0x61, 0x6d, 0x65, 0x22, 0x35, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x11, 0x0a,
	...
	0x0a, 0x06, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x10, 0x02, 0x22, 0x49, 0x0a, 0x07, 0x4d, 0x65,
	0x6d, 0x62, 0x65, 0x72, 0x73, 0x12, 0x28, 0x0a, 0x07, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x73,
	...
	0x74, 0x6f, 0x74, 0x61, 0x6c, 0x22, 0xc9, 0x03, 0x0a, 0x08, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f,
	...
	0x69, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x56, 0x69,
	0x12, 0x12, 0x0a, 0x04, 0x6b, 0x65, 0x79, 0x78, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04,
	0x6b, 0x65, 0x79, 0x78, 0x12, 0x16, 0x0a, 0x06, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x78, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x78, 0x12, 0x1a, 0x0a, 0x08,
	0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08,
	...
	0x61, 0x74, 0x75, 0x73, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x17, 0x2e, 0x63, 0x6f, 0x6e,
	0x66, 0x69, 0x67, 0x2e, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x2e, 0x53, 0x74, 0x61,
	...
	0x3f, 0x0a, 0x0c, 0x69, 0x73, 0x5f, 0x66, 0x61, 0x76, 0x6f, 0x75, 0x72, 0x69, 0x74, 0x65, 0x18,
	0x0a, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x43,
	0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x2e, 0x49, 0x73, 0x46, 0x61, 0x76, 0x6f, 0x75, 0x72,
	...
	0x02, 0x22, 0xd3, 0x02, 0x0a, 0x0f, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x52, 0x65,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6b, 0x65, 0x79, 0x78, 0x12, 0x16, 0x0a, 0x06,
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x78, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x76, 0x61,
	0x6c, 0x75, 0x65, 0x78, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e,
	0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x72, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x73, 0x22, 0x54, 0x0a, 0x0a, 0x43, 0x61, 0x74, 0x65, 0x67,
	0x6f, 0x72, 0x69, 0x65, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x12, 0x30, 0x0a, 0x0a, 0x63,
	0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x69, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x10, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72,
	0x79, 0x52, 0x0a, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x69, 0x65, 0x73, 0x22, 0xf4, 0x01,
	...
	,
	...
	0x65, 0x6e, 0x74, 0x49, 0x64, 0x73, 0x22, 0xfd, 0x01, 0x0a, 0x06, 0x41, 0x63, 0x63, 0x65, 0x73,
	...
	0x69, 0x6e, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x61, 0x67, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x04, 0x70, 0x61, 0x67, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x20,
	...
	0x32, 0x15, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73,
	...
	0x74, 0x69, 0x76, 0x65, 0x10, 0x02, 0x22, 0xb3, 0x02, 0x0a, 0x0d, 0x41, 0x63, 0x63, 0x65, 0x73,
	...
	0x09, 0x52, 0x06, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x61, 0x67,
	0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x61, 0x67, 0x65, 0x12, 0x16, 0x0a,
	...
	0x0a, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x73, 0x18, 0x0e, 0x20, 0x03, 0x28,
	0x03, 0x52, 0x09, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x73, 0x22, 0x4c, 0x0a, 0x08,
	0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x65, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x74, 0x61,
	...
	0x32, 0x0e, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73,
	0x52, 0x08, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x65, 0x73, 0x22, 0xa2, 0x02, 0x0a, 0x0e, 0x4d,
	0x65, 0x6d, 0x62, 0x65, 0x72, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x12, 0x0e, 0x0a,
	...
	0x03, 0x52, 0x08, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x49, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x76,
	0x61, 0x6c, 0x75, 0x65, 0x78, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x76, 0x61, 0x6c,
	0x75, 0x65, 0x78, 0x12, 0x1d, 0x0a, 0x0a, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x5f, 0x61,
	...
	0x74, 0x12, 0x35, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x1d, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x4d, 0x65, 0x6d, 0x62, 0x65,
	0x72, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
	...
	0xa4, 0x03, 0x0a, 0x15, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f,
	...
	0x74, 0x49, 0x64, 0x73, 0x12, 0x21, 0x0a, 0x0c, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79,
	0x5f, 0x69, 0x64, 0x73, 0x18, 0x0f, 0x20, 0x03, 0x28, 0x03, 0x52, 0x0b, 0x63, 0x61, 0x74, 0x65,
	0x67, 0x6f, 0x72, 0x79, 0x49, 0x64, 0x73, 0x12, 0x1d, 0x0a, 0x0a, 0x6d, 0x65, 0x6d, 0x62, 0x65,
	0x72, 0x5f, 0x69, 0x64, 0x73, 0x18, 0x10, 0x20, 0x03, 0x28, 0x03, 0x52, 0x09, 0x6d, 0x65, 0x6d,
	0x62, 0x65, 0x72, 0x49, 0x64, 0x73, 0x22, 0x6d, 0x0a, 0x10, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72,
	...
	0x12, 0x43, 0x0a, 0x11, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x5f, 0x63, 0x61, 0x74, 0x65, 0x67,
	0x6f, 0x72, 0x69, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x63, 0x6f,
	0x6e, 0x66, 0x69, 0x67, 0x2e, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x43, 0x61, 0x74, 0x65, 0x67,
	0x6f, 0x72, 0x79, 0x52, 0x10, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x43, 0x61, 0x74, 0x65, 0x67,
	0x6f, 0x72, 0x69, 0x65, 0x73, 0x22, 0xb2, 0x04, 0x0a, 0x05, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x12,
	...
	0x14, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x2e, 0x53,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x26, 0x0a,
	0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x12, 0x2e, 0x63, 0x6f,
	0x6e, 0x66, 0x69, 0x67, 0x2e, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x2e, 0x54, 0x79, 0x70, 0x65, 0x52,
	0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x3b, 0x0a, 0x0e, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	0x5f, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e,
	...
	,
	...
	0x01, 0x12, 0x0a, 0x0a, 0x06, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x10, 0x02, 0x22, 0x3b, 0x0a,
	0x04, 0x54, 0x79, 0x70, 0x65, 0x12, 0x10, 0x0a, 0x0c, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74,
	0x5f, 0x74, 0x79, 0x70, 0x65, 0x10, 0x00, 0x12, 0x0a, 0x0a, 0x06, 0x73, 0x63, 0x68, 0x6f, 0x6f,
	0x6c, 0x10, 0x01, 0x12, 0x0a, 0x0a, 0x06, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x10, 0x02, 0x12,
	0x09, 0x0a, 0x05, 0x73, 0x6d, 0x61, 0x6c, 0x6c, 0x10, 0x03, 0x22, 0xdc, 0x02, 0x0a, 0x0c, 0x47,
	...
	,
	...
	0x74, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x10, 0x0a, 0x03, 0x69, 0x64, 0x73, 0x18, 0x0d,
	...
	0x08, 0x69, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x73, 0x22, 0x77, 0x0a, 0x06, 0x47, 0x72, 0x6f,
	...
	0x6e, 0x74, 0x22, 0xcc, 0x02, 0x0a, 0x0c, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x47, 0x72,
	...
	0x6f, 0x75, 0x70, 0x52, 0x05, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x22, 0x35, 0x0a, 0x06, 0x53, 0x74,
	...
	0x02, 0x22, 0xbc, 0x02, 0x0a, 0x13, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x47, 0x72, 0x6f,
	...
	0x74, 0x49, 0x64, 0x12, 0x17, 0x0a, 0x07, 0x72, 0x6f, 0x6c, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x72, 0x6f, 0x6c, 0x65, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x0a,
	...
	0x28, 0x05, 0x52, 0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x6f, 0x66, 0x66,
	0x73, 0x65, 0x74, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x6f, 0x66, 0x66, 0x73, 0x65,
	0x74, 0x12, 0x10, 0x0a, 0x03, 0x69, 0x64, 0x73, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x03, 0x52, 0x03,
	0x69, 0x64, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x63, 0x6f, 0x6c, 0x73, 0x18, 0x0b, 0x20, 0x03, 0x28,
	...
	,
	...
	,
	...
	,
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x6f,
	0x66, 0x66, 0x73, 0x65, 0x74, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x6f, 0x66, 0x66,
	0x73, 0x65, 0x74, 0x12, 0x27, 0x0a, 0x0f, 0x61, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x65, 0x5f, 0x70,
	0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0e, 0x61, 0x70,
	0x70, 0x72, 0x6f, 0x76, 0x65, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x12, 0x10, 0x0a, 0x03,
	...
	0x20, 0x03, 0x28, 0x09, 0x52, 0x08, 0x69, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x73, 0x22, 0x48,
	...
	0x61, 0x75, 0x6c, 0x74, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x10, 0x00, 0x12, 0x0c, 0x0a, 0x08,
	0x64, 0x65, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x10, 0x01, 0x12, 0x0a, 0x0a, 0x06, 0x61, 0x63,
	0x74, 0x69, 0x76, 0x65, 0x10, 0x02, 0x22, 0xe0, 0x03, 0x0a, 0x16, 0x41, 0x63, 0x63, 0x6f, 0x75,
	...
	,
	...
	,
	...
	0x74, 0x12, 0x35, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x0b, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x1d, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x4d, 0x65, 0x6d, 0x62, 0x65,
	0x72, 0x45, 0x78, 0x65, 0x72, 0x63, 0x69, 0x73, 0x65, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
	0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x30, 0x0a, 0x09, 0x70, 0x61, 0x72, 0x61,
	0x67, 0x72, 0x61, 0x70, 0x68, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x6c, 0x69,
	...
	,
	...
	,
	...
	0x10, 0x0a, 0x03, 0x69, 0x64, 0x73, 0x18, 0x13, 0x20, 0x03, 0x28, 0x03, 0x52, 0x03, 0x69, 0x64,
	0x73, 0x12, 0x12, 0x0a, 0x04, 0x63, 0x6f, 0x6c, 0x73, 0x18, 0x14, 0x20, 0x03, 0x28, 0x09, 0x52,
	...
	0x73, 0x12, 0x30, 0x0a, 0x14, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x65, 0x78, 0x65,
	0x72, 0x63, 0x69, 0x73, 0x65, 0x5f, 0x69, 0x64, 0x73, 0x18, 0x0e, 0x20, 0x03, 0x28, 0x03, 0x52,
	0x12, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x45, 0x78, 0x65, 0x72, 0x63, 0x69, 0x73, 0x65,
	...
	,
	...
	0x67, 0x72, 0x6f, 0x75, 0x70, 0x49, 0x64, 0x12, 0x21, 0x0a, 0x0c, 0x70, 0x61, 0x72, 0x61, 0x67,
	0x72, 0x61, 0x70, 0x68, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0b, 0x70,
	0x61, 0x72, 0x61, 0x67, 0x72, 0x61, 0x70, 0x68, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x69,
	...
	0x32, 0x1d, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x50,
	0x61, 0x72, 0x61, 0x67, 0x72, 0x61, 0x70, 0x68, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52,
	0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x4e, 0x0a, 0x0f, 0x61, 0x70, 0x70, 0x72, 0x6f,
	0x76, 0x65, 0x5f, 0x70, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0e,
	0x32, 0x25, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x50,
	0x61, 0x72, 0x61, 0x67, 0x72, 0x61, 0x70, 0x68, 0x2e, 0x41, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x65,
	...
	0x47, 0x72, 0x6f, 0x75, 0x70, 0x52, 0x05, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x12, 0x30, 0x0a, 0x09,
	0x70, 0x61, 0x72, 0x61, 0x67, 0x72, 0x61, 0x70, 0x68, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x12, 0x2e, 0x6c, 0x69, 0x62, 0x72, 0x61, 0x72, 0x79, 0x2e, 0x50, 0x61, 0x72, 0x61, 0x67, 0x72,
	0x61, 0x70, 0x68, 0x52, 0x09, 0x70, 0x61, 0x72, 0x61, 0x67, 0x72, 0x61, 0x70, 0x68, 0x12, 0x1a,
	...
	0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x35, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x12, 0x11, 0x0a, 0x0d, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x5f, 0x73, 0x74,
	0x61, 0x74, 0x65, 0x10, 0x00, 0x12, 0x0c, 0x0a, 0x08, 0x64, 0x65, 0x61, 0x63, 0x74, 0x69, 0x76,
	0x65, 0x10, 0x01, 0x12, 0x0a, 0x0a, 0x06, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x10, 0x02, 0x22,
	0x5e, 0x0a, 0x0e, 0x41, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x65, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73,
	0x73, 0x12, 0x14, 0x0a, 0x10, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x5f, 0x61, 0x70, 0x70,
	...
	0xee, 0x02, 0x0a, 0x15, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x50, 0x61, 0x72, 0x61, 0x67, 0x72, 0x61,
	0x70, 0x68, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x19, 0x0a, 0x08, 0x67, 0x72, 0x6f,
	0x75, 0x70, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x67, 0x72, 0x6f,
	0x75, 0x70, 0x49, 0x64, 0x12, 0x21, 0x0a, 0x0c, 0x70, 0x61, 0x72, 0x61, 0x67, 0x72, 0x61, 0x70,
	0x68, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0b, 0x70, 0x61, 0x72, 0x61,
	0x67, 0x72, 0x61, 0x70, 0x68, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65,
	...
	,
	...
	,
	...
	0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x12, 0x38, 0x0a, 0x0d, 0x55, 0x70, 0x64, 0x61,
	0x74, 0x65, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x16, 0x2e, 0x63, 0x6f, 0x6e, 0x66,
	...
	,
	...
	,
	...
	0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x45, 0x78,
	0x65, 0x72, 0x63, 0x69, 0x73, 0x65, 0x73, 0x12, 0x47, 0x0a, 0x14, 0x43, 0x72, 0x65, 0x61, 0x74,
	0x65, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x45, 0x78, 0x65, 0x72, 0x63, 0x69, 0x73, 0x65, 0x12,
	0x16, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x45,
	0x78, 0x65, 0x72, 0x63, 0x69, 0x73, 0x65, 0x1a, 0x17, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	0x2e, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x45, 0x78, 0x65, 0x72, 0x63, 0x69, 0x73, 0x65, 0x73,
	0x12, 0x52, 0x0a, 0x18, 0x4c, 0x69, 0x73, 0x74, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x4d, 0x65,
	...
	,
...
var file_config_proto_goTypes = []interface{}{
	...
	(Group_Status)(0),                    // 6: config.Group.Status
	(Group_Type)(0),                      // 7: config.Group.Type
	(AccountGroup_Status)(0),             // 8: config.AccountGroup.Status
	(MemberGroup_Status)(0),              // 9: config.MemberGroup.Status
	(MemberGroup_ApproveProcess)(0),      // 10: config.MemberGroup.ApproveProcess
	(Token_Status)(0),                    // 11: config.Token.Status
	(AccountExercise_Status)(0),          // 12: config.AccountExercise.Status
	(MemberExercise_Status)(0),           // 13: config.MemberExercise.Status
	(GroupParagraph_Status)(0),           // 14: config.GroupParagraph.Status
	(GroupParagraph_ApproveProcess)(0),   // 15: config.GroupParagraph.ApproveProcess
	(*Claims)(nil),                       // 16: config.Claims
	(*AccountRequest)(nil),               // 17: config.AccountRequest
	(*Account)(nil),                      // 18: config.Account
	(*Accounts)(nil),                     // 19: config.Accounts
	(*CheckRegisterAccountRequest)(nil),  // 20: config.CheckRegisterAccountRequest
	(*CheckRegisterAccountResponse)(nil), // 21: config.CheckRegisterAccountResponse
	(*VerifyOtpRegisterRequest)(nil),     // 22: config.VerifyOtpRegisterRequest
	(*VerifyOtpRegisterResponse)(nil),    // 23: config.VerifyOtpRegisterResponse
	(*RegisterAccountRequest)(nil),       // 24: config.RegisterAccountRequest
	(*RegisterAccountResponse)(nil),      // 25: config.RegisterAccountResponse
	(*LoginAccountRequest)(nil),          // 26: config.LoginAccountRequest
	(*LoginAccountResponse)(nil),         // 27: config.LoginAccountResponse
	(*LoginMemberResponse)(nil),          // 28: config.LoginMemberResponse
	(*AccessToken)(nil),                  // 29: config.AccessToken
	(*MemberRequest)(nil),                // 30: config.MemberRequest
	(*Member)(nil),                       // 31: config.Member
	(*Members)(nil),                      // 32: config.Members
	(*Category)(nil),                     // 33: config.Category
	(*CategoryRequest)(nil),              // 34: config.CategoryRequest
	(*Categories)(nil),                   // 35: config.Categories
	(*Role)(nil),                         // 36: config.Role
	(*Roles)(nil),                        // 37: config.Roles
	(*RoleRequest)(nil),                  // 38: config.RoleRequest
	(*Access)(nil),                       // 39: config.Access
	(*AccessRequest)(nil),                // 40: config.AccessRequest
	(*Accesses)(nil),                     // 41: config.Accesses
	(*MemberCategory)(nil),               // 42: config.MemberCategory
	(*MemberCategoryRequest)(nil),        // 43: config.MemberCategoryRequest
	(*MemberCategories)(nil),             // 44: config.MemberCategories
	(*Group)(nil),                        // 45: config.Group
	(*GroupRequest)(nil),                 // 46: config.GroupRequest
	(*Groups)(nil),                       // 47: config.Groups
	(*AccountGroup)(nil),                 // 48: config.AccountGroup
	(*AccountGroupRequest)(nil),          // 49: config.AccountGroupRequest
	(*AccountGroups)(nil),                // 50: config.AccountGroups
	(*MemberGroup)(nil),                  // 51: config.MemberGroup
	(*MemberGroupRequest)(nil),           // 52: config.MemberGroupRequest
	(*MemberGroups)(nil),                 // 53: config.MemberGroups
	(*Token)(nil),                        // 54: config.Token
	(*TokenRequest)(nil),                 // 55: config.TokenRequest
	(*Tokens)(nil),                       // 56: config.Tokens
	(*AccountToken)(nil),                 // 57: config.AccountToken
	(*AccountTokenRequest)(nil),          // 58: config.AccountTokenRequest
	(*AccountTokens)(nil),                // 59: config.AccountTokens
	(*MemberToken)(nil),                  // 60: config.MemberToken
	(*MemberTokenRequest)(nil),           // 61: config.MemberTokenRequest
	(*MemberPractice)(nil),               // 62: config.MemberPractice
	(*MemberPracticeRequest)(nil),        // 63: config.MemberPracticeRequest
	(*MemberPractices)(nil),              // 64: config.MemberPractices
	(*AccountExercise)(nil),              // 65: config.AccountExercise
	(*AccountExerciseRequest)(nil),       // 66: config.AccountExerciseRequest
	(*AccountExercises)(nil),             // 67: config.AccountExercises
	(*MemberExercise)(nil),               // 68: config.MemberExercise
	(*MemberExerciseRequest)(nil),        // 69: config.MemberExerciseRequest
	(*MemberExercises)(nil),              // 70: config.MemberExercises
	(*GroupParagraph)(nil),               // 71: config.GroupParagraph
	(*GroupParagraphRequest)(nil),        // 72: config.GroupParagraphRequest
	(*GroupParagraphs)(nil),              // 73: config.GroupParagraphs
	nil,                                  // 74: config.Role.ListAccessEntry
	(*library.Paragraph)(nil),            // 75: library.Paragraph
}
var file_config_proto_depIdxs = []int32{
	0,  // 0: config.Account.status:type_name -> config.Account.Status
	36, // 1: config.Account.role:type_name -> config.Role
	18, // 2: config.Accounts.accounts:type_name -> config.Account
	16, // 3: config.LoginAccountResponse.claim:type_name -> config.Claims
	18, // 4: config.LoginAccountResponse.account:type_name -> config.Account
	31, // 5: config.LoginAccountResponse.members:type_name -> config.Member
	16, // 6: config.LoginMemberResponse.claim:type_name -> config.Claims
	18, // 7: config.LoginMemberResponse.account:type_name -> config.Account
	31, // 8: config.LoginMemberResponse.member:type_name -> config.Member
	16, // 9: config.AccessToken.claims:type_name -> config.Claims
	1,  // 10: config.Member.status:type_name -> config.Member.Status
	31, // 11: config.Members.members:type_name -> config.Member
	...
	33, // 14: config.Categories.categories:type_name -> config.Category
	41, // 15: config.Role.accesses:type_name -> config.Accesses
	74, // 16: config.Role.list_access:type_name -> config.Role.ListAccessEntry
	36, // 17: config.Roles.roles:type_name -> config.Role
	4,  // 18: config.Access.status:type_name -> config.Access.Status
	39, // 19: config.Accesses.accesses:type_name -> config.Access
	5,  // 20: config.MemberCategory.status:type_name -> config.MemberCategory.Status
	42, // 21: config.MemberCategories.member_categories:type_name -> config.MemberCategory
	6,  // 22: config.Group.status:type_name -> config.Group.Status
	7,  // 23: config.Group.type:type_name -> config.Group.Type
	48, // 24: config.Group.account_groups:type_name -> config.AccountGroup
	51, // 25: config.Group.member_groups:type_name -> config.MemberGroup
	45, // 26: config.Groups.groups:type_name -> config.Group
	45, // 27: config.Groups.group_parent:type_name -> config.Group
	8,  // 28: config.AccountGroup.status:type_name -> config.AccountGroup.Status
	18, // 29: config.AccountGroup.account:type_name -> config.Account
	45, // 30: config.AccountGroup.group:type_name -> config.Group
	48, // 31: config.AccountGroups.account_groups:type_name -> config.AccountGroup
	9,  // 32: config.MemberGroup.status:type_name -> config.MemberGroup.Status
	10, // 33: config.MemberGroup.approve_process:type_name -> config.MemberGroup.ApproveProcess
	31, // 34: config.MemberGroup.member:type_name -> config.Member
	45, // 35: config.MemberGroup.group:type_name -> config.Group
	51, // 36: config.MemberGroups.member_groups:type_name -> config.MemberGroup
	11, // 37: config.Token.status:type_name -> config.Token.Status
	54, // 38: config.Tokens.tokens:type_name -> config.Token
	57, // 39: config.AccountTokens.account_tokens:type_name -> config.AccountToken
	62, // 40: config.MemberPractices.member_practices:type_name -> config.MemberPractice
	12, // 41: config.AccountExercise.status:type_name -> config.AccountExercise.Status
	75, // 42: config.AccountExercise.paragraph:type_name -> library.Paragraph
	18, // 43: config.AccountExercise.account:type_name -> config.Account
	45, // 44: config.AccountExercise.Group:type_name -> config.Group
	65, // 45: config.AccountExercises.account_exercises:type_name -> config.AccountExercise
	13, // 46: config.MemberExercise.status:type_name -> config.MemberExercise.Status
	75, // 47: config.MemberExercise.paragraph:type_name -> library.Paragraph
	65, // 48: config.MemberExercise.account_exercise:type_name -> config.AccountExercise
	31, // 49: config.MemberExercise.member:type_name -> config.Member
	68, // 50: config.MemberExercises.member_exercises:type_name -> config.MemberExercise
	14, // 51: config.GroupParagraph.status:type_name -> config.GroupParagraph.Status
	15, // 52: config.GroupParagraph.approve_process:type_name -> config.GroupParagraph.ApproveProcess
	45, // 53: config.GroupParagraph.group:type_name -> config.Group
	75, // 54: config.GroupParagraph.paragraph:type_name -> library.Paragraph
	71, // 55: config.GroupParagraphs.group_paragraphs:type_name -> config.GroupParagraph
	20, // 56: config.ConfigService.CheckRegisterAccount:input_type -> config.CheckRegisterAccountRequest
	22, // 57: config.ConfigService.VerifyOtpRegister:input_type -> config.VerifyOtpRegisterRequest
	24, // 58: config.ConfigService.RegisterAccount:input_type -> config.RegisterAccountRequest
	26, // 59: config.ConfigService.Login:input_type -> config.LoginAccountRequest
	30, // 60: config.ConfigService.MemberLogin:input_type -> config.MemberRequest
	31, // 61: config.ConfigService.ChangeMemberPassword:input_type -> config.Member
	17, // 62: config.ConfigService.ListAccounts:input_type -> config.AccountRequest
	17, // 63: config.ConfigService.UpdateAccount:input_type -> config.AccountRequest
	30, // 64: config.ConfigService.ListMembers:input_type -> config.MemberRequest
	31, // 65: config.ConfigService.CreateMember:input_type -> config.Member
	31, // 66: config.ConfigService.GetMember:input_type -> config.Member
	34, // 67: config.ConfigService.ListCategories:input_type -> config.CategoryRequest
	42, // 68: config.ConfigService.CreateMemberCategory:input_type -> config.MemberCategory
	42, // 69: config.ConfigService.GetMemberCategory:input_type -> config.MemberCategory
	43, // 70: config.ConfigService.ListMemberCategories:input_type -> config.MemberCategoryRequest
	63, // 71: config.ConfigService.ListMemberPractice:input_type -> config.MemberPracticeRequest
	62, // 72: config.ConfigService.CreateMemberPractice:input_type -> config.MemberPractice
	46, // 73: config.ConfigService.ListGroup:input_type -> config.GroupRequest
	52, // 74: config.ConfigService.ListMemberGroup:input_type -> config.MemberGroupRequest
	46, // 75: config.ConfigService.GetGroup:input_type -> config.GroupRequest
	45, // 76: config.ConfigService.CreateGroup:input_type -> config.Group
	51, // 77: config.ConfigService.CreateMemberGroup:input_type -> config.MemberGroup
	51, // 78: config.ConfigService.ApproveMemberToGroup:input_type -> config.MemberGroup
	49, // 79: config.ConfigService.ListAccountGroup:input_type -> config.AccountGroupRequest
	48, // 80: config.ConfigService.CreateAccountGroup:input_type -> config.AccountGroup
	65, // 81: config.ConfigService.CreateAccountExercise:input_type -> config.AccountExercise
	66, // 82: config.ConfigService.ListAccountExercises:input_type -> config.AccountExerciseRequest
	68, // 83: config.ConfigService.CreateMemberExercise:input_type -> config.MemberExercise
	69, // 84: config.ConfigService.ListMemberMemberExercise:input_type -> config.MemberExerciseRequest
	72, // 85: config.ConfigService.ListGroupParagraph:input_type -> config.GroupParagraphRequest
	71, // 86: config.ConfigService.CreateGroupParagraph:input_type -> config.GroupParagraph
	71, // 87: config.ConfigService.UpdateGroupParagraph:input_type -> config.GroupParagraph
	73, // 88: config.ConfigService.SortGroupParagraph:input_type -> config.GroupParagraphs
	21, // 89: config.ConfigService.CheckRegisterAccount:output_type -> config.CheckRegisterAccountResponse
	23, // 90: config.ConfigService.VerifyOtpRegister:output_type -> config.VerifyOtpRegisterResponse
	18, // 91: config.ConfigService.RegisterAccount:output_type -> config.Account
	27, // 92: config.ConfigService.Login:output_type -> config.LoginAccountResponse
	28, // 93: config.ConfigService.MemberLogin:output_type -> config.LoginMemberResponse
	31, // 94: config.ConfigService.ChangeMemberPassword:output_type -> config.Member
	19, // 95: config.ConfigService.ListAccounts:output_type -> config.Accounts
	18, // 96: config.ConfigService.UpdateAccount:output_type -> config.Account
	32, // 97: config.ConfigService.ListMembers:output_type -> config.Members
	31, // 98: config.ConfigService.CreateMember:output_type -> config.Member
	31, // 99: config.ConfigService.GetMember:output_type -> config.Member
	35, // 100: config.ConfigService.ListCategories:output_type -> config.Categories
	42, // 101: config.ConfigService.CreateMemberCategory:output_type -> config.MemberCategory
	42, // 102: config.ConfigService.GetMemberCategory:output_type -> config.MemberCategory
	44, // 103: config.ConfigService.ListMemberCategories:output_type -> config.MemberCategories
	64, // 104: config.ConfigService.ListMemberPractice:output_type -> config.MemberPractices
	62, // 105: config.ConfigService.CreateMemberPractice:output_type -> config.MemberPractice
	47, // 106: config.ConfigService.ListGroup:output_type -> config.Groups
	53, // 107: config.ConfigService.ListMemberGroup:output_type -> config.MemberGroups
	45, // 108: config.ConfigService.GetGroup:output_type -> config.Group
	45, // 109: config.ConfigService.CreateGroup:output_type -> config.Group
	51, // 110: config.ConfigService.CreateMemberGroup:output_type -> config.MemberGroup
	51, // 111: config.ConfigService.ApproveMemberToGroup:output_type -> config.MemberGroup
	50, // 112: config.ConfigService.ListAccountGroup:output_type -> config.AccountGroups
	48, // 113: config.ConfigService.CreateAccountGroup:output_type -> config.AccountGroup
	65, // 114: config.ConfigService.CreateAccountExercise:output_type -> config.AccountExercise
	67, // 115: config.ConfigService.ListAccountExercises:output_type -> config.AccountExercises
	70, // 116: config.ConfigService.CreateMemberExercise:output_type -> config.MemberExercises
	70, // 117: config.ConfigService.ListMemberMemberExercise:output_type -> config.MemberExercises
	73, // 118: config.ConfigService.ListGroupParagraph:output_type -> config.GroupParagraphs
	71, // 119: config.ConfigService.CreateGroupParagraph:output_type -> config.GroupParagraph
	71, // 120: config.ConfigService.UpdateGroupParagraph:output_type -> config.GroupParagraph
	73, // 121: config.ConfigService.SortGroupParagraph:output_type -> config.GroupParagraphs
...
func file_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_config_proto_msgTypes[56].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GroupParagraphRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
