...
var file_config_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x74, 0x61, 0x6c, 0x32, 0xcf, 0x13, 0x0a, 0x0d, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	...
	0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x2a, 0x5a, 0x28, 0x67, 0x69, 0x74, 0x68, 0x75,
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x51, 0x75, 0x61, 0x6e, 0x67, 0x41, 0x6e, 0x68, 0x4d, 0x54,
	0x41, 0x2f, 0x65, 0x6e, 0x74, 0x2d, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2f, 0x63, 0x6f, 0x6e,
...
var file_config_proto_depIdxs = []int32{
	...
	32, // 3: config.Account.member:type_name -> config.Member
	19, // 4: config.Accounts.accounts:type_name -> config.Account
	17, // 5: config.LoginAccountResponse.claim:type_name -> config.Claims
	19, // 6: config.LoginAccountResponse.account:type_name -> config.Account
	32, // 7: config.LoginAccountResponse.members:type_name -> config.Member
	43, // 8: config.LoginAccountResponse.member_categories:type_name -> config.MemberCategory
	17, // 9: config.LoginMemberResponse.claim:type_name -> config.Claims
	19, // 10: config.LoginMemberResponse.account:type_name -> config.Account
	32, // 11: config.LoginMemberResponse.member:type_name -> config.Member
	43, // 12: config.LoginMemberResponse.member_categories:type_name -> config.MemberCategory
	17, // 13: config.AccessToken.claims:type_name -> config.Claims
	2,  // 14: config.Member.status:type_name -> config.Member.Status
	32, // 15: config.Members.members:type_name -> config.Member
	3,  // 16: config.Category.status:type_name -> config.Category.Status
	4,  // 17: config.Category.is_favourite:type_name -> config.Category.IsFavourite
	34, // 18: config.Categories.categories:type_name -> config.Category
	42, // 19: config.Role.accesses:type_name -> config.Accesses
	75, // 20: config.Role.list_access:type_name -> config.Role.ListAccessEntry
	37, // 21: config.Roles.roles:type_name -> config.Role
	5,  // 22: config.Access.status:type_name -> config.Access.Status
	40, // 23: config.Accesses.accesses:type_name -> config.Access
	6,  // 24: config.MemberCategory.status:type_name -> config.MemberCategory.Status
	34, // 25: config.MemberCategory.category:type_name -> config.Category
	43, // 26: config.MemberCategories.member_categories:type_name -> config.MemberCategory
	7,  // 27: config.Group.status:type_name -> config.Group.Status
	8,  // 28: config.Group.type:type_name -> config.Group.Type
	49, // 29: config.Group.account_groups:type_name -> config.AccountGroup
	52, // 30: config.Group.member_groups:type_name -> config.MemberGroup
	19, // 31: config.Group.account_manager:type_name -> config.Account
	46, // 32: config.Groups.groups:type_name -> config.Group
	46, // 33: config.Groups.group_parent:type_name -> config.Group
	9,  // 34: config.AccountGroup.status:type_name -> config.AccountGroup.Status
	19, // 35: config.AccountGroup.account:type_name -> config.Account
	46, // 36: config.AccountGroup.group:type_name -> config.Group
	49, // 37: config.AccountGroups.account_groups:type_name -> config.AccountGroup
	10, // 38: config.MemberGroup.status:type_name -> config.MemberGroup.Status
	11, // 39: config.MemberGroup.approve_process:type_name -> config.MemberGroup.ApproveProcess
	32, // 40: config.MemberGroup.member:type_name -> config.Member
	46, // 41: config.MemberGroup.group:type_name -> config.Group
	52, // 42: config.MemberGroups.member_groups:type_name -> config.MemberGroup
	12, // 43: config.Token.status:type_name -> config.Token.Status
	55, // 44: config.Tokens.tokens:type_name -> config.Token
	58, // 45: config.AccountTokens.account_tokens:type_name -> config.AccountToken
	63, // 46: config.MemberPractices.member_practices:type_name -> config.MemberPractice
	13, // 47: config.AccountExercise.status:type_name -> config.AccountExercise.Status
	76, // 48: config.AccountExercise.paragraph:type_name -> library.Paragraph
	19, // 49: config.AccountExercise.account:type_name -> config.Account
	46, // 50: config.AccountExercise.Group:type_name -> config.Group
	66, // 51: config.AccountExercises.account_exercises:type_name -> config.AccountExercise
	14, // 52: config.MemberExercise.status:type_name -> config.MemberExercise.Status
	76, // 53: config.MemberExercise.paragraph:type_name -> library.Paragraph
	66, // 54: config.MemberExercise.account_exercise:type_name -> config.AccountExercise
	32, // 55: config.MemberExercise.member:type_name -> config.Member
	69, // 56: config.MemberExercises.member_exercises:type_name -> config.MemberExercise
	15, // 57: config.GroupDocument.status:type_name -> config.GroupDocument.Status
	16, // 58: config.GroupDocument.approve_process:type_name -> config.GroupDocument.ApproveProcess
	46, // 59: config.GroupDocument.group:type_name -> config.Group
	77, // 60: config.GroupDocument.document:type_name -> library.Document
	72, // 61: config.GroupDocuments.group_documents:type_name -> config.GroupDocument
	21, // 62: config.ConfigService.CheckRegisterAccount:input_type -> config.CheckRegisterAccountRequest
	23, // 63: config.ConfigService.VerifyOtpRegister:input_type -> config.VerifyOtpRegisterRequest
	25, // 64: config.ConfigService.RegisterAccount:input_type -> config.RegisterAccountRequest
	27, // 65: config.ConfigService.Login:input_type -> config.LoginAccountRequest
	31, // 66: config.ConfigService.MemberLogin:input_type -> config.MemberRequest
	32, // 67: config.ConfigService.ChangeMemberPassword:input_type -> config.Member
	18, // 68: config.ConfigService.ListAccounts:input_type -> config.AccountRequest
	18, // 69: config.ConfigService.UpdateAccount:input_type -> config.AccountRequest
	31, // 70: config.ConfigService.ListMembers:input_type -> config.MemberRequest
	32, // 71: config.ConfigService.CreateMember:input_type -> config.Member
	32, // 72: config.ConfigService.GetMember:input_type -> config.Member
	35, // 73: config.ConfigService.ListCategories:input_type -> config.CategoryRequest
	43, // 74: config.ConfigService.CreateMemberCategory:input_type -> config.MemberCategory
	43, // 75: config.ConfigService.GetMemberCategory:input_type -> config.MemberCategory
	44, // 76: config.ConfigService.ListMemberCategories:input_type -> config.MemberCategoryRequest
	64, // 77: config.ConfigService.ListMemberPractice:input_type -> config.MemberPracticeRequest
	63, // 78: config.ConfigService.CreateMemberPractice:input_type -> config.MemberPractice
	47, // 79: config.ConfigService.ListGroup:input_type -> config.GroupRequest
	53, // 80: config.ConfigService.ListMemberGroup:input_type -> config.MemberGroupRequest
	47, // 81: config.ConfigService.GetGroup:input_type -> config.GroupRequest
	46, // 82: config.ConfigService.CreateGroup:input_type -> config.Group
	52, // 83: config.ConfigService.CreateMemberGroup:input_type -> config.MemberGroup
	52, // 84: config.ConfigService.ApproveMemberToGroup:input_type -> config.MemberGroup
	50, // 85: config.ConfigService.ListAccountGroup:input_type -> config.AccountGroupRequest
	49, // 86: config.ConfigService.CreateAccountGroup:input_type -> config.AccountGroup
	66, // 87: config.ConfigService.CreateAccountExercise:input_type -> config.AccountExercise
	67, // 88: config.ConfigService.ListAccountExercises:input_type -> config.AccountExerciseRequest
	69, // 89: config.ConfigService.CreateMemberExercise:input_type -> config.MemberExercise
	70, // 90: config.ConfigService.ListMemberExercise:input_type -> config.MemberExerciseRequest
	73, // 91: config.ConfigService.ListGroupDocument:input_type -> config.GroupDocumentRequest
	72, // 92: config.ConfigService.CreateGroupDocument:input_type -> config.GroupDocument
	72, // 93: config.ConfigService.UpdateGroupDocument:input_type -> config.GroupDocument
	74, // 94: config.ConfigService.SortGroupDocument:input_type -> config.GroupDocuments
	70, // 95: config.ConfigService.GetMemberExercise:input_type -> config.MemberExerciseRequest
	70, // 96: config.ConfigService.UpdateMemberExercise:input_type -> config.MemberExerciseRequest
	53, // 97: config.ConfigService.CreateMemberGroups:input_type -> config.MemberGroupRequest
	19, // 98: config.ConfigService.CreateAccount:input_type -> config.Account
	22, // 99: config.ConfigService.CheckRegisterAccount:output_type -> config.CheckRegisterAccountResponse
	24, // 100: config.ConfigService.VerifyOtpRegister:output_type -> config.VerifyOtpRegisterResponse
	19, // 101: config.ConfigService.RegisterAccount:output_type -> config.Account
	28, // 102: config.ConfigService.Login:output_type -> config.LoginAccountResponse
	29, // 103: config.ConfigService.MemberLogin:output_type -> config.LoginMemberResponse
	32, // 104: config.ConfigService.ChangeMemberPassword:output_type -> config.Member
	20, // 105: config.ConfigService.ListAccounts:output_type -> config.Accounts
	19, // 106: config.ConfigService.UpdateAccount:output_type -> config.Account
	33, // 107: config.ConfigService.ListMembers:output_type -> config.Members
	32, // 108: config.ConfigService.CreateMember:output_type -> config.Member
	32, // 109: config.ConfigService.GetMember:output_type -> config.Member
	36, // 110: config.ConfigService.ListCategories:output_type -> config.Categories
	43, // 111: config.ConfigService.CreateMemberCategory:output_type -> config.MemberCategory
	43, // 112: config.ConfigService.GetMemberCategory:output_type -> config.MemberCategory
	45, // 113: config.ConfigService.ListMemberCategories:output_type -> config.MemberCategories
	65, // 114: config.ConfigService.ListMemberPractice:output_type -> config.MemberPractices
	63, // 115: config.ConfigService.CreateMemberPractice:output_type -> config.MemberPractice
	48, // 116: config.ConfigService.ListGroup:output_type -> config.Groups
	54, // 117: config.ConfigService.ListMemberGroup:output_type -> config.MemberGroups
	46, // 118: config.ConfigService.GetGroup:output_type -> config.Group
	46, // 119: config.ConfigService.CreateGroup:output_type -> config.Group
	52, // 120: config.ConfigService.CreateMemberGroup:output_type -> config.MemberGroup
	52, // 121: config.ConfigService.ApproveMemberToGroup:output_type -> config.MemberGroup
	51, // 122: config.ConfigService.ListAccountGroup:output_type -> config.AccountGroups
	49, // 123: config.ConfigService.CreateAccountGroup:output_type -> config.AccountGroup
	66, // 124: config.ConfigService.CreateAccountExercise:output_type -> config.AccountExercise
	68, // 125: config.ConfigService.ListAccountExercises:output_type -> config.AccountExercises
	71, // 126: config.ConfigService.CreateMemberExercise:output_type -> config.MemberExercises
	71, // 127: config.ConfigService.ListMemberExercise:output_type -> config.MemberExercises
	74, // 128: config.ConfigService.ListGroupDocument:output_type -> config.GroupDocuments
	72, // 129: config.ConfigService.CreateGroupDocument:output_type -> config.GroupDocument
	72, // 130: config.ConfigService.UpdateGroupDocument:output_type -> config.GroupDocument
	74, // 131: config.ConfigService.SortGroupDocument:output_type -> config.GroupDocuments
	69, // 132: config.ConfigService.GetMemberExercise:output_type -> config.MemberExercise
	69, // 133: config.ConfigService.UpdateMemberExercise:output_type -> config.MemberExercise
	54, // 134: config.ConfigService.CreateMemberGroups:output_type -> config.MemberGroups
	19, // 135: config.ConfigService.CreateAccount:output_type -> config.Account
