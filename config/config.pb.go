...
var file_config_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x32, 0xf4, 0x07, 0x0a, 0x0d, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x53, 0x65, 0x72,
...
var file_config_proto_depIdxs = []int32{
	...
	7,  // 29: config.ConfigService.UpdateAccount:input_type -> config.AccountRequest
	20, // 30: config.ConfigService.ListMembers:input_type -> config.MemberRequest
	21, // 31: config.ConfigService.CreateMember:input_type -> config.Member
	21, // 32: config.ConfigService.GetMember:input_type -> config.Member
	24, // 33: config.ConfigService.ListCategories:input_type -> config.CategoryRequest
	32, // 34: config.ConfigService.CreateMemberCategory:input_type -> config.MemberCategory
	32, // 35: config.ConfigService.GetMemberCategory:input_type -> config.MemberCategory
	33, // 36: config.ConfigService.ListMemberCategories:input_type -> config.MemberCategoryRequest
	11, // 37: config.ConfigService.CheckRegisterAccount:output_type -> config.CheckRegisterAccountResponse
	13, // 38: config.ConfigService.VerifyOtpRegister:output_type -> config.VerifyOtpRegisterResponse
	8,  // 39: config.ConfigService.RegisterAccount:output_type -> config.Account
	17, // 40: config.ConfigService.Login:output_type -> config.LoginAccountResponse
	18, // 41: config.ConfigService.MemberLogin:output_type -> config.LoginMemberResponse
	21, // 42: config.ConfigService.ChangeMemberPassword:output_type -> config.Member
	9,  // 43: config.ConfigService.ListAccounts:output_type -> config.Accounts
	8,  // 44: config.ConfigService.UpdateAccount:output_type -> config.Account
	22, // 45: config.ConfigService.ListMembers:output_type -> config.Members
	21, // 46: config.ConfigService.CreateMember:output_type -> config.Member
	21, // 47: config.ConfigService.GetMember:output_type -> config.Member
	25, // 48: config.ConfigService.ListCategories:output_type -> config.Categories
	32, // 49: config.ConfigService.CreateMemberCategory:output_type -> config.MemberCategory
	32, // 50: config.ConfigService.GetMemberCategory:output_type -> config.MemberCategory
	34, // 51: config.ConfigService.ListMemberCategories:output_type -> config.MemberCategories
