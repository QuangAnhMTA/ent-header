...
const (
	Group_default_state Group_Status = 0
...
var file_config_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x22, 0x9c, 0x02, 0x0a, 0x05, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x12, 0x0e, 0x0a, 0x02,
	...
	0x02, 0x22, 0xc6, 0x02, 0x0a, 0x0c, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02,
	0x69, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x12,
	0x14, 0x0a, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05,
	0x74, 0x69, 0x74, 0x6c, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73,
	...
	0x64, 0x5f, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x77, 0x61, 0x72, 0x64,
	...
	0x6c, 0x73, 0x18, 0x0b, 0x20, 0x03, 0x28, 0x09, 0x52, 0x04, 0x63, 0x6f, 0x6c, 0x73, 0x12, 0x1a,
	0x0a, 0x08, 0x69, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x73, 0x18, 0x0c, 0x20, 0x03, 0x28, 0x09,
	0x52, 0x08, 0x69, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x73, 0x22, 0x45, 0x0a, 0x06, 0x47, 0x72,
...
var file_config_proto_msgTypes = make([]protoimpl.MessageInfo, 47)
var file_config_proto_goTypes = []interface{}{
	...
	(MemberGroup_Status)(0),              // 7: config.MemberGroup.Status
	(Token_Status)(0),                    // 8: config.Token.Status
	(*Claims)(nil),                       // 9: config.Claims
	(*AccountRequest)(nil),               // 10: config.AccountRequest
	(*Account)(nil),                      // 11: config.Account
	(*Accounts)(nil),                     // 12: config.Accounts
	(*CheckRegisterAccountRequest)(nil),  // 13: config.CheckRegisterAccountRequest
	(*CheckRegisterAccountResponse)(nil), // 14: config.CheckRegisterAccountResponse
	(*VerifyOtpRegisterRequest)(nil),     // 15: config.VerifyOtpRegisterRequest
	(*VerifyOtpRegisterResponse)(nil),    // 16: config.VerifyOtpRegisterResponse
	(*RegisterAccountRequest)(nil),       // 17: config.RegisterAccountRequest
	(*RegisterAccountResponse)(nil),      // 18: config.RegisterAccountResponse
	(*LoginAccountRequest)(nil),          // 19: config.LoginAccountRequest
	(*LoginAccountResponse)(nil),         // 20: config.LoginAccountResponse
	(*LoginMemberResponse)(nil),          // 21: config.LoginMemberResponse
	(*AccessToken)(nil),                  // 22: config.AccessToken
	(*MemberRequest)(nil),                // 23: config.MemberRequest
	(*Member)(nil),                       // 24: config.Member
	(*Members)(nil),                      // 25: config.Members
	(*Category)(nil),                     // 26: config.Category
	(*CategoryRequest)(nil),              // 27: config.CategoryRequest
	(*Categories)(nil),                   // 28: config.Categories
	(*Role)(nil),                         // 29: config.Role
	(*Roles)(nil),                        // 30: config.Roles
	(*RoleRequest)(nil),                  // 31: config.RoleRequest
	(*Access)(nil),                       // 32: config.Access
	(*AccessRequest)(nil),                // 33: config.AccessRequest
	(*Accesses)(nil),                     // 34: config.Accesses
	(*MemberCategory)(nil),               // 35: config.MemberCategory
	(*MemberCategoryRequest)(nil),        // 36: config.MemberCategoryRequest
	(*MemberCategories)(nil),             // 37: config.MemberCategories
	(*Group)(nil),                        // 38: config.Group
	(*GroupRequest)(nil),                 // 39: config.GroupRequest
	(*Groups)(nil),                       // 40: config.Groups
	(*MemberGroup)(nil),                  // 41: config.MemberGroup
	(*MemberGroupRequest)(nil),           // 42: config.MemberGroupRequest
	(*MemberGroups)(nil),                 // 43: config.MemberGroups
	(*Token)(nil),                        // 44: config.Token
	(*TokenRequest)(nil),                 // 45: config.TokenRequest
	(*Tokens)(nil),                       // 46: config.Tokens
	(*AccountToken)(nil),                 // 47: config.AccountToken
	(*AccountTokenRequest)(nil),          // 48: config.AccountTokenRequest
	(*AccountTokens)(nil),                // 49: config.AccountTokens
	(*MemberToken)(nil),                  // 50: config.MemberToken
	(*MemberTokenRequest)(nil),           // 51: config.MemberTokenRequest
	(*MemberPractice)(nil),               // 52: config.MemberPractice
	(*MemberPracticeRequest)(nil),        // 53: config.MemberPracticeRequest
	(*MemberPractices)(nil),              // 54: config.MemberPractices
	nil,                                  // 55: config.Role.ListAccessEntry
}
var file_config_proto_depIdxs = []int32{
	0,  // 0: config.Account.status:type_name -> config.Account.Status
	29, // 1: config.Account.role:type_name -> config.Role
	11, // 2: config.Accounts.accounts:type_name -> config.Account
	9,  // 3: config.LoginAccountResponse.claim:type_name -> config.Claims
	11, // 4: config.LoginAccountResponse.account:type_name -> config.Account
	24, // 5: config.LoginAccountResponse.members:type_name -> config.Member
	9,  // 6: config.LoginMemberResponse.claim:type_name -> config.Claims
	11, // 7: config.LoginMemberResponse.account:type_name -> config.Account
	24, // 8: config.LoginMemberResponse.member:type_name -> config.Member
	9,  // 9: config.AccessToken.claims:type_name -> config.Claims
	1,  // 10: config.Member.status:type_name -> config.Member.Status
	24, // 11: config.Members.members:type_name -> config.Member
	...
	26, // 14: config.Categories.categories:type_name -> config.Category
	34, // 15: config.Role.accesses:type_name -> config.Accesses
	55, // 16: config.Role.list_access:type_name -> config.Role.ListAccessEntry
	29, // 17: config.Roles.roles:type_name -> config.Role
	4,  // 18: config.Access.status:type_name -> config.Access.Status
	32, // 19: config.Accesses.accesses:type_name -> config.Access
	5,  // 20: config.MemberCategory.status:type_name -> config.MemberCategory.Status
	35, // 21: config.MemberCategories.member_categories:type_name -> config.MemberCategory
	6,  // 22: config.Group.status:type_name -> config.Group.Status
	38, // 23: config.Groups.groups:type_name -> config.Group
	7,  // 24: config.MemberGroup.status:type_name -> config.MemberGroup.Status
	41, // 25: config.MemberGroups.member_groups:type_name -> config.MemberGroup
	8,  // 26: config.Token.status:type_name -> config.Token.Status
	44, // 27: config.Tokens.tokens:type_name -> config.Token
	47, // 28: config.AccountTokens.account_tokens:type_name -> config.AccountToken
	52, // 29: config.MemberPractices.member_practices:type_name -> config.MemberPractice
	13, // 30: config.ConfigService.CheckRegisterAccount:input_type -> config.CheckRegisterAccountRequest
	15, // 31: config.ConfigService.VerifyOtpRegister:input_type -> config.VerifyOtpRegisterRequest
	17, // 32: config.ConfigService.RegisterAccount:input_type -> config.RegisterAccountRequest
	19, // 33: config.ConfigService.Login:input_type -> config.LoginAccountRequest
	23, // 34: config.ConfigService.MemberLogin:input_type -> config.MemberRequest
	24, // 35: config.ConfigService.ChangeMemberPassword:input_type -> config.Member
	10, // 36: config.ConfigService.ListAccounts:input_type -> config.AccountRequest
	10, // 37: config.ConfigService.UpdateAccount:input_type -> config.AccountRequest
	23, // 38: config.ConfigService.ListMembers:input_type -> config.MemberRequest
	24, // 39: config.ConfigService.CreateMember:input_type -> config.Member
	24, // 40: config.ConfigService.GetMember:input_type -> config.Member
	27, // 41: config.ConfigService.ListCategories:input_type -> config.CategoryRequest
	35, // 42: config.ConfigService.CreateMemberCategory:input_type -> config.MemberCategory
	35, // 43: config.ConfigService.GetMemberCategory:input_type -> config.MemberCategory
	36, // 44: config.ConfigService.ListMemberCategories:input_type -> config.MemberCategoryRequest
	53, // 45: config.ConfigService.ListMemberPractice:input_type -> config.MemberPracticeRequest
	52, // 46: config.ConfigService.CreateMemberPractice:input_type -> config.MemberPractice
	39, // 47: config.ConfigService.ListGroup:input_type -> config.GroupRequest
	42, // 48: config.ConfigService.ListMemberGroup:input_type -> config.MemberGroupRequest
	14, // 49: config.ConfigService.CheckRegisterAccount:output_type -> config.CheckRegisterAccountResponse
	16, // 50: config.ConfigService.VerifyOtpRegister:output_type -> config.VerifyOtpRegisterResponse
	11, // 51: config.ConfigService.RegisterAccount:output_type -> config.Account
	20, // 52: config.ConfigService.Login:output_type -> config.LoginAccountResponse
	21, // 53: config.ConfigService.MemberLogin:output_type -> config.LoginMemberResponse
	24, // 54: config.ConfigService.ChangeMemberPassword:output_type -> config.Member
	12, // 55: config.ConfigService.ListAccounts:output_type -> config.Accounts
	11, // 56: config.ConfigService.UpdateAccount:output_type -> config.Account
	25, // 57: config.ConfigService.ListMembers:output_type -> config.Members
	24, // 58: config.ConfigService.CreateMember:output_type -> config.Member
	24, // 59: config.ConfigService.GetMember:output_type -> config.Member
	28, // 60: config.ConfigService.ListCategories:output_type -> config.Categories
	35, // 61: config.ConfigService.CreateMemberCategory:output_type -> config.MemberCategory
	35, // 62: config.ConfigService.GetMemberCategory:output_type -> config.MemberCategory
	37, // 63: config.ConfigService.ListMemberCategories:output_type -> config.MemberCategories
	54, // 64: config.ConfigService.ListMemberPractice:output_type -> config.MemberPractices
	52, // 65: config.ConfigService.CreateMemberPractice:output_type -> config.MemberPractice
	40, // 66: config.ConfigService.ListGroup:output_type -> config.Groups
	43, // 67: config.ConfigService.ListMemberGroup:output_type -> config.MemberGroups
