...
var file_config_proto_rawDesc = []byte{
	...
	0x6f, 0x75, 0x70, 0x73, 0x12, 0x30, 0x0a, 0x0c, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x5f, 0x70, 0x61,
	0x72, 0x65, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x63, 0x6f, 0x6e,
	0x66, 0x69, 0x67, 0x2e, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x52, 0x0b, 0x67, 0x72, 0x6f, 0x75, 0x70,
	0x50, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x22, 0xa7, 0x02, 0x0a, 0x0c, 0x41, 0x63, 0x63, 0x6f, 0x75,
	0x6e, 0x74, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20,
	...
	0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x12, 0x33, 0x0a, 0x06, 0x73, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1b, 0x2e, 0x63, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x2e, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x2e,
	0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x29,
	0x0a, 0x07, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x0f, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	0x52, 0x07, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x35, 0x0a, 0x06, 0x53, 0x74, 0x61,
	...
	0x75, 0x70, 0x73, 0x22, 0xdf, 0x01, 0x0a, 0x0b, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x47, 0x72,
	...
	0x69, 0x76, 0x65, 0x10, 0x02, 0x22, 0x83, 0x02, 0x0a, 0x12, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72,
	...
	0x09, 0x52, 0x08, 0x69, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x73, 0x22, 0x48, 0x0a, 0x0c, 0x4d,
	...
	0x32, 0xb3, 0x0a, 0x0a, 0x0d, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x2e, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x42, 0x2a, 0x5a, 0x28, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_config_proto_depIdxs = []int32{
	...
	40, // 26: config.Groups.group_parent:type_name -> config.Group
	8,  // 27: config.AccountGroup.status:type_name -> config.AccountGroup.Status
	13, // 28: config.AccountGroup.account:type_name -> config.Account
	43, // 29: config.AccountGroups.account_groups:type_name -> config.AccountGroup
	9,  // 30: config.MemberGroup.status:type_name -> config.MemberGroup.Status
	46, // 31: config.MemberGroups.member_groups:type_name -> config.MemberGroup
	10, // 32: config.Token.status:type_name -> config.Token.Status
	49, // 33: config.Tokens.tokens:type_name -> config.Token
	52, // 34: config.AccountTokens.account_tokens:type_name -> config.AccountToken
	57, // 35: config.MemberPractices.member_practices:type_name -> config.MemberPractice
	15, // 36: config.ConfigService.CheckRegisterAccount:input_type -> config.CheckRegisterAccountRequest
	17, // 37: config.ConfigService.VerifyOtpRegister:input_type -> config.VerifyOtpRegisterRequest
	19, // 38: config.ConfigService.RegisterAccount:input_type -> config.RegisterAccountRequest
	21, // 39: config.ConfigService.Login:input_type -> config.LoginAccountRequest
	25, // 40: config.ConfigService.MemberLogin:input_type -> config.MemberRequest
	26, // 41: config.ConfigService.ChangeMemberPassword:input_type -> config.Member
	12, // 42: config.ConfigService.ListAccounts:input_type -> config.AccountRequest
	12, // 43: config.ConfigService.UpdateAccount:input_type -> config.AccountRequest
	25, // 44: config.ConfigService.ListMembers:input_type -> config.MemberRequest
	26, // 45: config.ConfigService.CreateMember:input_type -> config.Member
	26, // 46: config.ConfigService.GetMember:input_type -> config.Member
	29, // 47: config.ConfigService.ListCategories:input_type -> config.CategoryRequest
	37, // 48: config.ConfigService.CreateMemberCategory:input_type -> config.MemberCategory
	37, // 49: config.ConfigService.GetMemberCategory:input_type -> config.MemberCategory
	38, // 50: config.ConfigService.ListMemberCategories:input_type -> config.MemberCategoryRequest
	58, // 51: config.ConfigService.ListMemberPractice:input_type -> config.MemberPracticeRequest
	57, // 52: config.ConfigService.CreateMemberPractice:input_type -> config.MemberPractice
	41, // 53: config.ConfigService.ListGroup:input_type -> config.GroupRequest
	47, // 54: config.ConfigService.ListMemberGroup:input_type -> config.MemberGroupRequest
	41, // 55: config.ConfigService.GetGroup:input_type -> config.GroupRequest
	16, // 56: config.ConfigService.CheckRegisterAccount:output_type -> config.CheckRegisterAccountResponse
	18, // 57: config.ConfigService.VerifyOtpRegister:output_type -> config.VerifyOtpRegisterResponse
	13, // 58: config.ConfigService.RegisterAccount:output_type -> config.Account
	22, // 59: config.ConfigService.Login:output_type -> config.LoginAccountResponse
	23, // 60: config.ConfigService.MemberLogin:output_type -> config.LoginMemberResponse
	26, // 61: config.ConfigService.ChangeMemberPassword:output_type -> config.Member
	14, // 62: config.ConfigService.ListAccounts:output_type -> config.Accounts
	13, // 63: config.ConfigService.UpdateAccount:output_type -> config.Account
	27, // 64: config.ConfigService.ListMembers:output_type -> config.Members
	26, // 65: config.ConfigService.CreateMember:output_type -> config.Member
	26, // 66: config.ConfigService.GetMember:output_type -> config.Member
	30, // 67: config.ConfigService.ListCategories:output_type -> config.Categories
	37, // 68: config.ConfigService.CreateMemberCategory:output_type -> config.MemberCategory
	37, // 69: config.ConfigService.GetMemberCategory:output_type -> config.MemberCategory
	39, // 70: config.ConfigService.ListMemberCategories:output_type -> config.MemberCategories
	59, // 71: config.ConfigService.ListMemberPractice:output_type -> config.MemberPractices
	57, // 72: config.ConfigService.CreateMemberPractice:output_type -> config.MemberPractice
	42, // 73: config.ConfigService.ListGroup:output_type -> config.Groups
	48, // 74: config.ConfigService.ListMemberGroup:output_type -> config.MemberGroups
	40, // 75: config.ConfigService.GetGroup:output_type -> config.Group
