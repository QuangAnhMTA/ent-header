...
func (Category_Status) EnumDescriptor() ([]byte, []int) {
	return file_config_proto_rawDescGZIP(), []int{20, 0}
}
...
func (Category_IsFavourite) EnumDescriptor() ([]byte, []int) {
	return file_config_proto_rawDescGZIP(), []int{20, 1}
}
...
func (MemberGroup_ApproveProcess) EnumDescriptor() ([]byte, []int) {
	return file_config_proto_rawDescGZIP(), []int{38, 1}
}
...
func (Token_Status) EnumDescriptor() ([]byte, []int) {
	return file_config_proto_rawDescGZIP(), []int{41, 0}
}

type Product_Status int32

const (
	Product_default_state Product_Status = 0
	Product_deactive      Product_Status = 1
	Product_active        Product_Status = 2
)
...
func (Product_Status) EnumDescriptor() ([]byte, []int) {
	return file_config_proto_rawDescGZIP(), []int{44, 0}
}
...
func (GroupDocument_Status) EnumDescriptor() ([]byte, []int) {
	return file_config_proto_rawDescGZIP(), []int{61, 0}
}
...
func (GroupDocument_ApproveProcess) EnumDescriptor() ([]byte, []int) {
	return file_config_proto_rawDescGZIP(), []int{61, 1}
}
...
func (MemberQuiz_Status) EnumDescriptor() ([]byte, []int) {
	return file_config_proto_rawDescGZIP(), []int{64, 0}
}

type SumAllMemberGroupRequest struct {
...
func (x *SumAllMemberGroupRequest) Reset() {
	*x = SumAllMemberGroupRequest{}
...
func (x *SumAllMemberGroupRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SumAllMemberGroupRequest) ProtoMessage() {}

func (x *SumAllMemberGroupRequest) ProtoReflect() protoreflect.Message {
	mi := &file_config_proto_msgTypes[0]
...
// Deprecated: Use SumAllMemberGroupRequest.ProtoReflect.Descriptor instead.
func (*SumAllMemberGroupRequest) Descriptor() ([]byte, []int) {
	return file_config_proto_rawDescGZIP(), []int{0}
}

func (x *SumAllMemberGroupRequest) GetStartAt() int64 {
	if x != nil {
		return x.StartAt
	}
	return 0
...
func (x *SumAllMemberGroupRequest) GetEndAt() int64 {
	if x != nil {
		return x.EndAt
	}
	return 0
...
func (x *SumAllMemberGroupRequest) GetAccountId() int64 {
	if x != nil {
		return x.AccountId
	}
	return 0
...
func (x *SumAllMemberGroupRequest) GetGroupId() int64 {
	if x != nil {
		return x.GroupId
	}
	return 0
...
type SumAllMemberGroupResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	ReportMemberGroups []*ReportMember `protobuf:"bytes,1,rep,name=report_member_groups,json=reportMemberGroups,proto3" json:"report_member_groups,omitempty"`
}

func (x *SumAllMemberGroupResponse) Reset() {
	*x = SumAllMemberGroupResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *SumAllMemberGroupResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SumAllMemberGroupResponse) ProtoMessage() {}

func (x *SumAllMemberGroupResponse) ProtoReflect() protoreflect.Message {
	mi := &file_config_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SumAllMemberGroupResponse.ProtoReflect.Descriptor instead.
func (*SumAllMemberGroupResponse) Descriptor() ([]byte, []int) {
	return file_config_proto_rawDescGZIP(), []int{1}
}

func (x *SumAllMemberGroupResponse) GetReportMemberGroups() []*ReportMember {
	if x != nil {
		return x.ReportMemberGroups
	}
	return nil
}
...
type ReportMember struct {
	...
	TotalMember int64  `protobuf:"varint,1,opt,name=total_member,json=totalMember,proto3" json:"total_member,omitempty"`
...
func (x *ReportMember) GetTotalMember() int64 {
	if x != nil {
...
func (x *ReportMember) GetGroupId() int64 {
	if x != nil {
		return x.GroupId
	}
	return 0
...
type Account struct {
	...
	// `gorm:"-"`
	GroupId int64 `protobuf:"varint,13,opt,name=group_id,json=groupId,proto3" json:"group_id,omitempty" gorm:"-"`
}
...
func (x *Account) GetGroupId() int64 {
	if x != nil {
		return x.GroupId
	}
	return 0
...
type LoginAccountResponse struct {
	...
	MemberCategories []*MemberCategory `protobuf:"bytes,7,rep,name=member_categories,json=memberCategories,proto3" json:"member_categories,omitempty"`
}
...
func (x *LoginAccountResponse) GetMemberCategories() []*MemberCategory {
	if x != nil {
...
func (x *LoginMemberResponse) GetMemberCategories() []*MemberCategory {
	if x != nil {
		return x.MemberCategories
	}
	return nil
...
type Member struct {
	...
	// `gorm:"-"`
	TokenQuantity int64 `protobuf:"varint,14,opt,name=token_quantity,json=tokenQuantity,proto3" json:"token_quantity,omitempty" gorm:"-"`
}
...
func (x *Member) GetTokenQuantity() int64 {
	if x != nil {
...
type MemberCategory struct {
	...
	// `gorm:"-"`
	Category *Category `protobuf:"bytes,8,opt,name=category,proto3" json:"category,omitempty" gorm:"-"`
}
...
func (x *MemberCategory) GetCategory() *Category {
	if x != nil {
		return x.Category
	}
	return nil
...
type Group struct {
	...
	// `gorm:"-"`
	AccountManager *Account `protobuf:"bytes,14,opt,name=account_manager,json=accountManager,proto3" json:"account_manager,omitempty" gorm:"-"`
}
...
func (x *Group) GetAccountManager() *Account {
	if x != nil {
...
func (x *MemberGroupRequest) GetGroupIds() []int64 {
	if x != nil {
		return x.GroupIds
	}
	return nil
...
func (x *MemberGroupRequest) GetMemberIds() []int64 {
	if x != nil {
		return x.MemberIds
	}
	return nil
...
type Product struct {
	...
	TokenQuantity int64  `protobuf:"varint,5,opt,name=token_quantity,json=tokenQuantity,proto3" json:"token_quantity,omitempty"`
	Price         int64  `protobuf:"varint,6,opt,name=price,proto3" json:"price,omitempty"`
	CreatedAt     int64  `protobuf:"varint,7,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"`
	UpdatedAt     int64  `protobuf:"varint,8,opt,name=updated_at,json=updatedAt,proto3" json:"updated_at,omitempty"`
	Status        int64  `protobuf:"varint,9,opt,name=status,proto3" json:"status,omitempty"`
	// `gorm:"-"`
	Token *Token `protobuf:"bytes,10,opt,name=token,proto3" json:"token,omitempty" gorm:"-"`
}
...
func (x *Product) GetTokenId() int64 {
	if x != nil {
		return x.TokenId
	}
	return 0
...
func (x *Product) GetTokenQuantity() int64 {
	if x != nil {
		return x.TokenQuantity
	}
	return 0
...
type ProductRequest struct {
	...
	Cols          []string `protobuf:"bytes,11,rep,name=cols,proto3" json:"cols,omitempty"`
	Includes      []string `protobuf:"bytes,12,rep,name=includes,proto3" json:"includes,omitempty"`
	TokenIds      []int64  `protobuf:"varint,14,rep,packed,name=token_ids,json=tokenIds,proto3" json:"token_ids,omitempty"`
}
...
func (x *ProductRequest) GetTokenId() int64 {
	if x != nil {
		return x.TokenId
	}
	return 0
...
func (x *ProductRequest) GetTokenQuantity() int64 {
	if x != nil {
		return x.TokenQuantity
	}
	return 0
...
func (x *ProductRequest) GetStatus() int32 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *ProductRequest) GetCols() []string {
	if x != nil {
		return x.Cols
	}
	return nil
...
func (x *ProductRequest) GetIncludes() []string {
	if x != nil {
		return x.Includes
	}
	return nil
...
func (x *ProductRequest) GetTokenIds() []int64 {
	if x != nil {
		return x.TokenIds
	}
	return nil
...
func (x *AccountExerciseRequest) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
type MemberExercise struct {
	...
	Lookup            int64                 `protobuf:"varint,21,opt,name=lookup,proto3" json:"lookup,omitempty"`
	...
	CorrectTotal int64   `protobuf:"varint,23,opt,name=correct_total,json=correctTotal,proto3" json:"correct_total,omitempty"`
	WrongTotal   int64   `protobuf:"varint,22,opt,name=wrong_total,json=wrongTotal,proto3" json:"wrong_total,omitempty"`
}
...
func (x *MemberExercise) GetLookup() int64 {
	if x != nil {
		return x.Lookup
	}
	return 0
...
func (x *MemberExercise) GetUpdatedAt() int64 {
	if x != nil {
		return x.UpdatedAt
	}
	return 0
...
func (x *MemberExercise) GetCorrectTotal() int64 {
	if x != nil {
		return x.CorrectTotal
	}
	return 0
}

func (x *MemberExercise) GetWrongTotal() int64 {
	if x != nil {
		return x.WrongTotal
	}
	return 0
...
type MemberExerciseRequest struct {
	...
	MemberIds          []int64  `protobuf:"varint,16,rep,packed,name=member_ids,json=memberIds,proto3" json:"member_ids,omitempty"`
	ParagraphIds       []int64  `protobuf:"varint,15,rep,packed,name=paragraph_ids,json=paragraphIds,proto3" json:"paragraph_ids,omitempty"`
	GroupIds           []int64  `protobuf:"varint,27,rep,packed,name=group_ids,json=groupIds,proto3" json:"group_ids,omitempty"`
	...
	Lookup             int64    `protobuf:"varint,21,opt,name=lookup,proto3" json:"lookup,omitempty"`
	GroupParentId      int64    `protobuf:"varint,26,opt,name=group_parent_id,json=groupParentId,proto3" json:"group_parent_id,omitempty"`
	CorrectTotal       int64    `protobuf:"varint,29,opt,name=correct_total,json=correctTotal,proto3" json:"correct_total,omitempty"`
	WrongTotal         int64    `protobuf:"varint,28,opt,name=wrong_total,json=wrongTotal,proto3" json:"wrong_total,omitempty"`
}
...
func (x *MemberExerciseRequest) GetGroupIds() []int64 {
	if x != nil {
		return x.GroupIds
	}
	return nil
...
func (x *MemberExerciseRequest) GetUpdatedAt() int64 {
	if x != nil {
		return x.UpdatedAt
	}
	return 0
...
func (x *MemberExerciseRequest) GetLookup() int64 {
	if x != nil {
		return x.Lookup
	}
	return 0
...
func (x *MemberExerciseRequest) GetGroupParentId() int64 {
	if x != nil {
...
func (x *MemberExerciseRequest) GetCorrectTotal() int64 {
	if x != nil {
		return x.CorrectTotal
	}
	return 0
...
func (x *MemberExerciseRequest) GetWrongTotal() int64 {
	if x != nil {
		return x.WrongTotal
	}
	return 0
...
type MemberQuiz struct {
	...
	Status     MemberQuiz_Status `protobuf:"varint,13,opt,name=status,proto3,enum=config.MemberQuiz_Status" json:"status,omitempty"`
}
...
var file_config_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x86, 0x01, 0x0a, 0x18, 0x53, 0x75, 0x6d, 0x41, 0x6c, 0x6c,
	0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x12, 0x19, 0x0a, 0x08, 0x73, 0x74, 0x61, 0x72, 0x74, 0x5f, 0x61, 0x74, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x73, 0x74, 0x61, 0x72, 0x74, 0x41, 0x74, 0x12, 0x15, 0x0a,
	0x06, 0x65, 0x6e, 0x64, 0x5f, 0x61, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x65,
	0x6e, 0x64, 0x41, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f,
	...
	,
	...
	0x04, 0x69, 0x74, 0x65, 0x6d, 0x22, 0x61, 0x0a, 0x06, 0x43, 0x6c, 0x61, 0x69, 0x6d, 0x73, 0x12,
	...
	0x73, 0x22, 0xde, 0x03, 0x0a, 0x07, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x0e, 0x0a,
	...
	0x65, 0x52, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x12, 0x26, 0x0a, 0x06, 0x6d, 0x65, 0x6d, 0x62, 0x65,
	0x72, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	...
	0x03, 0x52, 0x07, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x49, 0x64, 0x22, 0x35, 0x0a, 0x06, 0x53, 0x74,
	...
	0x02, 0x22, 0x2f, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65, 0x12, 0x10, 0x0a, 0x0c, 0x64, 0x65, 0x66,
	0x61, 0x75, 0x6c, 0x74, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x75,
	0x73, 0x65, 0x72, 0x10, 0x01, 0x12, 0x0b, 0x0a, 0x07, 0x74, 0x65, 0x61, 0x63, 0x68, 0x65, 0x72,
	0x10, 0x02, 0x22, 0x4d, 0x0a, 0x08, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x12, 0x2b,
	0x0a, 0x08, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x0f, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	...
	0x6c, 0x22, 0x50, 0x0a, 0x1b, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74,
	...
	0x65, 0x49, 0x64, 0x22, 0x51, 0x0a, 0x1c, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x52, 0x65, 0x67, 0x69,
	...
	0x76, 0x69, 0x63, 0x65, 0x49, 0x64, 0x22, 0x5f, 0x0a, 0x18, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79,
	...
	0x09, 0x52, 0x05, 0x70, 0x68, 0x6f, 0x6e, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x64, 0x65, 0x76, 0x69,
	0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x64, 0x65, 0x76,
	0x69, 0x63, 0x65, 0x49, 0x64, 0x12, 0x10, 0x0a, 0x03, 0x6f, 0x74, 0x70, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x03, 0x6f, 0x74, 0x70, 0x22, 0x4e, 0x0a, 0x19, 0x56, 0x65, 0x72, 0x69, 0x66,
	...
	0x65, 0x76, 0x69, 0x63, 0x65, 0x49, 0x64, 0x22, 0x83, 0x01, 0x0a, 0x16, 0x52, 0x65, 0x67, 0x69,
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x66, 0x75, 0x6c, 0x6c, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x68, 0x0a,
	...
	,
	...
	,
	...
	,
	...
	0x6f, 0x75, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x66, 0x75, 0x6c, 0x6c, 0x6e, 0x61,
	...
	,
	...
	0x12, 0x17, 0x0a, 0x07, 0x69, 0x73, 0x5f, 0x6d, 0x61, 0x69, 0x6e, 0x18, 0x07, 0x20, 0x01, 0x28,
	0x05, 0x52, 0x06, 0x69, 0x73, 0x4d, 0x61, 0x69, 0x6e, 0x12, 0x1d, 0x0a, 0x0a, 0x69, 0x73, 0x5f,
	0x6f, 0x6e, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x05, 0x52, 0x09, 0x69,
	0x73, 0x4f, 0x6e, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61,
	0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x12, 0x2d, 0x0a, 0x06,
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x15, 0x2e, 0x63,
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x2e, 0x53, 0x74, 0x61,
	...
	0x6e, 0x12, 0x1a, 0x0a, 0x08, 0x6e, 0x69, 0x63, 0x6b, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x0c, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x08, 0x6e, 0x69, 0x63, 0x6b, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x25, 0x0a,
	0x0e, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x5f, 0x71, 0x75, 0x61, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x18,
	0x0e, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0d, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x51, 0x75, 0x61, 0x6e,
	0x74, 0x69, 0x74, 0x79, 0x22, 0x35, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x11,
	...
	0x0a, 0x0a, 0x06, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x10, 0x02, 0x22, 0x49, 0x0a, 0x07, 0x4d,
	0x65, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x12, 0x28, 0x0a, 0x07, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72,
	0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	...
	0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x22, 0xc9, 0x03, 0x0a, 0x08, 0x43, 0x61, 0x74, 0x65, 0x67,
	...
	0x76, 0x69, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x56,
	0x69, 0x12, 0x12, 0x0a, 0x04, 0x6b, 0x65, 0x79, 0x78, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x04, 0x6b, 0x65, 0x79, 0x78, 0x12, 0x16, 0x0a, 0x06, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x78, 0x18,
	0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x78, 0x12, 0x1a, 0x0a,
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x17, 0x2e, 0x63, 0x6f,
	0x6e, 0x66, 0x69, 0x67, 0x2e, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x2e, 0x53, 0x74,
	...
	0x12, 0x3f, 0x0a, 0x0c, 0x69, 0x73, 0x5f, 0x66, 0x61, 0x76, 0x6f, 0x75, 0x72, 0x69, 0x74, 0x65,
	0x18, 0x0a, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e,
	0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x2e, 0x49, 0x73, 0x46, 0x61, 0x76, 0x6f, 0x75,
	...
	0x10, 0x02, 0x22, 0xd3, 0x02, 0x0a, 0x0f, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x52,
	...
	0x61, 0x72, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x73, 0x22, 0x54, 0x0a, 0x0a, 0x43, 0x61, 0x74, 0x65,
	0x67, 0x6f, 0x72, 0x69, 0x65, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x12, 0x30, 0x0a, 0x0a,
	0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x69, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x10, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f,
	0x72, 0x79, 0x52, 0x0a, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x69, 0x65, 0x73, 0x22, 0xf4,
	...
	,
	...
	0x52, 0x08, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x69,
	...
	0x69, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x73, 0x12, 0x1d, 0x0a, 0x0a, 0x70, 0x61, 0x72, 0x65,
	0x6e, 0x74, 0x5f, 0x69, 0x64, 0x73, 0x18, 0x0e, 0x20, 0x03, 0x28, 0x03, 0x52, 0x09, 0x70, 0x61,
	0x72, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x73, 0x22, 0xfd, 0x01, 0x0a, 0x06, 0x41, 0x63, 0x63, 0x65,
	...
	0x61, 0x69, 0x6e, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x61, 0x67, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x04, 0x70, 0x61, 0x67, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x63, 0x74, 0x69, 0x6f,
	...
	0x6e, 0x12, 0x2d, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x08, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x15, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x41, 0x63, 0x63, 0x65, 0x73,
	...
	0x63, 0x74, 0x69, 0x76, 0x65, 0x10, 0x02, 0x22, 0xb3, 0x02, 0x0a, 0x0d, 0x41, 0x63, 0x63, 0x65,
	0x73, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x17, 0x0a, 0x07, 0x72, 0x6f, 0x6c,
	...
	0x67, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x61, 0x67, 0x65, 0x12, 0x16,
	...
	,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x78, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x76, 0x61,
	0x6c, 0x75, 0x65, 0x78, 0x12, 0x1d, 0x0a, 0x0a, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x5f,
	...
	0x41, 0x74, 0x12, 0x35, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x07, 0x20, 0x01,
	0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x4d, 0x65, 0x6d, 0x62,
	0x65, 0x72, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x2c, 0x0a, 0x08, 0x63, 0x61, 0x74,
	0x65, 0x67, 0x6f, 0x72, 0x79, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x63, 0x6f,
	0x6e, 0x66, 0x69, 0x67, 0x2e, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x52, 0x08, 0x63,
	0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x22, 0x35, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75,
	...
	0x03, 0x0a, 0x15, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72,
	...
	0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x49, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x6d, 0x65, 0x6d,
	0x62, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x6d, 0x65,
	0x6d, 0x62, 0x65, 0x72, 0x49, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x78,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x78, 0x12, 0x1d,
	...
	0x65, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x69, 0x64, 0x73, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x03, 0x52,
	0x03, 0x69, 0x64, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x63, 0x6f, 0x6c, 0x73, 0x18, 0x0b, 0x20, 0x03,
	...
	,
	...
	,
	...
	0x74, 0x69, 0x76, 0x65, 0x10, 0x02, 0x22, 0x3b, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65, 0x12, 0x10,
	0x0a, 0x0c, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x10, 0x00,
	0x12, 0x0a, 0x0a, 0x06, 0x73, 0x63, 0x68, 0x6f, 0x6f, 0x6c, 0x10, 0x01, 0x12, 0x0a, 0x0a, 0x06,
	0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x10, 0x02, 0x12, 0x09, 0x0a, 0x05, 0x73, 0x6d, 0x61, 0x6c,
	0x6c, 0x10, 0x03, 0x22, 0x98, 0x03, 0x0a, 0x0c, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x52, 0x65, 0x71,
	...
	0x52, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65,
	...
	0x0a, 0x64, 0x69, 0x73, 0x74, 0x72, 0x69, 0x63, 0x74, 0x49, 0x64, 0x12, 0x17, 0x0a, 0x07, 0x77,
	0x61, 0x72, 0x64, 0x5f, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x77, 0x61,
	0x72, 0x64, 0x49, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x08,
	...
	0x6b, 0x65, 0x6e, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e,
	...
	,
	...
	0x01, 0x28, 0x03, 0x52, 0x06, 0x72, 0x6f, 0x6c, 0x65, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x63,
	...
	,
	...
	0x69, 0x76, 0x65, 0x10, 0x02, 0x22, 0xbc, 0x02, 0x0a, 0x13, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	...
	0x07, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x61, 0x63, 0x63, 0x6f,
	...
	,
	...
	0x1a, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x47,
	0x72, 0x6f, 0x75, 0x70, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x12, 0x4b, 0x0a, 0x0f, 0x61, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x65, 0x5f, 0x70,
	0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x22, 0x2e, 0x63,
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x47, 0x72, 0x6f, 0x75,
	0x70, 0x2e, 0x41, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x65, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73,
	...
	0x06, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x23, 0x0a, 0x05, 0x67, 0x72, 0x6f, 0x75, 0x70,
	0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e,
	0x47, 0x72, 0x6f, 0x75, 0x70, 0x52, 0x05, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x22, 0x35, 0x0a, 0x06,
	...
	0x65, 0x10, 0x02, 0x22, 0x4e, 0x0a, 0x0e, 0x41, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x65, 0x50, 0x72,
	0x6f, 0x63, 0x65, 0x73, 0x73, 0x12, 0x1b, 0x0a, 0x17, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74,
	0x5f, 0x61, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x65, 0x5f, 0x70, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73,
	0x10, 0x00, 0x12, 0x06, 0x0a, 0x02, 0x6e, 0x6f, 0x10, 0x01, 0x12, 0x0e, 0x0a, 0x0a, 0x70, 0x72,
	0x6f, 0x63, 0x65, 0x73, 0x73, 0x69, 0x6e, 0x67, 0x10, 0x02, 0x12, 0x07, 0x0a, 0x03, 0x79, 0x65,
	0x73, 0x10, 0x03, 0x22, 0xe8, 0x02, 0x0a, 0x12, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x47, 0x72,
	...
	0x6f, 0x75, 0x70, 0x49, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x5f,
	...
	,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x2c, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x0a,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x14, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x54, 0x6f,
	...
	0x06, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x10, 0x02, 0x22, 0xf8, 0x02, 0x0a, 0x0c, 0x54, 0x6f,
	...
	,
	...
	,
	...
	,
	...
	0x75, 0x61, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x12, 0x12, 0x0a, 0x04, 0x68, 0x61, 0x73, 0x68, 0x18,
	0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x68, 0x61, 0x73, 0x68, 0x22, 0xb8, 0x02, 0x0a, 0x13,
	...
	0x68, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x68, 0x61, 0x73, 0x68, 0x12, 0x16, 0x0a,
	0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x73,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x18, 0x09,
	...
	0x73, 0x65, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x69, 0x64, 0x73, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x03,
	0x52, 0x03, 0x69, 0x64, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x63, 0x6f, 0x6c, 0x73, 0x18, 0x0b, 0x20,
	...
	0x6c, 0x75, 0x64, 0x65, 0x73, 0x12, 0x1f, 0x0a, 0x0b, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	0x5f, 0x69, 0x64, 0x73, 0x18, 0x0e, 0x20, 0x03, 0x28, 0x03, 0x52, 0x0a, 0x61, 0x63, 0x63, 0x6f,
	0x75, 0x6e, 0x74, 0x49, 0x64, 0x73, 0x22, 0x62, 0x0a, 0x0d, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	0x74, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x12, 0x3b, 0x0a, 0x0e, 0x61, 0x63, 0x63, 0x6f, 0x75,
	0x6e, 0x74, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x14, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	...
	0x01, 0x28, 0x05, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x22, 0x85, 0x01, 0x0a, 0x0b, 0x4d,
	...
	0x73, 0x68, 0x22, 0xb5, 0x02, 0x0a, 0x12, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x54, 0x6f, 0x6b,
	...
	,
	...
	0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0xf6, 0x02, 0x0a, 0x15, 0x4d, 0x65,
	0x6d, 0x62, 0x65, 0x72, 0x50, 0x72, 0x61, 0x63, 0x74, 0x69, 0x63, 0x65, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52,
	...
	0x0a, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x6f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x12, 0x10, 0x0a,
	0x03, 0x69, 0x64, 0x73, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x03, 0x52, 0x03, 0x69, 0x64, 0x73, 0x12,
	...
	0x1f, 0x0a, 0x0b, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x73, 0x18, 0x0e,
	...
	0x18, 0x0f, 0x20, 0x03, 0x28, 0x03, 0x52, 0x0b, 0x71, 0x75, 0x65, 0x73, 0x74, 0x69, 0x6f, 0x6e,
	0x49, 0x64, 0x73, 0x12, 0x1d, 0x0a, 0x0a, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x5f, 0x69, 0x64,
	0x73, 0x18, 0x10, 0x20, 0x03, 0x28, 0x03, 0x52, 0x09, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x49,
	0x64, 0x73, 0x22, 0x6a, 0x0a, 0x0f, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x50, 0x72, 0x61, 0x63,
	0x74, 0x69, 0x63, 0x65, 0x73, 0x12, 0x41, 0x0a, 0x10, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x5f,
	0x70, 0x72, 0x61, 0x63, 0x74, 0x69, 0x63, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32,
	...
	0x01, 0x28, 0x03, 0x52, 0x07, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x49, 0x64, 0x12, 0x21, 0x0a, 0x0c,
	...
	0x64, 0x5f, 0x61, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x65, 0x6e, 0x64, 0x41,
	...
	0x32, 0x1e, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	0x74, 0x45, 0x78, 0x65, 0x72, 0x63, 0x69, 0x73, 0x65, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
	...
	0x09, 0x70, 0x61, 0x72, 0x61, 0x67, 0x72, 0x61, 0x70, 0x68, 0x12, 0x1d, 0x0a, 0x0a, 0x6d, 0x65,
	0x6d, 0x62, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x73, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x03, 0x52, 0x09,
	0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x49, 0x64, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x6d,
	...
	0x73, 0x74, 0x61, 0x74, 0x65, 0x10, 0x00, 0x12, 0x0c, 0x0a, 0x08, 0x64, 0x65, 0x61, 0x63, 0x74,
	0x69, 0x76, 0x65, 0x10, 0x01, 0x12, 0x0a, 0x0a, 0x06, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x10,
	0x02, 0x22, 0xf6, 0x03, 0x0a, 0x16, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x45, 0x78, 0x65,
	...
	0x72, 0x6f, 0x75, 0x70, 0x49, 0x64, 0x12, 0x21, 0x0a, 0x0c, 0x70, 0x61, 0x72, 0x61, 0x67, 0x72,
	0x61, 0x70, 0x68, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0b, 0x70, 0x61,
	0x72, 0x61, 0x67, 0x72, 0x61, 0x70, 0x68, 0x49, 0x64, 0x12, 0x19, 0x0a, 0x08, 0x73, 0x74, 0x61,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x65, 0x6e, 0x64, 0x41, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x63,
	...
	0x64, 0x73, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x03, 0x52, 0x03, 0x69, 0x64, 0x73, 0x12, 0x12, 0x0a,
	...
	,
	...
	0x45, 0x78, 0x65, 0x72, 0x63, 0x69, 0x73, 0x65, 0x52, 0x10, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	0x74, 0x45, 0x78, 0x65, 0x72, 0x63, 0x69, 0x73, 0x65, 0x73, 0x22, 0xd1, 0x06, 0x0a, 0x0e, 0x4d,
	0x65, 0x6d, 0x62, 0x65, 0x72, 0x45, 0x78, 0x65, 0x72, 0x63, 0x69, 0x73, 0x65, 0x12, 0x0e, 0x0a,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x41, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x0b, 0x20, 0x01,
	...
	,
	...
	0x12, 0x1b, 0x0a, 0x09, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x5f, 0x69, 0x64, 0x73, 0x18, 0x1b, 0x20,
	0x03, 0x28, 0x03, 0x52, 0x08, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x49, 0x64, 0x73, 0x12, 0x14, 0x0a,
	0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x16, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f,
	0x6b, 0x65, 0x6e, 0x12, 0x1d, 0x0a, 0x0a, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x69,
	0x64, 0x18, 0x17, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	0x49, 0x64, 0x12, 0x19, 0x0a, 0x08, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x5f, 0x69, 0x64, 0x18, 0x18,
	...
	,
	...
	,
	...
	0x74, 0x52, 0x08, 0x64, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x70,
	...
	0x12, 0x0a, 0x0a, 0x06, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x10, 0x02, 0x22, 0x5e, 0x0a, 0x0e,
	0x41, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x65, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x12, 0x14,
	...
	0x6e, 0x5f, 0x61, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x65, 0x64, 0x10, 0x03, 0x22, 0xe9, 0x02, 0x0a,
	0x14, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x44, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65,
	...
	0x27, 0x0a, 0x0f, 0x61, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x65, 0x5f, 0x70, 0x72, 0x6f, 0x63, 0x65,
	0x73, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0e, 0x61, 0x70, 0x70, 0x72, 0x6f, 0x76,
	0x65, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x69, 0x6d, 0x69,
	...
	,
	...
	0x22, 0xc2, 0x03, 0x0a, 0x0a, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x51, 0x75, 0x69, 0x7a, 0x12,
	...
	0x69, 0x7a, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x18, 0x05, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x05, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x12, 0x1f, 0x0a, 0x0b, 0x70, 0x6f,
	0x69, 0x6e, 0x74, 0x5f, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x0a, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x12, 0x19, 0x0a, 0x08, 0x62,
	0x65, 0x67, 0x69, 0x6e, 0x5f, 0x61, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x62,
	0x65, 0x67, 0x69, 0x6e, 0x41, 0x74, 0x12, 0x15, 0x0a, 0x06, 0x65, 0x6e, 0x64, 0x5f, 0x61, 0x74,
	0x18, 0x08, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x65, 0x6e, 0x64, 0x41, 0x74, 0x12, 0x1d, 0x0a,
	...
	,
	...
	0x49, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x05, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x12, 0x1f, 0x0a, 0x0b, 0x70, 0x6f, 0x69, 0x6e,
	0x74, 0x5f, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0a, 0x70,
	0x6f, 0x69, 0x6e, 0x74, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x12, 0x19, 0x0a, 0x08, 0x62, 0x65, 0x67,
	0x69, 0x6e, 0x5f, 0x61, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x62, 0x65, 0x67,
	0x69, 0x6e, 0x41, 0x74, 0x12, 0x15, 0x0a, 0x06, 0x65, 0x6e, 0x64, 0x5f, 0x61, 0x74, 0x18, 0x08,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x65, 0x6e, 0x64, 0x41, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x73,
	...
	0x6e, 0x69, 0x73, 0x68, 0x65, 0x64, 0x5f, 0x61, 0x74, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x03, 0x52,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x61, 0x64, 0x65, 0x72, 0x2f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_config_proto_enumTypes = make([]protoimpl.EnumInfo, 19)
...
var file_config_proto_goTypes = []interface{}{
	...
	(Product_Status)(0),                  // 13: config.Product.Status
	(AccountExercise_Status)(0),          // 14: config.AccountExercise.Status
	(MemberExercise_Status)(0),           // 15: config.MemberExercise.Status
	(GroupDocument_Status)(0),            // 16: config.GroupDocument.Status
	(GroupDocument_ApproveProcess)(0),    // 17: config.GroupDocument.ApproveProcess
	(MemberQuiz_Status)(0),               // 18: config.MemberQuiz.Status
	(*SumAllMemberGroupRequest)(nil),     // 19: config.SumAllMemberGroupRequest
	(*SumAllMemberGroupResponse)(nil),    // 20: config.SumAllMemberGroupResponse
	(*ReportMember)(nil),                 // 21: config.ReportMember
	(*Claims)(nil),                       // 22: config.Claims
	(*AccountRequest)(nil),               // 23: config.AccountRequest
	(*Account)(nil),                      // 24: config.Account
	(*Accounts)(nil),                     // 25: config.Accounts
	(*CheckRegisterAccountRequest)(nil),  // 26: config.CheckRegisterAccountRequest
	(*CheckRegisterAccountResponse)(nil), // 27: config.CheckRegisterAccountResponse
	(*VerifyOtpRegisterRequest)(nil),     // 28: config.VerifyOtpRegisterRequest
	(*VerifyOtpRegisterResponse)(nil),    // 29: config.VerifyOtpRegisterResponse
	(*RegisterAccountRequest)(nil),       // 30: config.RegisterAccountRequest
	(*RegisterAccountResponse)(nil),      // 31: config.RegisterAccountResponse
	(*LoginAccountRequest)(nil),          // 32: config.LoginAccountRequest
	(*LoginAccountResponse)(nil),         // 33: config.LoginAccountResponse
	(*LoginMemberResponse)(nil),          // 34: config.LoginMemberResponse
	(*AccessToken)(nil),                  // 35: config.AccessToken
	(*MemberRequest)(nil),                // 36: config.MemberRequest
	(*Member)(nil),                       // 37: config.Member
	(*Members)(nil),                      // 38: config.Members
	(*Category)(nil),                     // 39: config.Category
	(*CategoryRequest)(nil),              // 40: config.CategoryRequest
	(*Categories)(nil),                   // 41: config.Categories
	(*Role)(nil),                         // 42: config.Role
	(*Roles)(nil),                        // 43: config.Roles
	(*RoleRequest)(nil),                  // 44: config.RoleRequest
	(*Access)(nil),                       // 45: config.Access
	(*AccessRequest)(nil),                // 46: config.AccessRequest
	(*Accesses)(nil),                     // 47: config.Accesses
	(*MemberCategory)(nil),               // 48: config.MemberCategory
	(*MemberCategoryRequest)(nil),        // 49: config.MemberCategoryRequest
	(*MemberCategories)(nil),             // 50: config.MemberCategories
	(*Group)(nil),                        // 51: config.Group
	(*GroupRequest)(nil),                 // 52: config.GroupRequest
	(*Groups)(nil),                       // 53: config.Groups
	(*AccountGroup)(nil),                 // 54: config.AccountGroup
	(*AccountGroupRequest)(nil),          // 55: config.AccountGroupRequest
	(*AccountGroups)(nil),                // 56: config.AccountGroups
	(*MemberGroup)(nil),                  // 57: config.MemberGroup
	(*MemberGroupRequest)(nil),           // 58: config.MemberGroupRequest
	(*MemberGroups)(nil),                 // 59: config.MemberGroups
	(*Token)(nil),                        // 60: config.Token
	(*TokenRequest)(nil),                 // 61: config.TokenRequest
	(*Tokens)(nil),                       // 62: config.Tokens
	(*Product)(nil),                      // 63: config.Product
	(*ProductRequest)(nil),               // 64: config.ProductRequest
	(*Products)(nil),                     // 65: config.Products
	(*AccountToken)(nil),                 // 66: config.AccountToken
	(*AccountTokenRequest)(nil),          // 67: config.AccountTokenRequest
	(*AccountTokens)(nil),                // 68: config.AccountTokens
	(*MemberToken)(nil),                  // 69: config.MemberToken
	(*MemberTokenRequest)(nil),           // 70: config.MemberTokenRequest
	(*MemberPractice)(nil),               // 71: config.MemberPractice
	(*MemberPracticeRequest)(nil),        // 72: config.MemberPracticeRequest
	(*MemberPractices)(nil),              // 73: config.MemberPractices
	(*AccountExercise)(nil),              // 74: config.AccountExercise
	(*AccountExerciseRequest)(nil),       // 75: config.AccountExerciseRequest
	(*AccountExercises)(nil),             // 76: config.AccountExercises
	(*MemberExercise)(nil),               // 77: config.MemberExercise
	(*MemberExerciseRequest)(nil),        // 78: config.MemberExerciseRequest
	(*MemberExercises)(nil),              // 79: config.MemberExercises
	(*GroupDocument)(nil),                // 80: config.GroupDocument
	(*GroupDocumentRequest)(nil),         // 81: config.GroupDocumentRequest
	(*GroupDocuments)(nil),               // 82: config.GroupDocuments
	(*MemberQuiz)(nil),                   // 83: config.MemberQuiz
	(*MemberQuizzes)(nil),                // 84: config.MemberQuizzes
	(*MemberQuizRequest)(nil),            // 85: config.MemberQuizRequest
	nil,                                  // 86: config.Role.ListAccessEntry
	(*library.Paragraph)(nil),            // 87: library.Paragraph
	(*library.Document)(nil),             // 88: library.Document
}
var file_config_proto_depIdxs = []int32{
	21,  // 0: config.SumAllMemberGroupResponse.report_member_groups:type_name -> config.ReportMember
	0,   // 1: config.Account.status:type_name -> config.Account.Status
	1,   // 2: config.Account.type:type_name -> config.Account.Type
	42,  // 3: config.Account.role:type_name -> config.Role
	37,  // 4: config.Account.member:type_name -> config.Member
	24,  // 5: config.Accounts.accounts:type_name -> config.Account
	22,  // 6: config.LoginAccountResponse.claim:type_name -> config.Claims
	24,  // 7: config.LoginAccountResponse.account:type_name -> config.Account
	37,  // 8: config.LoginAccountResponse.members:type_name -> config.Member
	48,  // 9: config.LoginAccountResponse.member_categories:type_name -> config.MemberCategory
	22,  // 10: config.LoginMemberResponse.claim:type_name -> config.Claims
	24,  // 11: config.LoginMemberResponse.account:type_name -> config.Account
	37,  // 12: config.LoginMemberResponse.member:type_name -> config.Member
	48,  // 13: config.LoginMemberResponse.member_categories:type_name -> config.MemberCategory
	22,  // 14: config.AccessToken.claims:type_name -> config.Claims
	2,   // 15: config.Member.status:type_name -> config.Member.Status
	37,  // 16: config.Members.members:type_name -> config.Member
	3,   // 17: config.Category.status:type_name -> config.Category.Status
	4,   // 18: config.Category.is_favourite:type_name -> config.Category.IsFavourite
	39,  // 19: config.Categories.categories:type_name -> config.Category
	47,  // 20: config.Role.accesses:type_name -> config.Accesses
	86,  // 21: config.Role.list_access:type_name -> config.Role.ListAccessEntry
	42,  // 22: config.Roles.roles:type_name -> config.Role
	5,   // 23: config.Access.status:type_name -> config.Access.Status
	45,  // 24: config.Accesses.accesses:type_name -> config.Access
	6,   // 25: config.MemberCategory.status:type_name -> config.MemberCategory.Status
	39,  // 26: config.MemberCategory.category:type_name -> config.Category
	48,  // 27: config.MemberCategories.member_categories:type_name -> config.MemberCategory
	7,   // 28: config.Group.status:type_name -> config.Group.Status
	8,   // 29: config.Group.type:type_name -> config.Group.Type
	54,  // 30: config.Group.account_groups:type_name -> config.AccountGroup
	57,  // 31: config.Group.member_groups:type_name -> config.MemberGroup
	24,  // 32: config.Group.account_manager:type_name -> config.Account
	51,  // 33: config.Groups.groups:type_name -> config.Group
	51,  // 34: config.Groups.group_parent:type_name -> config.Group
	9,   // 35: config.AccountGroup.status:type_name -> config.AccountGroup.Status
	24,  // 36: config.AccountGroup.account:type_name -> config.Account
	51,  // 37: config.AccountGroup.group:type_name -> config.Group
	54,  // 38: config.AccountGroups.account_groups:type_name -> config.AccountGroup
	10,  // 39: config.MemberGroup.status:type_name -> config.MemberGroup.Status
	11,  // 40: config.MemberGroup.approve_process:type_name -> config.MemberGroup.ApproveProcess
	37,  // 41: config.MemberGroup.member:type_name -> config.Member
	51,  // 42: config.MemberGroup.group:type_name -> config.Group
	57,  // 43: config.MemberGroups.member_groups:type_name -> config.MemberGroup
	12,  // 44: config.Token.status:type_name -> config.Token.Status
	60,  // 45: config.Tokens.tokens:type_name -> config.Token
	60,  // 46: config.Product.token:type_name -> config.Token
	63,  // 47: config.Products.products:type_name -> config.Product
	66,  // 48: config.AccountTokens.account_tokens:type_name -> config.AccountToken
	71,  // 49: config.MemberPractices.member_practices:type_name -> config.MemberPractice
	14,  // 50: config.AccountExercise.status:type_name -> config.AccountExercise.Status
	87,  // 51: config.AccountExercise.paragraph:type_name -> library.Paragraph
	24,  // 52: config.AccountExercise.account:type_name -> config.Account
	51,  // 53: config.AccountExercise.Group:type_name -> config.Group
	74,  // 54: config.AccountExercises.account_exercises:type_name -> config.AccountExercise
	15,  // 55: config.MemberExercise.status:type_name -> config.MemberExercise.Status
	87,  // 56: config.MemberExercise.paragraph:type_name -> library.Paragraph
	74,  // 57: config.MemberExercise.account_exercise:type_name -> config.AccountExercise
	37,  // 58: config.MemberExercise.member:type_name -> config.Member
	77,  // 59: config.MemberExercises.member_exercises:type_name -> config.MemberExercise
	16,  // 60: config.GroupDocument.status:type_name -> config.GroupDocument.Status
	17,  // 61: config.GroupDocument.approve_process:type_name -> config.GroupDocument.ApproveProcess
	51,  // 62: config.GroupDocument.group:type_name -> config.Group
	88,  // 63: config.GroupDocument.document:type_name -> library.Document
	80,  // 64: config.GroupDocuments.group_documents:type_name -> config.GroupDocument
	18,  // 65: config.MemberQuiz.status:type_name -> config.MemberQuiz.Status
	83,  // 66: config.MemberQuizzes.member_quizzes:type_name -> config.MemberQuiz
	26,  // 67: config.ConfigService.CheckRegisterAccount:input_type -> config.CheckRegisterAccountRequest
	28,  // 68: config.ConfigService.VerifyOtpRegister:input_type -> config.VerifyOtpRegisterRequest
	30,  // 69: config.ConfigService.RegisterAccount:input_type -> config.RegisterAccountRequest
	32,  // 70: config.ConfigService.Login:input_type -> config.LoginAccountRequest
	36,  // 71: config.ConfigService.MemberLogin:input_type -> config.MemberRequest
	37,  // 72: config.ConfigService.ChangeMemberPassword:input_type -> config.Member
	23,  // 73: config.ConfigService.ListAccounts:input_type -> config.AccountRequest
	23,  // 74: config.ConfigService.UpdateAccount:input_type -> config.AccountRequest
	36,  // 75: config.ConfigService.ListMembers:input_type -> config.MemberRequest
	37,  // 76: config.ConfigService.CreateMember:input_type -> config.Member
	37,  // 77: config.ConfigService.GetMember:input_type -> config.Member
	40,  // 78: config.ConfigService.ListCategories:input_type -> config.CategoryRequest
	48,  // 79: config.ConfigService.CreateMemberCategory:input_type -> config.MemberCategory
	48,  // 80: config.ConfigService.GetMemberCategory:input_type -> config.MemberCategory
	49,  // 81: config.ConfigService.ListMemberCategories:input_type -> config.MemberCategoryRequest
	72,  // 82: config.ConfigService.ListMemberPractice:input_type -> config.MemberPracticeRequest
	71,  // 83: config.ConfigService.CreateMemberPractice:input_type -> config.MemberPractice
	52,  // 84: config.ConfigService.ListGroup:input_type -> config.GroupRequest
	58,  // 85: config.ConfigService.ListMemberGroup:input_type -> config.MemberGroupRequest
	52,  // 86: config.ConfigService.GetGroup:input_type -> config.GroupRequest
	51,  // 87: config.ConfigService.CreateGroup:input_type -> config.Group
	57,  // 88: config.ConfigService.CreateMemberGroup:input_type -> config.MemberGroup
	57,  // 89: config.ConfigService.ApproveMemberToGroup:input_type -> config.MemberGroup
	55,  // 90: config.ConfigService.ListAccountGroup:input_type -> config.AccountGroupRequest
	54,  // 91: config.ConfigService.CreateAccountGroup:input_type -> config.AccountGroup
	74,  // 92: config.ConfigService.CreateAccountExercise:input_type -> config.AccountExercise
	75,  // 93: config.ConfigService.ListAccountExercises:input_type -> config.AccountExerciseRequest
	77,  // 94: config.ConfigService.CreateMemberExercise:input_type -> config.MemberExercise
	78,  // 95: config.ConfigService.ListMemberExercise:input_type -> config.MemberExerciseRequest
	81,  // 96: config.ConfigService.ListGroupDocument:input_type -> config.GroupDocumentRequest
	80,  // 97: config.ConfigService.CreateGroupDocument:input_type -> config.GroupDocument
	80,  // 98: config.ConfigService.UpdateGroupDocument:input_type -> config.GroupDocument
	82,  // 99: config.ConfigService.SortGroupDocument:input_type -> config.GroupDocuments
	78,  // 100: config.ConfigService.GetMemberExercise:input_type -> config.MemberExerciseRequest
	78,  // 101: config.ConfigService.UpdateMemberExercise:input_type -> config.MemberExerciseRequest
	58,  // 102: config.ConfigService.CreateMemberGroups:input_type -> config.MemberGroupRequest
	24,  // 103: config.ConfigService.CreateAccount:input_type -> config.Account
	52,  // 104: config.ConfigService.CountGroup:input_type -> config.GroupRequest
	19,  // 105: config.ConfigService.SumAllMemberGroup:input_type -> config.SumAllMemberGroupRequest
	64,  // 106: config.ConfigService.ListProducts:input_type -> config.ProductRequest
	64,  // 107: config.ConfigService.GetProduct:input_type -> config.ProductRequest
	83,  // 108: config.ConfigService.CreateQuizMember:input_type -> config.MemberQuiz
	85,  // 109: config.ConfigService.ListQuizMembers:input_type -> config.MemberQuizRequest
	83,  // 110: config.ConfigService.UpdateQuizMember:input_type -> config.MemberQuiz
	27,  // 111: config.ConfigService.CheckRegisterAccount:output_type -> config.CheckRegisterAccountResponse
	29,  // 112: config.ConfigService.VerifyOtpRegister:output_type -> config.VerifyOtpRegisterResponse
	24,  // 113: config.ConfigService.RegisterAccount:output_type -> config.Account
	33,  // 114: config.ConfigService.Login:output_type -> config.LoginAccountResponse
	34,  // 115: config.ConfigService.MemberLogin:output_type -> config.LoginMemberResponse
	37,  // 116: config.ConfigService.ChangeMemberPassword:output_type -> config.Member
	25,  // 117: config.ConfigService.ListAccounts:output_type -> config.Accounts
	24,  // 118: config.ConfigService.UpdateAccount:output_type -> config.Account
	38,  // 119: config.ConfigService.ListMembers:output_type -> config.Members
	37,  // 120: config.ConfigService.CreateMember:output_type -> config.Member
	37,  // 121: config.ConfigService.GetMember:output_type -> config.Member
	41,  // 122: config.ConfigService.ListCategories:output_type -> config.Categories
	48,  // 123: config.ConfigService.CreateMemberCategory:output_type -> config.MemberCategory
	48,  // 124: config.ConfigService.GetMemberCategory:output_type -> config.MemberCategory
	50,  // 125: config.ConfigService.ListMemberCategories:output_type -> config.MemberCategories
	73,  // 126: config.ConfigService.ListMemberPractice:output_type -> config.MemberPractices
	71,  // 127: config.ConfigService.CreateMemberPractice:output_type -> config.MemberPractice
	53,  // 128: config.ConfigService.ListGroup:output_type -> config.Groups
	59,  // 129: config.ConfigService.ListMemberGroup:output_type -> config.MemberGroups
	51,  // 130: config.ConfigService.GetGroup:output_type -> config.Group
	51,  // 131: config.ConfigService.CreateGroup:output_type -> config.Group
	57,  // 132: config.ConfigService.CreateMemberGroup:output_type -> config.MemberGroup
	57,  // 133: config.ConfigService.ApproveMemberToGroup:output_type -> config.MemberGroup
	56,  // 134: config.ConfigService.ListAccountGroup:output_type -> config.AccountGroups
	54,  // 135: config.ConfigService.CreateAccountGroup:output_type -> config.AccountGroup
	74,  // 136: config.ConfigService.CreateAccountExercise:output_type -> config.AccountExercise
	76,  // 137: config.ConfigService.ListAccountExercises:output_type -> config.AccountExercises
	79,  // 138: config.ConfigService.CreateMemberExercise:output_type -> config.MemberExercises
	79,  // 139: config.ConfigService.ListMemberExercise:output_type -> config.MemberExercises
	82,  // 140: config.ConfigService.ListGroupDocument:output_type -> config.GroupDocuments
	80,  // 141: config.ConfigService.CreateGroupDocument:output_type -> config.GroupDocument
	80,  // 142: config.ConfigService.UpdateGroupDocument:output_type -> config.GroupDocument
	82,  // 143: config.ConfigService.SortGroupDocument:output_type -> config.GroupDocuments
	77,  // 144: config.ConfigService.GetMemberExercise:output_type -> config.MemberExercise
	77,  // 145: config.ConfigService.UpdateMemberExercise:output_type -> config.MemberExercise
	59,  // 146: config.ConfigService.CreateMemberGroups:output_type -> config.MemberGroups
	24,  // 147: config.ConfigService.CreateAccount:output_type -> config.Account
	53,  // 148: config.ConfigService.CountGroup:output_type -> config.Groups
	20,  // 149: config.ConfigService.SumAllMemberGroup:output_type -> config.SumAllMemberGroupResponse
	65,  // 150: config.ConfigService.ListProducts:output_type -> config.Products
	63,  // 151: config.ConfigService.GetProduct:output_type -> config.Product
	83,  // 152: config.ConfigService.CreateQuizMember:output_type -> config.MemberQuiz
	84,  // 153: config.ConfigService.ListQuizMembers:output_type -> config.MemberQuizzes
	83,  // 154: config.ConfigService.UpdateQuizMember:output_type -> config.MemberQuiz
	111, // [111:155] is the sub-list for method output_type
	67,  // [67:111] is the sub-list for method input_type
...
func file_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_config_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SumAllMemberGroupRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_config_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SumAllMemberGroupResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_config_proto_msgTypes[65].Exporter = func(v interface{}, i int) interface{} {
		...
		file_config_proto_msgTypes[66].Exporter = func(v interface{}, i int) interface{} {
