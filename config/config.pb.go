...
var file_config_proto_goTypes = []interface{}{
	...
	(*SumAllMemberGroupRequest)(nil),     // 18: config.SumAllMemberGroupRequest
	(*SumAllMemberGroupResponse)(nil),    // 19: config.SumAllMemberGroupResponse
	(*ReportMember)(nil),                 // 20: config.ReportMember
	(*Claims)(nil),                       // 21: config.Claims
	(*AccountRequest)(nil),               // 22: config.AccountRequest
	(*Account)(nil),                      // 23: config.Account
	(*Accounts)(nil),                     // 24: config.Accounts
	(*CheckRegisterAccountRequest)(nil),  // 25: config.CheckRegisterAccountRequest
	(*CheckRegisterAccountResponse)(nil), // 26: config.CheckRegisterAccountResponse
	(*VerifyOtpRegisterRequest)(nil),     // 27: config.VerifyOtpRegisterRequest
	(*VerifyOtpRegisterResponse)(nil),    // 28: config.VerifyOtpRegisterResponse
	(*RegisterAccountRequest)(nil),       // 29: config.RegisterAccountRequest
	(*RegisterAccountResponse)(nil),      // 30: config.RegisterAccountResponse
	(*LoginAccountRequest)(nil),          // 31: config.LoginAccountRequest
	(*LoginAccountResponse)(nil),         // 32: config.LoginAccountResponse
	(*LoginMemberResponse)(nil),          // 33: config.LoginMemberResponse
	(*AccessToken)(nil),                  // 34: config.AccessToken
	(*MemberRequest)(nil),                // 35: config.MemberRequest
	(*Member)(nil),                       // 36: config.Member
	(*Members)(nil),                      // 37: config.Members
	(*Category)(nil),                     // 38: config.Category
	(*CategoryRequest)(nil),              // 39: config.CategoryRequest
	(*Categories)(nil),                   // 40: config.Categories
	(*Role)(nil),                         // 41: config.Role
	(*Roles)(nil),                        // 42: config.Roles
	(*RoleRequest)(nil),                  // 43: config.RoleRequest
	(*Access)(nil),                       // 44: config.Access
	(*AccessRequest)(nil),                // 45: config.AccessRequest
	(*Accesses)(nil),                     // 46: config.Accesses
	(*MemberCategory)(nil),               // 47: config.MemberCategory
	(*MemberCategoryRequest)(nil),        // 48: config.MemberCategoryRequest
	(*MemberCategories)(nil),             // 49: config.MemberCategories
	(*Group)(nil),                        // 50: config.Group
	(*GroupRequest)(nil),                 // 51: config.GroupRequest
	(*Groups)(nil),                       // 52: config.Groups
	(*AccountGroup)(nil),                 // 53: config.AccountGroup
	(*AccountGroupRequest)(nil),          // 54: config.AccountGroupRequest
	(*AccountGroups)(nil),                // 55: config.AccountGroups
	(*MemberGroup)(nil),                  // 56: config.MemberGroup
	(*MemberGroupRequest)(nil),           // 57: config.MemberGroupRequest
	(*MemberGroups)(nil),                 // 58: config.MemberGroups
	(*Token)(nil),                        // 59: config.Token
	(*TokenRequest)(nil),                 // 60: config.TokenRequest
	(*Tokens)(nil),                       // 61: config.Tokens
	(*Product)(nil),                      // 62: config.Product
	(*ProductRequest)(nil),               // 63: config.ProductRequest
	(*Products)(nil),                     // 64: config.Products
	(*AccountToken)(nil),                 // 65: config.AccountToken
	(*AccountTokenRequest)(nil),          // 66: config.AccountTokenRequest
	(*AccountTokens)(nil),                // 67: config.AccountTokens
	(*MemberToken)(nil),                  // 68: config.MemberToken
	(*MemberTokenRequest)(nil),           // 69: config.MemberTokenRequest
	(*MemberPractice)(nil),               // 70: config.MemberPractice
	(*MemberPracticeRequest)(nil),        // 71: config.MemberPracticeRequest
	(*MemberPractices)(nil),              // 72: config.MemberPractices
	(*AccountExercise)(nil),              // 73: config.AccountExercise
	(*AccountExerciseRequest)(nil),       // 74: config.AccountExerciseRequest
	(*AccountExercises)(nil),             // 75: config.AccountExercises
	(*MemberExercise)(nil),               // 76: config.MemberExercise
	(*MemberExerciseRequest)(nil),        // 77: config.MemberExerciseRequest
	(*MemberExercises)(nil),              // 78: config.MemberExercises
	(*GroupDocument)(nil),                // 79: config.GroupDocument
	(*GroupDocumentRequest)(nil),         // 80: config.GroupDocumentRequest
	(*GroupDocuments)(nil),               // 81: config.GroupDocuments
	nil,                                  // 82: config.Role.ListAccessEntry
	(*library.Paragraph)(nil),            // 83: library.Paragraph
	(*library.Document)(nil),             // 84: library.Document
}
var file_config_proto_depIdxs = []int32{
	20,  // 0: config.SumAllMemberGroupResponse.report_member_groups:type_name -> config.ReportMember
	0,   // 1: config.Account.status:type_name -> config.Account.Status
	1,   // 2: config.Account.type:type_name -> config.Account.Type
	41,  // 3: config.Account.role:type_name -> config.Role
	36,  // 4: config.Account.member:type_name -> config.Member
	23,  // 5: config.Accounts.accounts:type_name -> config.Account
	21,  // 6: config.LoginAccountResponse.claim:type_name -> config.Claims
	23,  // 7: config.LoginAccountResponse.account:type_name -> config.Account
	36,  // 8: config.LoginAccountResponse.members:type_name -> config.Member
	47,  // 9: config.LoginAccountResponse.member_categories:type_name -> config.MemberCategory
	21,  // 10: config.LoginMemberResponse.claim:type_name -> config.Claims
	23,  // 11: config.LoginMemberResponse.account:type_name -> config.Account
	36,  // 12: config.LoginMemberResponse.member:type_name -> config.Member
	47,  // 13: config.LoginMemberResponse.member_categories:type_name -> config.MemberCategory
	21,  // 14: config.AccessToken.claims:type_name -> config.Claims
	2,   // 15: config.Member.status:type_name -> config.Member.Status
	36,  // 16: config.Members.members:type_name -> config.Member
	...
	38,  // 19: config.Categories.categories:type_name -> config.Category
	46,  // 20: config.Role.accesses:type_name -> config.Accesses
	82,  // 21: config.Role.list_access:type_name -> config.Role.ListAccessEntry
	41,  // 22: config.Roles.roles:type_name -> config.Role
	5,   // 23: config.Access.status:type_name -> config.Access.Status
	44,  // 24: config.Accesses.accesses:type_name -> config.Access
	6,   // 25: config.MemberCategory.status:type_name -> config.MemberCategory.Status
	38,  // 26: config.MemberCategory.category:type_name -> config.Category
	47,  // 27: config.MemberCategories.member_categories:type_name -> config.MemberCategory
	7,   // 28: config.Group.status:type_name -> config.Group.Status
	8,   // 29: config.Group.type:type_name -> config.Group.Type
	53,  // 30: config.Group.account_groups:type_name -> config.AccountGroup
	56,  // 31: config.Group.member_groups:type_name -> config.MemberGroup
	23,  // 32: config.Group.account_manager:type_name -> config.Account
	50,  // 33: config.Groups.groups:type_name -> config.Group
	50,  // 34: config.Groups.group_parent:type_name -> config.Group
	9,   // 35: config.AccountGroup.status:type_name -> config.AccountGroup.Status
	23,  // 36: config.AccountGroup.account:type_name -> config.Account
	50,  // 37: config.AccountGroup.group:type_name -> config.Group
	53,  // 38: config.AccountGroups.account_groups:type_name -> config.AccountGroup
	...
	36,  // 41: config.MemberGroup.member:type_name -> config.Member
	50,  // 42: config.MemberGroup.group:type_name -> config.Group
	56,  // 43: config.MemberGroups.member_groups:type_name -> config.MemberGroup
	12,  // 44: config.Token.status:type_name -> config.Token.Status
	59,  // 45: config.Tokens.tokens:type_name -> config.Token
	59,  // 46: config.Product.token:type_name -> config.Token
	62,  // 47: config.Products.products:type_name -> config.Product
	65,  // 48: config.AccountTokens.account_tokens:type_name -> config.AccountToken
	70,  // 49: config.MemberPractices.member_practices:type_name -> config.MemberPractice
	14,  // 50: config.AccountExercise.status:type_name -> config.AccountExercise.Status
	83,  // 51: config.AccountExercise.paragraph:type_name -> library.Paragraph
	23,  // 52: config.AccountExercise.account:type_name -> config.Account
	50,  // 53: config.AccountExercise.Group:type_name -> config.Group
	73,  // 54: config.AccountExercises.account_exercises:type_name -> config.AccountExercise
	15,  // 55: config.MemberExercise.status:type_name -> config.MemberExercise.Status
	83,  // 56: config.MemberExercise.paragraph:type_name -> library.Paragraph
	73,  // 57: config.MemberExercise.account_exercise:type_name -> config.AccountExercise
	36,  // 58: config.MemberExercise.member:type_name -> config.Member
	76,  // 59: config.MemberExercises.member_exercises:type_name -> config.MemberExercise
	...
	50,  // 62: config.GroupDocument.group:type_name -> config.Group
	84,  // 63: config.GroupDocument.document:type_name -> library.Document
	79,  // 64: config.GroupDocuments.group_documents:type_name -> config.GroupDocument
	25,  // 65: config.ConfigService.CheckRegisterAccount:input_type -> config.CheckRegisterAccountRequest
	27,  // 66: config.ConfigService.VerifyOtpRegister:input_type -> config.VerifyOtpRegisterRequest
	29,  // 67: config.ConfigService.RegisterAccount:input_type -> config.RegisterAccountRequest
	31,  // 68: config.ConfigService.Login:input_type -> config.LoginAccountRequest
	35,  // 69: config.ConfigService.MemberLogin:input_type -> config.MemberRequest
	36,  // 70: config.ConfigService.ChangeMemberPassword:input_type -> config.Member
	22,  // 71: config.ConfigService.ListAccounts:input_type -> config.AccountRequest
	22,  // 72: config.ConfigService.UpdateAccount:input_type -> config.AccountRequest
	35,  // 73: config.ConfigService.ListMembers:input_type -> config.MemberRequest
	36,  // 74: config.ConfigService.CreateMember:input_type -> config.Member
	36,  // 75: config.ConfigService.GetMember:input_type -> config.Member
	39,  // 76: config.ConfigService.ListCategories:input_type -> config.CategoryRequest
	47,  // 77: config.ConfigService.CreateMemberCategory:input_type -> config.MemberCategory
	47,  // 78: config.ConfigService.GetMemberCategory:input_type -> config.MemberCategory
	48,  // 79: config.ConfigService.ListMemberCategories:input_type -> config.MemberCategoryRequest
	71,  // 80: config.ConfigService.ListMemberPractice:input_type -> config.MemberPracticeRequest
	70,  // 81: config.ConfigService.CreateMemberPractice:input_type -> config.MemberPractice
	51,  // 82: config.ConfigService.ListGroup:input_type -> config.GroupRequest
	57,  // 83: config.ConfigService.ListMemberGroup:input_type -> config.MemberGroupRequest
	51,  // 84: config.ConfigService.GetGroup:input_type -> config.GroupRequest
	50,  // 85: config.ConfigService.CreateGroup:input_type -> config.Group
	56,  // 86: config.ConfigService.CreateMemberGroup:input_type -> config.MemberGroup
	56,  // 87: config.ConfigService.ApproveMemberToGroup:input_type -> config.MemberGroup
	54,  // 88: config.ConfigService.ListAccountGroup:input_type -> config.AccountGroupRequest
	53,  // 89: config.ConfigService.CreateAccountGroup:input_type -> config.AccountGroup
	73,  // 90: config.ConfigService.CreateAccountExercise:input_type -> config.AccountExercise
	74,  // 91: config.ConfigService.ListAccountExercises:input_type -> config.AccountExerciseRequest
	76,  // 92: config.ConfigService.CreateMemberExercise:input_type -> config.MemberExercise
	77,  // 93: config.ConfigService.ListMemberExercise:input_type -> config.MemberExerciseRequest
	80,  // 94: config.ConfigService.ListGroupDocument:input_type -> config.GroupDocumentRequest
	79,  // 95: config.ConfigService.CreateGroupDocument:input_type -> config.GroupDocument
	79,  // 96: config.ConfigService.UpdateGroupDocument:input_type -> config.GroupDocument
	81,  // 97: config.ConfigService.SortGroupDocument:input_type -> config.GroupDocuments
	77,  // 98: config.ConfigService.GetMemberExercise:input_type -> config.MemberExerciseRequest
	77,  // 99: config.ConfigService.UpdateMemberExercise:input_type -> config.MemberExerciseRequest
	57,  // 100: config.ConfigService.CreateMemberGroups:input_type -> config.MemberGroupRequest
	23,  // 101: config.ConfigService.CreateAccount:input_type -> config.Account
