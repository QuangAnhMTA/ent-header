...
var file_config_proto_rawDesc = []byte{
	...
	0x6f, 0x75, 0x70, 0x73, 0x22, 0xfc, 0x01, 0x0a, 0x0c, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	...
	0x74, 0x61, 0x6c, 0x32, 0x82, 0x0a, 0x0a, 0x0d, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x53, 0x65,
	...
	0x65, 0x72, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x42, 0x2a, 0x5a, 0x28, 0x67, 0x69, 0x74, 0x68,
...
var file_config_proto_depIdxs = []int32{
	...
	43, // 27: config.AccountGroups.account_groups:type_name -> config.AccountGroup
	9,  // 28: config.MemberGroup.status:type_name -> config.MemberGroup.Status
	46, // 29: config.MemberGroups.member_groups:type_name -> config.MemberGroup
	10, // 30: config.Token.status:type_name -> config.Token.Status
	49, // 31: config.Tokens.tokens:type_name -> config.Token
	52, // 32: config.AccountTokens.account_tokens:type_name -> config.AccountToken
	57, // 33: config.MemberPractices.member_practices:type_name -> config.MemberPractice
	15, // 34: config.ConfigService.CheckRegisterAccount:input_type -> config.CheckRegisterAccountRequest
	17, // 35: config.ConfigService.VerifyOtpRegister:input_type -> config.VerifyOtpRegisterRequest
	19, // 36: config.ConfigService.RegisterAccount:input_type -> config.RegisterAccountRequest
	21, // 37: config.ConfigService.Login:input_type -> config.LoginAccountRequest
	25, // 38: config.ConfigService.MemberLogin:input_type -> config.MemberRequest
	26, // 39: config.ConfigService.ChangeMemberPassword:input_type -> config.Member
	12, // 40: config.ConfigService.ListAccounts:input_type -> config.AccountRequest
	12, // 41: config.ConfigService.UpdateAccount:input_type -> config.AccountRequest
	25, // 42: config.ConfigService.ListMembers:input_type -> config.MemberRequest
	26, // 43: config.ConfigService.CreateMember:input_type -> config.Member
	26, // 44: config.ConfigService.GetMember:input_type -> config.Member
	29, // 45: config.ConfigService.ListCategories:input_type -> config.CategoryRequest
	37, // 46: config.ConfigService.CreateMemberCategory:input_type -> config.MemberCategory
	37, // 47: config.ConfigService.GetMemberCategory:input_type -> config.MemberCategory
	38, // 48: config.ConfigService.ListMemberCategories:input_type -> config.MemberCategoryRequest
	58, // 49: config.ConfigService.ListMemberPractice:input_type -> config.MemberPracticeRequest
	57, // 50: config.ConfigService.CreateMemberPractice:input_type -> config.MemberPractice
	41, // 51: config.ConfigService.ListGroup:input_type -> config.GroupRequest
	47, // 52: config.ConfigService.ListMemberGroup:input_type -> config.MemberGroupRequest
	16, // 53: config.ConfigService.CheckRegisterAccount:output_type -> config.CheckRegisterAccountResponse
	18, // 54: config.ConfigService.VerifyOtpRegister:output_type -> config.VerifyOtpRegisterResponse
	13, // 55: config.ConfigService.RegisterAccount:output_type -> config.Account
	22, // 56: config.ConfigService.Login:output_type -> config.LoginAccountResponse
	23, // 57: config.ConfigService.MemberLogin:output_type -> config.LoginMemberResponse
	26, // 58: config.ConfigService.ChangeMemberPassword:output_type -> config.Member
	14, // 59: config.ConfigService.ListAccounts:output_type -> config.Accounts
	13, // 60: config.ConfigService.UpdateAccount:output_type -> config.Account
	27, // 61: config.ConfigService.ListMembers:output_type -> config.Members
	26, // 62: config.ConfigService.CreateMember:output_type -> config.Member
	26, // 63: config.ConfigService.GetMember:output_type -> config.Member
	30, // 64: config.ConfigService.ListCategories:output_type -> config.Categories
	37, // 65: config.ConfigService.CreateMemberCategory:output_type -> config.MemberCategory
	37, // 66: config.ConfigService.GetMemberCategory:output_type -> config.MemberCategory
	39, // 67: config.ConfigService.ListMemberCategories:output_type -> config.MemberCategories
	59, // 68: config.ConfigService.ListMemberPractice:output_type -> config.MemberPractices
	57, // 69: config.ConfigService.CreateMemberPractice:output_type -> config.MemberPractice
	42, // 70: config.ConfigService.ListGroup:output_type -> config.Groups
	48, // 71: config.ConfigService.ListMemberGroup:output_type -> config.MemberGroups
