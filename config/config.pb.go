...
var file_config_proto_rawDesc = []byte{
	...
	0x70, 0x73, 0x22, 0xaf, 0x02, 0x0a, 0x0b, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x47, 0x72, 0x6f,
	...
	,
	...
	0x52, 0x06, 0x6f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x12, 0x27, 0x0a, 0x0f, 0x61, 0x70, 0x70, 0x72,
	0x6f, 0x76, 0x65, 0x5f, 0x70, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28,
	...
	0x64, 0x65, 0x73, 0x22, 0x48, 0x0a, 0x0c, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x47, 0x72, 0x6f,
	...
	0x05, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x32, 0xe1, 0x0b, 0x0a, 0x0d, 0x43, 0x6f, 0x6e,
	...
	0x2e, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x42, 0x2a, 0x5a, 0x28,
...
var file_config_proto_depIdxs = []int32{
	...
	47, // 31: config.MemberGroups.member_groups:type_name -> config.MemberGroup
	11, // 32: config.Token.status:type_name -> config.Token.Status
	50, // 33: config.Tokens.tokens:type_name -> config.Token
	53, // 34: config.AccountTokens.account_tokens:type_name -> config.AccountToken
	58, // 35: config.MemberPractices.member_practices:type_name -> config.MemberPractice
	16, // 36: config.ConfigService.CheckRegisterAccount:input_type -> config.CheckRegisterAccountRequest
	18, // 37: config.ConfigService.VerifyOtpRegister:input_type -> config.VerifyOtpRegisterRequest
	20, // 38: config.ConfigService.RegisterAccount:input_type -> config.RegisterAccountRequest
	22, // 39: config.ConfigService.Login:input_type -> config.LoginAccountRequest
	26, // 40: config.ConfigService.MemberLogin:input_type -> config.MemberRequest
	27, // 41: config.ConfigService.ChangeMemberPassword:input_type -> config.Member
	13, // 42: config.ConfigService.ListAccounts:input_type -> config.AccountRequest
	13, // 43: config.ConfigService.UpdateAccount:input_type -> config.AccountRequest
	26, // 44: config.ConfigService.ListMembers:input_type -> config.MemberRequest
	27, // 45: config.ConfigService.CreateMember:input_type -> config.Member
	27, // 46: config.ConfigService.GetMember:input_type -> config.Member
	30, // 47: config.ConfigService.ListCategories:input_type -> config.CategoryRequest
	38, // 48: config.ConfigService.CreateMemberCategory:input_type -> config.MemberCategory
	38, // 49: config.ConfigService.GetMemberCategory:input_type -> config.MemberCategory
	39, // 50: config.ConfigService.ListMemberCategories:input_type -> config.MemberCategoryRequest
	59, // 51: config.ConfigService.ListMemberPractice:input_type -> config.MemberPracticeRequest
	58, // 52: config.ConfigService.CreateMemberPractice:input_type -> config.MemberPractice
	42, // 53: config.ConfigService.ListGroup:input_type -> config.GroupRequest
	48, // 54: config.ConfigService.ListMemberGroup:input_type -> config.MemberGroupRequest
	42, // 55: config.ConfigService.GetGroup:input_type -> config.GroupRequest
	41, // 56: config.ConfigService.CreateGroup:input_type -> config.Group
	47, // 57: config.ConfigService.CreateMemberGroup:input_type -> config.MemberGroup
	47, // 58: config.ConfigService.ApproveMemberToGroup:input_type -> config.MemberGroup
	17, // 59: config.ConfigService.CheckRegisterAccount:output_type -> config.CheckRegisterAccountResponse
	19, // 60: config.ConfigService.VerifyOtpRegister:output_type -> config.VerifyOtpRegisterResponse
	14, // 61: config.ConfigService.RegisterAccount:output_type -> config.Account
	23, // 62: config.ConfigService.Login:output_type -> config.LoginAccountResponse
	24, // 63: config.ConfigService.MemberLogin:output_type -> config.LoginMemberResponse
	27, // 64: config.ConfigService.ChangeMemberPassword:output_type -> config.Member
	15, // 65: config.ConfigService.ListAccounts:output_type -> config.Accounts
	14, // 66: config.ConfigService.UpdateAccount:output_type -> config.Account
	28, // 67: config.ConfigService.ListMembers:output_type -> config.Members
	27, // 68: config.ConfigService.CreateMember:output_type -> config.Member
	27, // 69: config.ConfigService.GetMember:output_type -> config.Member
	31, // 70: config.ConfigService.ListCategories:output_type -> config.Categories
	38, // 71: config.ConfigService.CreateMemberCategory:output_type -> config.MemberCategory
	38, // 72: config.ConfigService.GetMemberCategory:output_type -> config.MemberCategory
	40, // 73: config.ConfigService.ListMemberCategories:output_type -> config.MemberCategories
	60, // 74: config.ConfigService.ListMemberPractice:output_type -> config.MemberPractices
	58, // 75: config.ConfigService.CreateMemberPractice:output_type -> config.MemberPractice
	43, // 76: config.ConfigService.ListGroup:output_type -> config.Groups
	49, // 77: config.ConfigService.ListMemberGroup:output_type -> config.MemberGroups
	41, // 78: config.ConfigService.GetGroup:output_type -> config.Group
	41, // 79: config.ConfigService.CreateGroup:output_type -> config.Group
	47, // 80: config.ConfigService.CreateMemberGroup:output_type -> config.MemberGroup
	47, // 81: config.ConfigService.ApproveMemberToGroup:output_type -> config.MemberGroup
