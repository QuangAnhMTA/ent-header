...
var file_transaction_proto_rawDesc = []byte{
	...
	0x73, 0x18, 0x17, 0x20, 0x03, 0x28, 0x03, 0x52, 0x03, 0x69, 0x64, 0x73, 0x22, 0xdc, 0x02, 0x0a,
	...
	0x52, 0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0xd7, 0x02, 0x0a, 0x0d,
	...
	0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x4e, 0x0a, 0x07, 0x4c, 0x6f, 0x6f, 0x6b, 0x75, 0x70, 0x73,
	...
	0x74, 0x6f, 0x74, 0x61, 0x6c, 0x22, 0xe1, 0x01, 0x0a, 0x08, 0x53, 0x65, 0x6e, 0x74, 0x65, 0x6e,
	...
	0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x95, 0x02, 0x0a, 0x0f, 0x53, 0x65,
	...
	0xc7, 0x03, 0x0a, 0x03, 0x4e, 0x65, 0x77, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x6d, 0x65, 0x6d, 0x62, 0x65,
	0x72, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x6d, 0x65, 0x6d, 0x62,
	...
	0x6e, 0x65, 0x77, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x22, 0x25, 0x0a, 0x04, 0x54, 0x79,
	...
	0x01, 0x22, 0x36, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x12, 0x0a, 0x0e, 0x64,
	...
	0x6c, 0x32, 0xd8, 0x0a, 0x0a, 0x12, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f,
	...
	0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x4e, 0x65, 0x77, 0x73, 0x42, 0x2f, 0x5a, 0x2d,
...
var file_transaction_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
...
var file_transaction_proto_goTypes = []interface{}{
	...
	(*Listen)(nil),               // 5: transaction.Listen
	(*ListenRequest)(nil),        // 6: transaction.ListenRequest
	(*Speak)(nil),                // 7: transaction.Speak
	(*Speaks)(nil),               // 8: transaction.Speaks
	(*SpeakRequest)(nil),         // 9: transaction.SpeakRequest
	(*Lookup)(nil),               // 10: transaction.Lookup
	(*LookupRequest)(nil),        // 11: transaction.LookupRequest
	(*Lookups)(nil),              // 12: transaction.Lookups
	(*Sentence)(nil),             // 13: transaction.Sentence
	(*SentenceRequest)(nil),      // 14: transaction.SentenceRequest
	(*Sentences)(nil),            // 15: transaction.Sentences
	(*Paragraph)(nil),            // 16: transaction.Paragraph
	(*ParagraphRequest)(nil),     // 17: transaction.ParagraphRequest
	(*Paragraphs)(nil),           // 18: transaction.Paragraphs
	(*ListenDisplay)(nil),        // 19: transaction.ListenDisplay
	(*ListenDisplayRequest)(nil), // 20: transaction.ListenDisplayRequest
	(*ListenDisplays)(nil),       // 21: transaction.ListenDisplays
	(*SpeakDisplay)(nil),         // 22: transaction.SpeakDisplay
	(*SpeakDisplayRequest)(nil),  // 23: transaction.SpeakDisplayRequest
	(*SpeakDisplays)(nil),        // 24: transaction.SpeakDisplays
	(*Favourite)(nil),            // 25: transaction.Favourite
	(*FavouriteRequest)(nil),     // 26: transaction.FavouriteRequest
	(*Favourites)(nil),           // 27: transaction.Favourites
	(*New)(nil),                  // 28: transaction.New
	(*NewRequest)(nil),           // 29: transaction.NewRequest
	(*News)(nil),                 // 30: transaction.News
	(*NewDetail)(nil),            // 31: transaction.NewDetail
	(*NewDetailRequest)(nil),     // 32: transaction.NewDetailRequest
	(*NewDetails)(nil),           // 33: transaction.NewDetails
	(*library.Sentence)(nil),     // 34: library.Sentence
	(*library.SentencePos)(nil),  // 35: library.SentencePos
	(*library.Paragraph)(nil),    // 36: library.Paragraph
	(*library.Document)(nil),     // 37: library.Document
	(*library.Course)(nil),       // 38: library.Course
}
var file_transaction_proto_depIdxs = []int32{
	7,  // 0: transaction.Speaks.speaks:type_name -> transaction.Speak
	34, // 1: transaction.Lookup.sentence:type_name -> library.Sentence
	35, // 2: transaction.Lookup.sentence_pos:type_name -> library.SentencePos
	10, // 3: transaction.Lookups.lookups:type_name -> transaction.Lookup
	34, // 4: transaction.Sentence.sentence:type_name -> library.Sentence
	13, // 5: transaction.Sentences.sentences:type_name -> transaction.Sentence
	36, // 6: transaction.Paragraph.paragraph:type_name -> library.Paragraph
	37, // 7: transaction.Paragraph.document:type_name -> library.Document
	38, // 8: transaction.Paragraph.course:type_name -> library.Course
	0,  // 9: transaction.Paragraph.process:type_name -> transaction.Paragraph.Process
	16, // 10: transaction.Paragraphs.paragraphs:type_name -> transaction.Paragraph
	19, // 11: transaction.ListenDisplays.listen_displays:type_name -> transaction.ListenDisplay
	22, // 12: transaction.SpeakDisplays.speak_displays:type_name -> transaction.SpeakDisplay
	36, // 13: transaction.Favourite.paragraph:type_name -> library.Paragraph
	37, // 14: transaction.Favourite.document:type_name -> library.Document
	38, // 15: transaction.Favourite.course:type_name -> library.Course
	1,  // 16: transaction.Favourite.status:type_name -> transaction.Favourite.Status
	25, // 17: transaction.Favourites.favourites:type_name -> transaction.Favourite
	2,  // 18: transaction.New.type:type_name -> transaction.New.Type
	3,  // 19: transaction.New.status:type_name -> transaction.New.Status
	36, // 20: transaction.New.paragraph:type_name -> library.Paragraph
	31, // 21: transaction.New.new_details:type_name -> transaction.NewDetail
	28, // 22: transaction.News.News:type_name -> transaction.New
	4,  // 23: transaction.NewDetail.status:type_name -> transaction.NewDetail.Status
	34, // 24: transaction.NewDetail.sentence:type_name -> library.Sentence
	28, // 25: transaction.NewDetail.new:type_name -> transaction.New
	31, // 26: transaction.NewDetails.new_details:type_name -> transaction.NewDetail
	6,  // 27: transaction.TransactionService.ListListen:input_type -> transaction.ListenRequest
	5,  // 28: transaction.TransactionService.EndLearnListen:input_type -> transaction.Listen
	9,  // 29: transaction.TransactionService.ListSpeak:input_type -> transaction.SpeakRequest
	7,  // 30: transaction.TransactionService.EndLearnSpeak:input_type -> transaction.Speak
	13, // 31: transaction.TransactionService.CreateSentence:input_type -> transaction.Sentence
	10, // 32: transaction.TransactionService.CreateLookup:input_type -> transaction.Lookup
	16, // 33: transaction.TransactionService.CreateParagraph:input_type -> transaction.Paragraph
	16, // 34: transaction.TransactionService.CompleteParagraph:input_type -> transaction.Paragraph
	11, // 35: transaction.TransactionService.ListLookup:input_type -> transaction.LookupRequest
	14, // 36: transaction.TransactionService.ListSentence:input_type -> transaction.SentenceRequest
	17, // 37: transaction.TransactionService.GetParagraphMax:input_type -> transaction.ParagraphRequest
	17, // 38: transaction.TransactionService.ListParagraph:input_type -> transaction.ParagraphRequest
	20, // 39: transaction.TransactionService.ListListenDisplay:input_type -> transaction.ListenDisplayRequest
	23, // 40: transaction.TransactionService.ListSpeakDisplay:input_type -> transaction.SpeakDisplayRequest
	26, // 41: transaction.TransactionService.ListFavourite:input_type -> transaction.FavouriteRequest
	25, // 42: transaction.TransactionService.CreateFavourite:input_type -> transaction.Favourite
	25, // 43: transaction.TransactionService.DeleteFavourite:input_type -> transaction.Favourite
	16, // 44: transaction.TransactionService.StartParagraph:input_type -> transaction.Paragraph
	32, // 45: transaction.TransactionService.ListNewDetail:input_type -> transaction.NewDetailRequest
	29, // 46: transaction.TransactionService.ListNew:input_type -> transaction.NewRequest
	5,  // 47: transaction.TransactionService.ListListen:output_type -> transaction.Listen
	5,  // 48: transaction.TransactionService.EndLearnListen:output_type -> transaction.Listen
	8,  // 49: transaction.TransactionService.ListSpeak:output_type -> transaction.Speaks
	7,  // 50: transaction.TransactionService.EndLearnSpeak:output_type -> transaction.Speak
	13, // 51: transaction.TransactionService.CreateSentence:output_type -> transaction.Sentence
	10, // 52: transaction.TransactionService.CreateLookup:output_type -> transaction.Lookup
	16, // 53: transaction.TransactionService.CreateParagraph:output_type -> transaction.Paragraph
	16, // 54: transaction.TransactionService.CompleteParagraph:output_type -> transaction.Paragraph
	12, // 55: transaction.TransactionService.ListLookup:output_type -> transaction.Lookups
	15, // 56: transaction.TransactionService.ListSentence:output_type -> transaction.Sentences
	16, // 57: transaction.TransactionService.GetParagraphMax:output_type -> transaction.Paragraph
	18, // 58: transaction.TransactionService.ListParagraph:output_type -> transaction.Paragraphs
	21, // 59: transaction.TransactionService.ListListenDisplay:output_type -> transaction.ListenDisplays
	24, // 60: transaction.TransactionService.ListSpeakDisplay:output_type -> transaction.SpeakDisplays
	27, // 61: transaction.TransactionService.ListFavourite:output_type -> transaction.Favourites
	25, // 62: transaction.TransactionService.CreateFavourite:output_type -> transaction.Favourite
	25, // 63: transaction.TransactionService.DeleteFavourite:output_type -> transaction.Favourite
	16, // 64: transaction.TransactionService.StartParagraph:output_type -> transaction.Paragraph
	33, // 65: transaction.TransactionService.ListNewDetail:output_type -> transaction.NewDetails
	30, // 66: transaction.TransactionService.ListNew:output_type -> transaction.News
