...
var file_transaction_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c,
	0x22, 0x69, 0x0a, 0x09, 0x46, 0x61, 0x76, 0x6f, 0x75, 0x72, 0x69, 0x74, 0x65, 0x12, 0x0e, 0x0a,
	0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1b, 0x0a,
	0x09, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03,
	...
	0x03, 0x52, 0x08, 0x6f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x64, 0x22, 0xff, 0x01, 0x0a, 0x10,
	...
	0x03, 0x28, 0x09, 0x52, 0x08, 0x69, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x73, 0x22, 0x5a, 0x0a,
	0x0a, 0x46, 0x61, 0x76, 0x6f, 0x75, 0x72, 0x69, 0x74, 0x65, 0x73, 0x12, 0x36, 0x0a, 0x0a, 0x66,
	0x61, 0x76, 0x6f, 0x75, 0x72, 0x69, 0x74, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x16, 0x2e, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x46, 0x61,
	0x76, 0x6f, 0x75, 0x72, 0x69, 0x74, 0x65, 0x52, 0x0a, 0x66, 0x61, 0x76, 0x6f, 0x75, 0x72, 0x69,
	0x74, 0x65, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x32, 0xd1, 0x08, 0x0a, 0x12, 0x54, 0x72,
	...
	0x69, 0x6f, 0x6e, 0x2e, 0x46, 0x61, 0x76, 0x6f, 0x75, 0x72, 0x69, 0x74, 0x65, 0x42, 0x2f, 0x5a,
...
var file_transaction_proto_depIdxs = []int32{
	...
	20, // 12: transaction.Favourites.favourites:type_name -> transaction.Favourite
	1,  // 13: transaction.TransactionService.ListListen:input_type -> transaction.ListenRequest
	0,  // 14: transaction.TransactionService.EndLearnListen:input_type -> transaction.Listen
	4,  // 15: transaction.TransactionService.ListSpeak:input_type -> transaction.SpeakRequest
	2,  // 16: transaction.TransactionService.EndLearnSpeak:input_type -> transaction.Speak
	8,  // 17: transaction.TransactionService.CreateSentence:input_type -> transaction.Sentence
	5,  // 18: transaction.TransactionService.CreateLookup:input_type -> transaction.Lookup
	11, // 19: transaction.TransactionService.CreateParagraph:input_type -> transaction.Paragraph
	6,  // 20: transaction.TransactionService.ListLookup:input_type -> transaction.LookupRequest
	9,  // 21: transaction.TransactionService.ListSentence:input_type -> transaction.SentenceRequest
	12, // 22: transaction.TransactionService.GetParagraphMax:input_type -> transaction.ParagraphRequest
	12, // 23: transaction.TransactionService.ListParagraph:input_type -> transaction.ParagraphRequest
	15, // 24: transaction.TransactionService.ListListenDisplay:input_type -> transaction.ListenDisplayRequest
	18, // 25: transaction.TransactionService.ListSpeakDisplay:input_type -> transaction.SpeakDisplayRequest
	21, // 26: transaction.TransactionService.ListFavourite:input_type -> transaction.FavouriteRequest
	20, // 27: transaction.TransactionService.CreateFavourite:input_type -> transaction.Favourite
	20, // 28: transaction.TransactionService.DeleteFavourite:input_type -> transaction.Favourite
	0,  // 29: transaction.TransactionService.ListListen:output_type -> transaction.Listen
	0,  // 30: transaction.TransactionService.EndLearnListen:output_type -> transaction.Listen
	3,  // 31: transaction.TransactionService.ListSpeak:output_type -> transaction.Speaks
	2,  // 32: transaction.TransactionService.EndLearnSpeak:output_type -> transaction.Speak
	8,  // 33: transaction.TransactionService.CreateSentence:output_type -> transaction.Sentence
	5,  // 34: transaction.TransactionService.CreateLookup:output_type -> transaction.Lookup
	11, // 35: transaction.TransactionService.CreateParagraph:output_type -> transaction.Paragraph
	7,  // 36: transaction.TransactionService.ListLookup:output_type -> transaction.Lookups
	10, // 37: transaction.TransactionService.ListSentence:output_type -> transaction.Sentences
	11, // 38: transaction.TransactionService.GetParagraphMax:output_type -> transaction.Paragraph
	13, // 39: transaction.TransactionService.ListParagraph:output_type -> transaction.Paragraphs
	16, // 40: transaction.TransactionService.ListListenDisplay:output_type -> transaction.ListenDisplays
	19, // 41: transaction.TransactionService.ListSpeakDisplay:output_type -> transaction.SpeakDisplays
	22, // 42: transaction.TransactionService.ListFavourite:output_type -> transaction.Favourites
	20, // 43: transaction.TransactionService.CreateFavourite:output_type -> transaction.Favourite
	20, // 44: transaction.TransactionService.DeleteFavourite:output_type -> transaction.Favourite
