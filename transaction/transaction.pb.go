...
var file_transaction_proto_rawDesc = []byte{
	...
	0x2e, 0x53, 0x70, 0x65, 0x61, 0x6b, 0x73, 0x12, 0x37, 0x0a, 0x0d, 0x45, 0x6e, 0x64, 0x4c, 0x65,
	...
	0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x4c, 0x65, 0x61, 0x72, 0x6e, 0x12, 0x38, 0x0a,
...
var file_transaction_proto_goTypes = []interface{}{
	...
	(MemberToken_Type)(0),        // 8: transaction.MemberToken.Type
	(MemberToken_Status)(0),      // 9: transaction.MemberToken.Status
	(AccountToken_Type)(0),       // 10: transaction.AccountToken.Type
	(AccountToken_Status)(0),     // 11: transaction.AccountToken.Status
	(*Listen)(nil),               // 12: transaction.Listen
	(*ListenRequest)(nil),        // 13: transaction.ListenRequest
	(*Speak)(nil),                // 14: transaction.Speak
	(*Speaks)(nil),               // 15: transaction.Speaks
	(*SpeakRequest)(nil),         // 16: transaction.SpeakRequest
	(*Lookup)(nil),               // 17: transaction.Lookup
	(*LookupRequest)(nil),        // 18: transaction.LookupRequest
	(*Lookups)(nil),              // 19: transaction.Lookups
	(*Sentence)(nil),             // 20: transaction.Sentence
	(*SentenceRequest)(nil),      // 21: transaction.SentenceRequest
	(*Sentences)(nil),            // 22: transaction.Sentences
	(*Paragraph)(nil),            // 23: transaction.Paragraph
	(*ParagraphRequest)(nil),     // 24: transaction.ParagraphRequest
	(*Paragraphs)(nil),           // 25: transaction.Paragraphs
	(*ListenDisplay)(nil),        // 26: transaction.ListenDisplay
	(*ListenDisplayRequest)(nil), // 27: transaction.ListenDisplayRequest
	(*ListenDisplays)(nil),       // 28: transaction.ListenDisplays
	(*SpeakDisplay)(nil),         // 29: transaction.SpeakDisplay
	(*SpeakDisplayRequest)(nil),  // 30: transaction.SpeakDisplayRequest
	(*SpeakDisplays)(nil),        // 31: transaction.SpeakDisplays
	(*Favourite)(nil),            // 32: transaction.Favourite
	(*FavouriteRequest)(nil),     // 33: transaction.FavouriteRequest
	(*Favourites)(nil),           // 34: transaction.Favourites
	(*New)(nil),                  // 35: transaction.New
	(*NewRequest)(nil),           // 36: transaction.NewRequest
	(*News)(nil),                 // 37: transaction.News
	(*NewDetail)(nil),            // 38: transaction.NewDetail
	(*NewDetailRequest)(nil),     // 39: transaction.NewDetailRequest
	(*NewDetails)(nil),           // 40: transaction.NewDetails
	(*Learn)(nil),                // 41: transaction.Learn
