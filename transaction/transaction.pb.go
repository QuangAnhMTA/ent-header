...
var file_transaction_proto_rawDesc = []byte{
	...
	0x67, 0x73, 0x32, 0xaf, 0x14, 0x0a, 0x12, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69,
	...
	0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x54, 0x6f,
	0x6b, 0x65, 0x6e, 0x73, 0x42, 0x2f, 0x5a, 0x2d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_transaction_proto_depIdxs = []int32{
	...
	64,  // 112: transaction.TransactionService.ListMemberToken:input_type -> transaction.MemberTokenRequest
	25,  // 113: transaction.TransactionService.ListListen:output_type -> transaction.Listen
	25,  // 114: transaction.TransactionService.EndLearnListen:output_type -> transaction.Listen
	28,  // 115: transaction.TransactionService.ListSpeak:output_type -> transaction.Speaks
	27,  // 116: transaction.TransactionService.UpdateSpeak:output_type -> transaction.Speak
	27,  // 117: transaction.TransactionService.EndLearnSpeak:output_type -> transaction.Speak
	36,  // 118: transaction.TransactionService.CreateSentence:output_type -> transaction.Sentence
	33,  // 119: transaction.TransactionService.CreateLookup:output_type -> transaction.Lookup
	39,  // 120: transaction.TransactionService.CreateParagraph:output_type -> transaction.Paragraph
	39,  // 121: transaction.TransactionService.CompleteParagraph:output_type -> transaction.Paragraph
	35,  // 122: transaction.TransactionService.ListLookup:output_type -> transaction.Lookups
	38,  // 123: transaction.TransactionService.ListSentence:output_type -> transaction.Sentences
	39,  // 124: transaction.TransactionService.GetParagraphMax:output_type -> transaction.Paragraph
	41,  // 125: transaction.TransactionService.ListParagraph:output_type -> transaction.Paragraphs
	44,  // 126: transaction.TransactionService.ListListenDisplay:output_type -> transaction.ListenDisplays
	47,  // 127: transaction.TransactionService.ListSpeakDisplay:output_type -> transaction.SpeakDisplays
	50,  // 128: transaction.TransactionService.ListFavourite:output_type -> transaction.Favourites
	48,  // 129: transaction.TransactionService.CreateFavourite:output_type -> transaction.Favourite
	48,  // 130: transaction.TransactionService.DeleteFavourite:output_type -> transaction.Favourite
	39,  // 131: transaction.TransactionService.StartParagraph:output_type -> transaction.Paragraph
	56,  // 132: transaction.TransactionService.ListNewDetail:output_type -> transaction.NewDetails
	53,  // 133: transaction.TransactionService.ListNew:output_type -> transaction.News
	57,  // 134: transaction.TransactionService.StartLearn:output_type -> transaction.Learn
	57,  // 135: transaction.TransactionService.EndLearn:output_type -> transaction.Learn
	60,  // 136: transaction.TransactionService.CreateMemberAnswer:output_type -> transaction.Answer
	60,  // 137: transaction.TransactionService.UpdateMemberAnswer:output_type -> transaction.Answer
	62,  // 138: transaction.TransactionService.ListMemberAnswer:output_type -> transaction.Answers
	62,  // 139: transaction.TransactionService.CreateAnswers:output_type -> transaction.Answers
	86,  // 140: transaction.TransactionService.ListReportToken:output_type -> transaction.ReportTokens
	83,  // 141: transaction.TransactionService.ListReportPoint:output_type -> transaction.ReportPoints
	80,  // 142: transaction.TransactionService.ListReportMember:output_type -> transaction.ReportMembers
	62,  // 143: transaction.TransactionService.CreateRecommend:output_type -> transaction.Answers
	72,  // 144: transaction.TransactionService.BuyToken:output_type -> transaction.Cart
	72,  // 145: transaction.TransactionService.PaymentCart:output_type -> transaction.Cart
	68,  // 146: transaction.TransactionService.ListMemberTokenTransaction:output_type -> transaction.MemberTokenTransactions
	24,  // 147: transaction.TransactionService.ListReportTokenTransaction:output_type -> transaction.ReportMemberTokenTransactionResponse
	63,  // 148: transaction.TransactionService.GetMemberToken:output_type -> transaction.MemberToken
	65,  // 149: transaction.TransactionService.ListMemberToken:output_type -> transaction.MemberTokens
