...
type Answer struct {
	...
	AnwserFormat   string        `protobuf:"bytes,15,opt,name=anwser_format,json=anwserFormat,proto3" json:"anwser_format,omitempty"`
}
...
var file_transaction_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x46, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x12, 0x23, 0x0a, 0x0d, 0x61, 0x6e, 0x77, 0x73,
	0x65, 0x72, 0x5f, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x0c, 0x61, 0x6e, 0x77, 0x73, 0x65, 0x72, 0x46, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x22, 0x35, 0x0a,
	...
	0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x22, 0xcd,
	0x04, 0x0a, 0x16, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x54, 0x72,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x6f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x64, 0x22, 0x34,
	...
	0x61, 0x6b, 0x10, 0x01, 0x12, 0x0a, 0x0a, 0x06, 0x6c, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x10, 0x02,
	0x12, 0x0c, 0x0a, 0x08, 0x65, 0x78, 0x65, 0x72, 0x63, 0x69, 0x73, 0x65, 0x10, 0x03, 0x22, 0xaf,
	0x03, 0x0a, 0x1d, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x54, 0x72,
...
var file_transaction_proto_depIdxs = []int32{
	...
	65, // 44: transaction.MemberTokenTransactions.member_token_transactions:type_name -> transaction.MemberTokenTransaction
	13, // 45: transaction.AccountToken.type:type_name -> transaction.AccountToken.Type
	14, // 46: transaction.AccountToken.status:type_name -> transaction.AccountToken.Status
	68, // 47: transaction.AccountTokens.account_tokens:type_name -> transaction.AccountToken
	15, // 48: transaction.Cart.pay:type_name -> transaction.Cart.Pay
	16, // 49: transaction.Cart.delivery:type_name -> transaction.Cart.Delivery
	17, // 50: transaction.Cart.status:type_name -> transaction.Cart.Status
	74, // 51: transaction.CartRequest.cart_details:type_name -> transaction.CartDetail
	71, // 52: transaction.Carts.carts:type_name -> transaction.Cart
	18, // 53: transaction.CartDetail.status:type_name -> transaction.CartDetail.Status
	74, // 54: transaction.CartDetails.cart_details:type_name -> transaction.CartDetail
	19, // 55: transaction.ReportMember.status:type_name -> transaction.ReportMember.Status
	77, // 56: transaction.ReportMembers.report_members:type_name -> transaction.ReportMember
	20, // 57: transaction.ReportPoint.status:type_name -> transaction.ReportPoint.Status
	80, // 58: transaction.ReportPoints.report_points:type_name -> transaction.ReportPoint
	21, // 59: transaction.ReportToken.status:type_name -> transaction.ReportToken.Status
	22, // 60: transaction.ReportToken.transaction_type:type_name -> transaction.ReportToken.TransactionType
	83, // 61: transaction.ReportTokens.report_tokens:type_name -> transaction.ReportToken
	23, // 62: transaction.NewConfig.status:type_name -> transaction.NewConfig.Status
	86, // 63: transaction.NewConfigs.new_configs:type_name -> transaction.NewConfig
	25, // 64: transaction.TransactionService.ListListen:input_type -> transaction.ListenRequest
	24, // 65: transaction.TransactionService.EndLearnListen:input_type -> transaction.Listen
	28, // 66: transaction.TransactionService.ListSpeak:input_type -> transaction.SpeakRequest
	26, // 67: transaction.TransactionService.UpdateSpeak:input_type -> transaction.Speak
	26, // 68: transaction.TransactionService.EndLearnSpeak:input_type -> transaction.Speak
	35, // 69: transaction.TransactionService.CreateSentence:input_type -> transaction.Sentence
	32, // 70: transaction.TransactionService.CreateLookup:input_type -> transaction.Lookup
	38, // 71: transaction.TransactionService.CreateParagraph:input_type -> transaction.Paragraph
	38, // 72: transaction.TransactionService.CompleteParagraph:input_type -> transaction.Paragraph
	33, // 73: transaction.TransactionService.ListLookup:input_type -> transaction.LookupRequest
	36, // 74: transaction.TransactionService.ListSentence:input_type -> transaction.SentenceRequest
	39, // 75: transaction.TransactionService.GetParagraphMax:input_type -> transaction.ParagraphRequest
	39, // 76: transaction.TransactionService.ListParagraph:input_type -> transaction.ParagraphRequest
	42, // 77: transaction.TransactionService.ListListenDisplay:input_type -> transaction.ListenDisplayRequest
	45, // 78: transaction.TransactionService.ListSpeakDisplay:input_type -> transaction.SpeakDisplayRequest
	48, // 79: transaction.TransactionService.ListFavourite:input_type -> transaction.FavouriteRequest
	47, // 80: transaction.TransactionService.CreateFavourite:input_type -> transaction.Favourite
	47, // 81: transaction.TransactionService.DeleteFavourite:input_type -> transaction.Favourite
	38, // 82: transaction.TransactionService.StartParagraph:input_type -> transaction.Paragraph
	54, // 83: transaction.TransactionService.ListNewDetail:input_type -> transaction.NewDetailRequest
	51, // 84: transaction.TransactionService.ListNew:input_type -> transaction.NewRequest
	56, // 85: transaction.TransactionService.StartLearn:input_type -> transaction.Learn
	56, // 86: transaction.TransactionService.EndLearn:input_type -> transaction.Learn
	59, // 87: transaction.TransactionService.CreateMemberAnswer:input_type -> transaction.Answer
	59, // 88: transaction.TransactionService.UpdateMemberAnswer:input_type -> transaction.Answer
	60, // 89: transaction.TransactionService.ListMemberAnswer:input_type -> transaction.AnswerRequest
	61, // 90: transaction.TransactionService.CreateAnswers:input_type -> transaction.Answers
	84, // 91: transaction.TransactionService.ListReportToken:input_type -> transaction.ReportTokenRequest
	81, // 92: transaction.TransactionService.ListReportPoint:input_type -> transaction.ReportPointRequest
	78, // 93: transaction.TransactionService.ListReportMember:input_type -> transaction.ReportMemberRequest
	60, // 94: transaction.TransactionService.CreateRecommend:input_type -> transaction.AnswerRequest
	72, // 95: transaction.TransactionService.BuyToken:input_type -> transaction.CartRequest
	72, // 96: transaction.TransactionService.PaymentCart:input_type -> transaction.CartRequest
	66, // 97: transaction.TransactionService.ListMemberTokenTransaction:input_type -> transaction.MemberTokenTransactionRequest
	24, // 98: transaction.TransactionService.ListListen:output_type -> transaction.Listen
	24, // 99: transaction.TransactionService.EndLearnListen:output_type -> transaction.Listen
	27, // 100: transaction.TransactionService.ListSpeak:output_type -> transaction.Speaks
	26, // 101: transaction.TransactionService.UpdateSpeak:output_type -> transaction.Speak
	26, // 102: transaction.TransactionService.EndLearnSpeak:output_type -> transaction.Speak
	35, // 103: transaction.TransactionService.CreateSentence:output_type -> transaction.Sentence
	32, // 104: transaction.TransactionService.CreateLookup:output_type -> transaction.Lookup
	38, // 105: transaction.TransactionService.CreateParagraph:output_type -> transaction.Paragraph
	38, // 106: transaction.TransactionService.CompleteParagraph:output_type -> transaction.Paragraph
	34, // 107: transaction.TransactionService.ListLookup:output_type -> transaction.Lookups
	37, // 108: transaction.TransactionService.ListSentence:output_type -> transaction.Sentences
	38, // 109: transaction.TransactionService.GetParagraphMax:output_type -> transaction.Paragraph
	40, // 110: transaction.TransactionService.ListParagraph:output_type -> transaction.Paragraphs
	43, // 111: transaction.TransactionService.ListListenDisplay:output_type -> transaction.ListenDisplays
	46, // 112: transaction.TransactionService.ListSpeakDisplay:output_type -> transaction.SpeakDisplays
	49, // 113: transaction.TransactionService.ListFavourite:output_type -> transaction.Favourites
	47, // 114: transaction.TransactionService.CreateFavourite:output_type -> transaction.Favourite
	47, // 115: transaction.TransactionService.DeleteFavourite:output_type -> transaction.Favourite
	38, // 116: transaction.TransactionService.StartParagraph:output_type -> transaction.Paragraph
	55, // 117: transaction.TransactionService.ListNewDetail:output_type -> transaction.NewDetails
	52, // 118: transaction.TransactionService.ListNew:output_type -> transaction.News
	56, // 119: transaction.TransactionService.StartLearn:output_type -> transaction.Learn
	56, // 120: transaction.TransactionService.EndLearn:output_type -> transaction.Learn
	59, // 121: transaction.TransactionService.CreateMemberAnswer:output_type -> transaction.Answer
	59, // 122: transaction.TransactionService.UpdateMemberAnswer:output_type -> transaction.Answer
	61, // 123: transaction.TransactionService.ListMemberAnswer:output_type -> transaction.Answers
	61, // 124: transaction.TransactionService.CreateAnswers:output_type -> transaction.Answers
	85, // 125: transaction.TransactionService.ListReportToken:output_type -> transaction.ReportTokens
	82, // 126: transaction.TransactionService.ListReportPoint:output_type -> transaction.ReportPoints
	79, // 127: transaction.TransactionService.ListReportMember:output_type -> transaction.ReportMembers
	61, // 128: transaction.TransactionService.CreateRecommend:output_type -> transaction.Answers
	71, // 129: transaction.TransactionService.BuyToken:output_type -> transaction.Cart
	71, // 130: transaction.TransactionService.PaymentCart:output_type -> transaction.Cart
	67, // 131: transaction.TransactionService.ListMemberTokenTransaction:output_type -> transaction.MemberTokenTransactions
