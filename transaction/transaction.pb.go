...
var file_transaction_proto_rawDesc = []byte{
	...
	0x4c, 0x65, 0x61, 0x72, 0x6e, 0x52, 0x06, 0x6c, 0x65, 0x61, 0x72, 0x6e, 0x73, 0x22, 0x8b, 0x02,
	...
	0x6f, 0x6e, 0x12, 0x14, 0x0a, 0x05, 0x69, 0x6e, 0x74, 0x33, 0x32, 0x18, 0x08, 0x20, 0x01, 0x28,
	0x05, 0x52, 0x05, 0x69, 0x6e, 0x74, 0x33, 0x32, 0x12, 0x12, 0x0a, 0x04, 0x68, 0x61, 0x73, 0x68,
	...
	0x52, 0x09, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x32, 0xfc, 0x0b, 0x0a, 0x12,
	...
	0x69, 0x6f, 0x6e, 0x2e, 0x53, 0x70, 0x65, 0x61, 0x6b, 0x73, 0x12, 0x37, 0x0a, 0x0d, 0x45, 0x6e,
	...
	0x12, 0x38, 0x0a, 0x0c, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x41, 0x6e, 0x73, 0x77, 0x65, 0x72,
	...
	0x69, 0x6f, 0x6e, 0x2e, 0x41, 0x6e, 0x73, 0x77, 0x65, 0x72, 0x42, 0x2f, 0x5a, 0x2d, 0x67, 0x69,
...
var file_transaction_proto_enumTypes = make([]protoimpl.EnumInfo, 8)
...
var file_transaction_proto_goTypes = []interface{}{
	...
	(*Listen)(nil),               // 8: transaction.Listen
	(*ListenRequest)(nil),        // 9: transaction.ListenRequest
	(*Speak)(nil),                // 10: transaction.Speak
	(*Speaks)(nil),               // 11: transaction.Speaks
	(*SpeakRequest)(nil),         // 12: transaction.SpeakRequest
	(*Lookup)(nil),               // 13: transaction.Lookup
	(*LookupRequest)(nil),        // 14: transaction.LookupRequest
	(*Lookups)(nil),              // 15: transaction.Lookups
	(*Sentence)(nil),             // 16: transaction.Sentence
	(*SentenceRequest)(nil),      // 17: transaction.SentenceRequest
	(*Sentences)(nil),            // 18: transaction.Sentences
	(*Paragraph)(nil),            // 19: transaction.Paragraph
	(*ParagraphRequest)(nil),     // 20: transaction.ParagraphRequest
	(*Paragraphs)(nil),           // 21: transaction.Paragraphs
	(*ListenDisplay)(nil),        // 22: transaction.ListenDisplay
	(*ListenDisplayRequest)(nil), // 23: transaction.ListenDisplayRequest
	(*ListenDisplays)(nil),       // 24: transaction.ListenDisplays
	(*SpeakDisplay)(nil),         // 25: transaction.SpeakDisplay
	(*SpeakDisplayRequest)(nil),  // 26: transaction.SpeakDisplayRequest
	(*SpeakDisplays)(nil),        // 27: transaction.SpeakDisplays
	(*Favourite)(nil),            // 28: transaction.Favourite
	(*FavouriteRequest)(nil),     // 29: transaction.FavouriteRequest
	(*Favourites)(nil),           // 30: transaction.Favourites
	(*New)(nil),                  // 31: transaction.New
	(*NewRequest)(nil),           // 32: transaction.NewRequest
	(*News)(nil),                 // 33: transaction.News
	(*NewDetail)(nil),            // 34: transaction.NewDetail
	(*NewDetailRequest)(nil),     // 35: transaction.NewDetailRequest
	(*NewDetails)(nil),           // 36: transaction.NewDetails
	(*Learn)(nil),                // 37: transaction.Learn
	(*LearnRequest)(nil),         // 38: transaction.LearnRequest
	(*Learns)(nil),               // 39: transaction.Learns
	(*Answer)(nil),               // 40: transaction.Answer
	(*library.Sentence)(nil),     // 41: library.Sentence
	(*library.SentencePos)(nil),  // 42: library.SentencePos
	(*library.Paragraph)(nil),    // 43: library.Paragraph
	(*library.Document)(nil),     // 44: library.Document
	(*library.Course)(nil),       // 45: library.Course
}
var file_transaction_proto_depIdxs = []int32{
	10, // 0: transaction.Speaks.speaks:type_name -> transaction.Speak
	41, // 1: transaction.Lookup.sentence:type_name -> library.Sentence
	42, // 2: transaction.Lookup.sentence_pos:type_name -> library.SentencePos
	13, // 3: transaction.Lookups.lookups:type_name -> transaction.Lookup
	41, // 4: transaction.Sentence.sentence:type_name -> library.Sentence
	16, // 5: transaction.Sentences.sentences:type_name -> transaction.Sentence
	43, // 6: transaction.Paragraph.paragraph:type_name -> library.Paragraph
	44, // 7: transaction.Paragraph.document:type_name -> library.Document
	45, // 8: transaction.Paragraph.course:type_name -> library.Course
	0,  // 9: transaction.Paragraph.process:type_name -> transaction.Paragraph.Process
	19, // 10: transaction.Paragraphs.paragraphs:type_name -> transaction.Paragraph
	22, // 11: transaction.ListenDisplays.listen_displays:type_name -> transaction.ListenDisplay
	25, // 12: transaction.SpeakDisplays.speak_displays:type_name -> transaction.SpeakDisplay
	43, // 13: transaction.Favourite.paragraph:type_name -> library.Paragraph
	44, // 14: transaction.Favourite.document:type_name -> library.Document
	45, // 15: transaction.Favourite.course:type_name -> library.Course
	1,  // 16: transaction.Favourite.status:type_name -> transaction.Favourite.Status
	28, // 17: transaction.Favourites.favourites:type_name -> transaction.Favourite
	2,  // 18: transaction.New.type:type_name -> transaction.New.Type
	3,  // 19: transaction.New.status:type_name -> transaction.New.Status
	43, // 20: transaction.New.paragraph:type_name -> library.Paragraph
	34, // 21: transaction.New.new_details:type_name -> transaction.NewDetail
	31, // 22: transaction.News.News:type_name -> transaction.New
	4,  // 23: transaction.NewDetail.status:type_name -> transaction.NewDetail.Status
	41, // 24: transaction.NewDetail.sentence:type_name -> library.Sentence
	31, // 25: transaction.NewDetail.new:type_name -> transaction.New
	34, // 26: transaction.NewDetails.new_details:type_name -> transaction.NewDetail
	...
	37, // 30: transaction.Learns.learns:type_name -> transaction.Learn
	9,  // 31: transaction.TransactionService.ListListen:input_type -> transaction.ListenRequest
	8,  // 32: transaction.TransactionService.EndLearnListen:input_type -> transaction.Listen
	12, // 33: transaction.TransactionService.ListSpeak:input_type -> transaction.SpeakRequest
	10, // 34: transaction.TransactionService.EndLearnSpeak:input_type -> transaction.Speak
	16, // 35: transaction.TransactionService.CreateSentence:input_type -> transaction.Sentence
	13, // 36: transaction.TransactionService.CreateLookup:input_type -> transaction.Lookup
	19, // 37: transaction.TransactionService.CreateParagraph:input_type -> transaction.Paragraph
	19, // 38: transaction.TransactionService.CompleteParagraph:input_type -> transaction.Paragraph
	14, // 39: transaction.TransactionService.ListLookup:input_type -> transaction.LookupRequest
	17, // 40: transaction.TransactionService.ListSentence:input_type -> transaction.SentenceRequest
	20, // 41: transaction.TransactionService.GetParagraphMax:input_type -> transaction.ParagraphRequest
	20, // 42: transaction.TransactionService.ListParagraph:input_type -> transaction.ParagraphRequest
	23, // 43: transaction.TransactionService.ListListenDisplay:input_type -> transaction.ListenDisplayRequest
	26, // 44: transaction.TransactionService.ListSpeakDisplay:input_type -> transaction.SpeakDisplayRequest
	29, // 45: transaction.TransactionService.ListFavourite:input_type -> transaction.FavouriteRequest
	28, // 46: transaction.TransactionService.CreateFavourite:input_type -> transaction.Favourite
	28, // 47: transaction.TransactionService.DeleteFavourite:input_type -> transaction.Favourite
	19, // 48: transaction.TransactionService.StartParagraph:input_type -> transaction.Paragraph
	35, // 49: transaction.TransactionService.ListNewDetail:input_type -> transaction.NewDetailRequest
	32, // 50: transaction.TransactionService.ListNew:input_type -> transaction.NewRequest
	37, // 51: transaction.TransactionService.StartLearn:input_type -> transaction.Learn
	37, // 52: transaction.TransactionService.EndLearn:input_type -> transaction.Learn
	40, // 53: transaction.TransactionService.CreateAnswer:input_type -> transaction.Answer
	8,  // 54: transaction.TransactionService.ListListen:output_type -> transaction.Listen
	8,  // 55: transaction.TransactionService.EndLearnListen:output_type -> transaction.Listen
	11, // 56: transaction.TransactionService.ListSpeak:output_type -> transaction.Speaks
	10, // 57: transaction.TransactionService.EndLearnSpeak:output_type -> transaction.Speak
	16, // 58: transaction.TransactionService.CreateSentence:output_type -> transaction.Sentence
	13, // 59: transaction.TransactionService.CreateLookup:output_type -> transaction.Lookup
	19, // 60: transaction.TransactionService.CreateParagraph:output_type -> transaction.Paragraph
	19, // 61: transaction.TransactionService.CompleteParagraph:output_type -> transaction.Paragraph
	15, // 62: transaction.TransactionService.ListLookup:output_type -> transaction.Lookups
	18, // 63: transaction.TransactionService.ListSentence:output_type -> transaction.Sentences
	19, // 64: transaction.TransactionService.GetParagraphMax:output_type -> transaction.Paragraph
	21, // 65: transaction.TransactionService.ListParagraph:output_type -> transaction.Paragraphs
	24, // 66: transaction.TransactionService.ListListenDisplay:output_type -> transaction.ListenDisplays
	27, // 67: transaction.TransactionService.ListSpeakDisplay:output_type -> transaction.SpeakDisplays
	30, // 68: transaction.TransactionService.ListFavourite:output_type -> transaction.Favourites
	28, // 69: transaction.TransactionService.CreateFavourite:output_type -> transaction.Favourite
	28, // 70: transaction.TransactionService.DeleteFavourite:output_type -> transaction.Favourite
	19, // 71: transaction.TransactionService.StartParagraph:output_type -> transaction.Paragraph
	36, // 72: transaction.TransactionService.ListNewDetail:output_type -> transaction.NewDetails
	33, // 73: transaction.TransactionService.ListNew:output_type -> transaction.News
	37, // 74: transaction.TransactionService.StartLearn:output_type -> transaction.Learn
	37, // 75: transaction.TransactionService.EndLearn:output_type -> transaction.Learn
	40, // 76: transaction.TransactionService.CreateAnswer:output_type -> transaction.Answer
