...
var file_transaction_proto_rawDesc = []byte{
	...
	0x74, 0x22, 0x77, 0x0a, 0x08, 0x53, 0x65, 0x6e, 0x74, 0x65, 0x6e, 0x63, 0x65, 0x12, 0x0e, 0x0a,
	0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1b, 0x0a,
	0x09, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x08, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x49, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x65,
	0x6e, 0x74, 0x65, 0x6e, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52,
	...
	0x09, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0xb8, 0x01, 0x0a, 0x09, 0x50,
	...
	0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x9d, 0x02, 0x0a, 0x10, 0x50, 0x61, 0x72, 0x61, 0x67, 0x72,
	...
	0x6c, 0x75, 0x64, 0x65, 0x73, 0x22, 0x5a, 0x0a, 0x0a, 0x50, 0x61, 0x72, 0x61, 0x67, 0x72, 0x61,
	...
	0x6c, 0x32, 0xc2, 0x03, 0x0a, 0x12, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f,
	...
	0x61, 0x67, 0x72, 0x61, 0x70, 0x68, 0x42, 0x2f, 0x5a, 0x2d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_transaction_proto_goTypes = []interface{}{
	...
	(*Paragraph)(nil),        // 7: transaction.Paragraph
	(*ParagraphRequest)(nil), // 8: transaction.ParagraphRequest
	(*Paragraphs)(nil),       // 9: transaction.Paragraphs
}
var file_transaction_proto_depIdxs = []int32{
	2, // 0: transaction.Speaks.speaks:type_name -> transaction.Speak
	7, // 1: transaction.Paragraphs.paragraphs:type_name -> transaction.Paragraph
	1, // 2: transaction.TransactionService.ListListen:input_type -> transaction.ListenRequest
	0, // 3: transaction.TransactionService.EndLearnListen:input_type -> transaction.Listen
	4, // 4: transaction.TransactionService.ListSpeak:input_type -> transaction.SpeakRequest
	2, // 5: transaction.TransactionService.EndLearnSpeak:input_type -> transaction.Speak
	6, // 6: transaction.TransactionService.CreateSentence:input_type -> transaction.Sentence
	5, // 7: transaction.TransactionService.CreateLookup:input_type -> transaction.Lookup
	7, // 8: transaction.TransactionService.CreateParagraph:input_type -> transaction.Paragraph
	0, // 9: transaction.TransactionService.ListListen:output_type -> transaction.Listen
	0, // 10: transaction.TransactionService.EndLearnListen:output_type -> transaction.Listen
	3, // 11: transaction.TransactionService.ListSpeak:output_type -> transaction.Speaks
	2, // 12: transaction.TransactionService.EndLearnSpeak:output_type -> transaction.Speak
	6, // 13: transaction.TransactionService.CreateSentence:output_type -> transaction.Sentence
	5, // 14: transaction.TransactionService.CreateLookup:output_type -> transaction.Lookup
	7, // 15: transaction.TransactionService.CreateParagraph:output_type -> transaction.Paragraph
