...
var file_transaction_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c,
	0x22, 0xf3, 0x01, 0x0a, 0x09, 0x46, 0x61, 0x76, 0x6f, 0x75, 0x72, 0x69, 0x74, 0x65, 0x12, 0x0e,
	...
	0x28, 0x03, 0x52, 0x08, 0x6f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x64, 0x12, 0x30, 0x0a, 0x09,
	0x70, 0x61, 0x72, 0x61, 0x67, 0x72, 0x61, 0x70, 0x68, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x12, 0x2e, 0x6c, 0x69, 0x62, 0x72, 0x61, 0x72, 0x79, 0x2e, 0x50, 0x61, 0x72, 0x61, 0x67, 0x72,
	0x61, 0x70, 0x68, 0x52, 0x09, 0x70, 0x61, 0x72, 0x61, 0x67, 0x72, 0x61, 0x70, 0x68, 0x12, 0x2d,
	...
	0x06, 0x63, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e,
	0x6c, 0x69, 0x62, 0x72, 0x61, 0x72, 0x79, 0x2e, 0x43, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x52, 0x06,
	0x63, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x22, 0xff, 0x01, 0x0a, 0x10, 0x46, 0x61, 0x76, 0x6f, 0x75,
	...
	0x69, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x73, 0x22, 0x5a, 0x0a, 0x0a, 0x46, 0x61, 0x76, 0x6f,
	...
	0x6f, 0x74, 0x61, 0x6c, 0x32, 0xd1, 0x08, 0x0a, 0x12, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63,
	...
	0x61, 0x76, 0x6f, 0x75, 0x72, 0x69, 0x74, 0x65, 0x42, 0x2f, 0x5a, 0x2d, 0x67, 0x69, 0x74, 0x68,
...
var file_transaction_proto_goTypes = []interface{}{
	...
	(*Favourite)(nil),            // 20: transaction.Favourite
	(*FavouriteRequest)(nil),     // 21: transaction.FavouriteRequest
	(*Favourites)(nil),           // 22: transaction.Favourites
	(*library.Sentence)(nil),     // 23: library.Sentence
	(*library.SentencePos)(nil),  // 24: library.SentencePos
	(*library.Paragraph)(nil),    // 25: library.Paragraph
	(*library.Document)(nil),     // 26: library.Document
	(*library.Course)(nil),       // 27: library.Course
}
var file_transaction_proto_depIdxs = []int32{
	2,  // 0: transaction.Speaks.speaks:type_name -> transaction.Speak
	23, // 1: transaction.Lookup.sentence:type_name -> library.Sentence
	24, // 2: transaction.Lookup.sentence_pos:type_name -> library.SentencePos
	5,  // 3: transaction.Lookups.lookups:type_name -> transaction.Lookup
	23, // 4: transaction.Sentence.sentence:type_name -> library.Sentence
	8,  // 5: transaction.Sentences.sentences:type_name -> transaction.Sentence
	25, // 6: transaction.Paragraph.paragraph:type_name -> library.Paragraph
	26, // 7: transaction.Paragraph.document:type_name -> library.Document
	27, // 8: transaction.Paragraph.course:type_name -> library.Course
	...
	25, // 12: transaction.Favourite.paragraph:type_name -> library.Paragraph
	26, // 13: transaction.Favourite.document:type_name -> library.Document
	27, // 14: transaction.Favourite.course:type_name -> library.Course
	20, // 15: transaction.Favourites.favourites:type_name -> transaction.Favourite
	1,  // 16: transaction.TransactionService.ListListen:input_type -> transaction.ListenRequest
	0,  // 17: transaction.TransactionService.EndLearnListen:input_type -> transaction.Listen
	4,  // 18: transaction.TransactionService.ListSpeak:input_type -> transaction.SpeakRequest
	2,  // 19: transaction.TransactionService.EndLearnSpeak:input_type -> transaction.Speak
	8,  // 20: transaction.TransactionService.CreateSentence:input_type -> transaction.Sentence
	5,  // 21: transaction.TransactionService.CreateLookup:input_type -> transaction.Lookup
	11, // 22: transaction.TransactionService.CreateParagraph:input_type -> transaction.Paragraph
	6,  // 23: transaction.TransactionService.ListLookup:input_type -> transaction.LookupRequest
	9,  // 24: transaction.TransactionService.ListSentence:input_type -> transaction.SentenceRequest
	12, // 25: transaction.TransactionService.GetParagraphMax:input_type -> transaction.ParagraphRequest
	12, // 26: transaction.TransactionService.ListParagraph:input_type -> transaction.ParagraphRequest
	15, // 27: transaction.TransactionService.ListListenDisplay:input_type -> transaction.ListenDisplayRequest
	18, // 28: transaction.TransactionService.ListSpeakDisplay:input_type -> transaction.SpeakDisplayRequest
	21, // 29: transaction.TransactionService.ListFavourite:input_type -> transaction.FavouriteRequest
	20, // 30: transaction.TransactionService.CreateFavourite:input_type -> transaction.Favourite
	20, // 31: transaction.TransactionService.DeleteFavourite:input_type -> transaction.Favourite
	0,  // 32: transaction.TransactionService.ListListen:output_type -> transaction.Listen
	0,  // 33: transaction.TransactionService.EndLearnListen:output_type -> transaction.Listen
	3,  // 34: transaction.TransactionService.ListSpeak:output_type -> transaction.Speaks
	2,  // 35: transaction.TransactionService.EndLearnSpeak:output_type -> transaction.Speak
	8,  // 36: transaction.TransactionService.CreateSentence:output_type -> transaction.Sentence
	5,  // 37: transaction.TransactionService.CreateLookup:output_type -> transaction.Lookup
	11, // 38: transaction.TransactionService.CreateParagraph:output_type -> transaction.Paragraph
	7,  // 39: transaction.TransactionService.ListLookup:output_type -> transaction.Lookups
	10, // 40: transaction.TransactionService.ListSentence:output_type -> transaction.Sentences
	11, // 41: transaction.TransactionService.GetParagraphMax:output_type -> transaction.Paragraph
	13, // 42: transaction.TransactionService.ListParagraph:output_type -> transaction.Paragraphs
	16, // 43: transaction.TransactionService.ListListenDisplay:output_type -> transaction.ListenDisplays
	19, // 44: transaction.TransactionService.ListSpeakDisplay:output_type -> transaction.SpeakDisplays
	22, // 45: transaction.TransactionService.ListFavourite:output_type -> transaction.Favourites
	20, // 46: transaction.TransactionService.CreateFavourite:output_type -> transaction.Favourite
	20, // 47: transaction.TransactionService.DeleteFavourite:output_type -> transaction.Favourite
