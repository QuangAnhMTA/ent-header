...
var file_transaction_proto_rawDesc = []byte{
	...
	0x8e, 0x03, 0x0a, 0x03, 0x4e, 0x65, 0x77, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x6d, 0x65, 0x6d, 0x62, 0x65,
	0x72, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x6d, 0x65, 0x6d, 0x62,
	...
	0x68, 0x22, 0x25, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65, 0x12, 0x10, 0x0a, 0x0c, 0x64, 0x65, 0x66,
	0x61, 0x75, 0x6c, 0x74, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x07, 0x6c,
	0x6f, 0x6f, 0x6b, 0x5f, 0x75, 0x70, 0x10, 0x01, 0x22, 0x36, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74,
	...
	0x03, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x32, 0xa1, 0x0a, 0x0a, 0x12, 0x54, 0x72, 0x61,
	...
	0x6e, 0x2e, 0x4e, 0x65, 0x77, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x42, 0x2f, 0x5a, 0x2d,
...
var file_transaction_proto_depIdxs = []int32{
	...
	28, // 21: transaction.News.News:type_name -> transaction.New
	4,  // 22: transaction.NewDetail.status:type_name -> transaction.NewDetail.Status
	34, // 23: transaction.NewDetail.sentence:type_name -> library.Sentence
	28, // 24: transaction.NewDetail.new:type_name -> transaction.New
	31, // 25: transaction.NewDetails.new_details:type_name -> transaction.NewDetail
	6,  // 26: transaction.TransactionService.ListListen:input_type -> transaction.ListenRequest
	5,  // 27: transaction.TransactionService.EndLearnListen:input_type -> transaction.Listen
	9,  // 28: transaction.TransactionService.ListSpeak:input_type -> transaction.SpeakRequest
	7,  // 29: transaction.TransactionService.EndLearnSpeak:input_type -> transaction.Speak
	13, // 30: transaction.TransactionService.CreateSentence:input_type -> transaction.Sentence
	10, // 31: transaction.TransactionService.CreateLookup:input_type -> transaction.Lookup
	16, // 32: transaction.TransactionService.CreateParagraph:input_type -> transaction.Paragraph
	16, // 33: transaction.TransactionService.CompleteParagraph:input_type -> transaction.Paragraph
	11, // 34: transaction.TransactionService.ListLookup:input_type -> transaction.LookupRequest
	14, // 35: transaction.TransactionService.ListSentence:input_type -> transaction.SentenceRequest
	17, // 36: transaction.TransactionService.GetParagraphMax:input_type -> transaction.ParagraphRequest
	17, // 37: transaction.TransactionService.ListParagraph:input_type -> transaction.ParagraphRequest
	20, // 38: transaction.TransactionService.ListListenDisplay:input_type -> transaction.ListenDisplayRequest
	23, // 39: transaction.TransactionService.ListSpeakDisplay:input_type -> transaction.SpeakDisplayRequest
	26, // 40: transaction.TransactionService.ListFavourite:input_type -> transaction.FavouriteRequest
	25, // 41: transaction.TransactionService.CreateFavourite:input_type -> transaction.Favourite
	25, // 42: transaction.TransactionService.DeleteFavourite:input_type -> transaction.Favourite
	16, // 43: transaction.TransactionService.StartParagraph:input_type -> transaction.Paragraph
	32, // 44: transaction.TransactionService.ListNewDetail:input_type -> transaction.NewDetailRequest
	5,  // 45: transaction.TransactionService.ListListen:output_type -> transaction.Listen
	5,  // 46: transaction.TransactionService.EndLearnListen:output_type -> transaction.Listen
	8,  // 47: transaction.TransactionService.ListSpeak:output_type -> transaction.Speaks
	7,  // 48: transaction.TransactionService.EndLearnSpeak:output_type -> transaction.Speak
	13, // 49: transaction.TransactionService.CreateSentence:output_type -> transaction.Sentence
	10, // 50: transaction.TransactionService.CreateLookup:output_type -> transaction.Lookup
	16, // 51: transaction.TransactionService.CreateParagraph:output_type -> transaction.Paragraph
	16, // 52: transaction.TransactionService.CompleteParagraph:output_type -> transaction.Paragraph
	12, // 53: transaction.TransactionService.ListLookup:output_type -> transaction.Lookups
	15, // 54: transaction.TransactionService.ListSentence:output_type -> transaction.Sentences
	16, // 55: transaction.TransactionService.GetParagraphMax:output_type -> transaction.Paragraph
	18, // 56: transaction.TransactionService.ListParagraph:output_type -> transaction.Paragraphs
	21, // 57: transaction.TransactionService.ListListenDisplay:output_type -> transaction.ListenDisplays
	24, // 58: transaction.TransactionService.ListSpeakDisplay:output_type -> transaction.SpeakDisplays
	27, // 59: transaction.TransactionService.ListFavourite:output_type -> transaction.Favourites
	25, // 60: transaction.TransactionService.CreateFavourite:output_type -> transaction.Favourite
	25, // 61: transaction.TransactionService.DeleteFavourite:output_type -> transaction.Favourite
	16, // 62: transaction.TransactionService.StartParagraph:output_type -> transaction.Paragraph
	33, // 63: transaction.TransactionService.ListNewDetail:output_type -> transaction.NewDetails
