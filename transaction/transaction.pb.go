...
var file_transaction_proto_rawDesc = []byte{
	...
	0x4c, 0x65, 0x61, 0x72, 0x6e, 0x52, 0x06, 0x6c, 0x65, 0x61, 0x72, 0x6e, 0x73, 0x32, 0xc2, 0x0b,
	...
	0x2e, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x4c, 0x65, 0x61,
	0x72, 0x6e, 0x42, 0x2f, 0x5a, 0x2d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
...
var file_transaction_proto_goTypes = []interface{}{
	...
	(*library.Sentence)(nil),     // 40: library.Sentence
	(*library.SentencePos)(nil),  // 41: library.SentencePos
	(*library.Paragraph)(nil),    // 42: library.Paragraph
	(*library.Document)(nil),     // 43: library.Document
	(*library.Course)(nil),       // 44: library.Course
}
var file_transaction_proto_depIdxs = []int32{
	10, // 0: transaction.Speaks.speaks:type_name -> transaction.Speak
	40, // 1: transaction.Lookup.sentence:type_name -> library.Sentence
	41, // 2: transaction.Lookup.sentence_pos:type_name -> library.SentencePos
	13, // 3: transaction.Lookups.lookups:type_name -> transaction.Lookup
	40, // 4: transaction.Sentence.sentence:type_name -> library.Sentence
	16, // 5: transaction.Sentences.sentences:type_name -> transaction.Sentence
	42, // 6: transaction.Paragraph.paragraph:type_name -> library.Paragraph
	43, // 7: transaction.Paragraph.document:type_name -> library.Document
	44, // 8: transaction.Paragraph.course:type_name -> library.Course
	...
	42, // 13: transaction.Favourite.paragraph:type_name -> library.Paragraph
	43, // 14: transaction.Favourite.document:type_name -> library.Document
	44, // 15: transaction.Favourite.course:type_name -> library.Course
	...
	42, // 20: transaction.New.paragraph:type_name -> library.Paragraph
	...
	40, // 24: transaction.NewDetail.sentence:type_name -> library.Sentence
	...
	8,  // 53: transaction.TransactionService.ListListen:output_type -> transaction.Listen
	8,  // 54: transaction.TransactionService.EndLearnListen:output_type -> transaction.Listen
	11, // 55: transaction.TransactionService.ListSpeak:output_type -> transaction.Speaks
	10, // 56: transaction.TransactionService.EndLearnSpeak:output_type -> transaction.Speak
	16, // 57: transaction.TransactionService.CreateSentence:output_type -> transaction.Sentence
	13, // 58: transaction.TransactionService.CreateLookup:output_type -> transaction.Lookup
	19, // 59: transaction.TransactionService.CreateParagraph:output_type -> transaction.Paragraph
	19, // 60: transaction.TransactionService.CompleteParagraph:output_type -> transaction.Paragraph
	15, // 61: transaction.TransactionService.ListLookup:output_type -> transaction.Lookups
	18, // 62: transaction.TransactionService.ListSentence:output_type -> transaction.Sentences
	19, // 63: transaction.TransactionService.GetParagraphMax:output_type -> transaction.Paragraph
	21, // 64: transaction.TransactionService.ListParagraph:output_type -> transaction.Paragraphs
	24, // 65: transaction.TransactionService.ListListenDisplay:output_type -> transaction.ListenDisplays
	27, // 66: transaction.TransactionService.ListSpeakDisplay:output_type -> transaction.SpeakDisplays
	30, // 67: transaction.TransactionService.ListFavourite:output_type -> transaction.Favourites
	28, // 68: transaction.TransactionService.CreateFavourite:output_type -> transaction.Favourite
	28, // 69: transaction.TransactionService.DeleteFavourite:output_type -> transaction.Favourite
	19, // 70: transaction.TransactionService.StartParagraph:output_type -> transaction.Paragraph
	36, // 71: transaction.TransactionService.ListNewDetail:output_type -> transaction.NewDetails
	33, // 72: transaction.TransactionService.ListNew:output_type -> transaction.News
	37, // 73: transaction.TransactionService.StartLearn:output_type -> transaction.Learn
	37, // 74: transaction.TransactionService.EndLearn:output_type -> transaction.Learn
