...
func (x *AccountRequest) GetCreatedAt() int32 {
	if x != nil {
		return x.CreatedAt
	}
	return 0
...
func (x *Account) GetCreatedAt() int32 {
	if x != nil {
		return x.CreatedAt
	}
	return 0
...
func (x *MemberRequest) GetCreatedAt() int32 {
	if x != nil {
		return x.CreatedAt
	}
	return 0
...
func (x *Member) GetCreatedAt() int32 {
	if x != nil {
		return x.CreatedAt
	}
	return 0
...
var file_account_proto_rawDesc = []byte{
	...
	0x28, 0x05, 0x52, 0x09, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x12, 0x16, 0x0a,
	...
	0x61, 0x6c, 0x32, 0xe2, 0x03, 0x0a, 0x0e, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x53, 0x65,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x54, 0x0a, 0x0f, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74,
	...
	0x75, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x20, 0x2e, 0x61, 0x63, 0x63,
	0x6f, 0x75, 0x6e, 0x74, 0x2e, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x41, 0x63, 0x63,
	0x6f, 0x75, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x44, 0x0a, 0x05,
	...
	0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x42, 0x2b, 0x5a, 0x29, 0x67, 0x69, 0x74, 0x68, 0x75,
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x51, 0x75, 0x61, 0x6e, 0x67, 0x41, 0x6e, 0x68, 0x4d, 0x54,
	0x41, 0x2f, 0x65, 0x6e, 0x74, 0x2d, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2f, 0x61, 0x63, 0x63,
...
var file_account_proto_goTypes = []interface{}{
	...
	(*Claims)(nil),                       // 2: account.Claims
	(*AccountRequest)(nil),               // 3: account.AccountRequest
	(*Account)(nil),                      // 4: account.Account
	(*Accounts)(nil),                     // 5: account.Accounts
	(*CheckRegisterAccountRequest)(nil),  // 6: account.CheckRegisterAccountRequest
	(*CheckRegisterAccountResponse)(nil), // 7: account.CheckRegisterAccountResponse
	(*VerifyOtpRegisterRequest)(nil),     // 8: account.VerifyOtpRegisterRequest
	(*VerifyOtpRegisterResponse)(nil),    // 9: account.VerifyOtpRegisterResponse
	(*RegisterAccountRequest)(nil),       // 10: account.RegisterAccountRequest
	(*RegisterAccountResponse)(nil),      // 11: account.RegisterAccountResponse
	(*LoginAccountRequest)(nil),          // 12: account.LoginAccountRequest
	(*LoginAccountResponse)(nil),         // 13: account.LoginAccountResponse
	(*AccessToken)(nil),                  // 14: account.AccessToken
	(*MemberRequest)(nil),                // 15: account.MemberRequest
	(*Member)(nil),                       // 16: account.Member
	(*Members)(nil),                      // 17: account.Members
}
var file_account_proto_depIdxs = []int32{
	0,  // 0: account.Account.status:type_name -> account.Account.Status
	4,  // 1: account.Accounts.accounts:type_name -> account.Account
	2,  // 2: account.LoginAccountResponse.claim:type_name -> account.Claims
	2,  // 3: account.AccessToken.claims:type_name -> account.Claims
	1,  // 4: account.Member.status:type_name -> account.Member.Status
	16, // 5: account.Members.members:type_name -> account.Member
	6,  // 6: account.AccountService.CheckRegisterAccount:input_type -> account.CheckRegisterAccountRequest
	8,  // 7: account.AccountService.VerifyOtpRegister:input_type -> account.VerifyOtpRegisterRequest
	10, // 8: account.AccountService.RegisterAccount:input_type -> account.RegisterAccountRequest
	12, // 9: account.AccountService.Login:input_type -> account.LoginAccountRequest
	3,  // 10: account.AccountService.ListAccounts:input_type -> account.AccountRequest
	15, // 11: account.AccountService.ListMembers:input_type -> account.MemberRequest
	7,  // 12: account.AccountService.CheckRegisterAccount:output_type -> account.CheckRegisterAccountResponse
	9,  // 13: account.AccountService.VerifyOtpRegister:output_type -> account.VerifyOtpRegisterResponse
	11, // 14: account.AccountService.RegisterAccount:output_type -> account.RegisterAccountResponse
	13, // 15: account.AccountService.Login:output_type -> account.LoginAccountResponse
	5,  // 16: account.AccountService.ListAccounts:output_type -> account.Accounts
	17, // 17: account.AccountService.ListMembers:output_type -> account.Members
