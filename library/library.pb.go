...
var file_library_proto_rawDesc = []byte{
	...
	0x72, 0x73, 0x32, 0xbb, 0x12, 0x0a, 0x0e, 0x4c, 0x69, 0x62, 0x72, 0x61, 0x72, 0x79, 0x53, 0x65,
...
var file_library_proto_depIdxs = []int32{
	...
	102, // 110: library.LibraryService.GetAnswer:input_type -> library.Answer
	106, // 111: library.LibraryService.ListQuiz:input_type -> library.QuizRequest
	109, // 112: library.LibraryService.ListSentenceGroup:input_type -> library.SentenceGroupRequest
	91,  // 113: library.LibraryService.ListTag:input_type -> library.TagRequest
	91,  // 114: library.LibraryService.FindTag:input_type -> library.TagRequest
	42,  // 115: library.LibraryService.UpdateSentences:input_type -> library.Sentences
	108, // 116: library.LibraryService.UpdateSentenceGroup:input_type -> library.SentenceGroup
	108, // 117: library.LibraryService.CreateSentenceGroup:input_type -> library.SentenceGroup
	64,  // 118: library.LibraryService.UpsertCharacter:input_type -> library.Character
	65,  // 119: library.LibraryService.ListCharacter:input_type -> library.CharacterRequest
	42,  // 120: library.LibraryService.SortSentence:input_type -> library.Sentences
	39,  // 121: library.LibraryService.SortParagraph:input_type -> library.Paragraphs
	41,  // 122: library.LibraryService.UpsertSentence:input_type -> library.Sentence
	40,  // 123: library.LibraryService.TokenizeSentence:input_type -> library.SentenceRequest
	110, // 124: library.LibraryService.SortSentenceGroup:input_type -> library.SentenceGroups
	63,  // 125: library.LibraryService.ListTranslation:input_type -> library.TranslationRequest
	33,  // 126: library.LibraryService.ListCourses:output_type -> library.Courses
	36,  // 127: library.LibraryService.ListDocument:output_type -> library.Documents
	35,  // 128: library.LibraryService.FindDocument:output_type -> library.Document
	39,  // 129: library.LibraryService.ListParagraph:output_type -> library.Paragraphs
	38,  // 130: library.LibraryService.FindParagraph:output_type -> library.Paragraph
	38,  // 131: library.LibraryService.CreateParagraph:output_type -> library.Paragraph
	51,  // 132: library.LibraryService.GetDataSearchEngine:output_type -> library.SearchEngines
	42,  // 133: library.LibraryService.ListSentence:output_type -> library.Sentences
	42,  // 134: library.LibraryService.StartLearnListen:output_type -> library.Sentences
	30,  // 135: library.LibraryService.EndLearnListen:output_type -> library.Listen
	58,  // 136: library.LibraryService.GetPos:output_type -> library.Pos
	38,  // 137: library.LibraryService.ApproveParagraph:output_type -> library.Paragraph
	54,  // 138: library.LibraryService.ListSentencePos:output_type -> library.SentencePoses
	41,  // 139: library.LibraryService.GetSentenceDetail:output_type -> library.Sentence
	83,  // 140: library.LibraryService.ListPronounce:output_type -> library.Pronounces
	81,  // 141: library.LibraryService.GetPronounce:output_type -> library.Pronounce
	54,  // 142: library.LibraryService.ListSentencePoses:output_type -> library.SentencePoses
	86,  // 143: library.LibraryService.ListKnowledge:output_type -> library.Knowledges
	84,  // 144: library.LibraryService.GetKnowledge:output_type -> library.Knowledge
	95,  // 145: library.LibraryService.ListTagDetail:output_type -> library.TagDetails
	101, // 146: library.LibraryService.ListQuestion:output_type -> library.Questions
	104, // 147: library.LibraryService.ListAnswer:output_type -> library.Answers
	102, // 148: library.LibraryService.GetAnswer:output_type -> library.Answer
	107, // 149: library.LibraryService.ListQuiz:output_type -> library.Quizzes
	110, // 150: library.LibraryService.ListSentenceGroup:output_type -> library.SentenceGroups
	92,  // 151: library.LibraryService.ListTag:output_type -> library.Tags
	90,  // 152: library.LibraryService.FindTag:output_type -> library.Tag
	42,  // 153: library.LibraryService.UpdateSentences:output_type -> library.Sentences
	108, // 154: library.LibraryService.UpdateSentenceGroup:output_type -> library.SentenceGroup
	108, // 155: library.LibraryService.CreateSentenceGroup:output_type -> library.SentenceGroup
	64,  // 156: library.LibraryService.UpsertCharacter:output_type -> library.Character
	66,  // 157: library.LibraryService.ListCharacter:output_type -> library.Characters
	42,  // 158: library.LibraryService.SortSentence:output_type -> library.Sentences
	39,  // 159: library.LibraryService.SortParagraph:output_type -> library.Paragraphs
	41,  // 160: library.LibraryService.UpsertSentence:output_type -> library.Sentence
	42,  // 161: library.LibraryService.TokenizeSentence:output_type -> library.Sentences
	110, // 162: library.LibraryService.SortSentenceGroup:output_type -> library.SentenceGroups
	62,  // 163: library.LibraryService.ListTranslation:output_type -> library.Translations
