...
var file_library_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x32, 0x8b, 0x0c, 0x0a, 0x0e, 0x4c, 0x69, 0x62, 0x72, 0x61, 0x72, 0x79, 0x53, 0x65,
...
var file_library_proto_depIdxs = []int32{
	...
	33,  // 109: library.LibraryService.ListCourses:output_type -> library.Courses
	36,  // 110: library.LibraryService.ListDocument:output_type -> library.Documents
	39,  // 111: library.LibraryService.ListParagraph:output_type -> library.Paragraphs
	38,  // 112: library.LibraryService.FindParagraph:output_type -> library.Paragraph
	51,  // 113: library.LibraryService.GetDataSearchEngine:output_type -> library.SearchEngines
	42,  // 114: library.LibraryService.ListSentence:output_type -> library.Sentences
	42,  // 115: library.LibraryService.StartLearnListen:output_type -> library.Sentences
	30,  // 116: library.LibraryService.EndLearnListen:output_type -> library.Listen
	58,  // 117: library.LibraryService.GetPos:output_type -> library.Pos
	38,  // 118: library.LibraryService.ApproveParagraph:output_type -> library.Paragraph
	54,  // 119: library.LibraryService.ListSentencePos:output_type -> library.SentencePoses
	41,  // 120: library.LibraryService.GetSentenceDetail:output_type -> library.Sentence
	83,  // 121: library.LibraryService.ListPronounce:output_type -> library.Pronounces
	81,  // 122: library.LibraryService.GetPronounce:output_type -> library.Pronounce
	54,  // 123: library.LibraryService.ListSentencePoses:output_type -> library.SentencePoses
	86,  // 124: library.LibraryService.ListKnowledge:output_type -> library.Knowledges
	84,  // 125: library.LibraryService.GetKnowledge:output_type -> library.Knowledge
	95,  // 126: library.LibraryService.ListTagDetail:output_type -> library.TagDetails
	101, // 127: library.LibraryService.ListQuestion:output_type -> library.Questions
	104, // 128: library.LibraryService.ListAnswer:output_type -> library.Answers
	107, // 129: library.LibraryService.ListQuiz:output_type -> library.Quizzes
	110, // 130: library.LibraryService.ListSentenceGroup:output_type -> library.SentenceGroups
	92,  // 131: library.LibraryService.ListTag:output_type -> library.Tags
	90,  // 132: library.LibraryService.FindTag:output_type -> library.Tag
	29,  // 133: library.LibraryService.UpdateSentences:output_type -> library.Empty
