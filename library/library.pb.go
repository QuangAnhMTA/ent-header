...
type SentenceGroup struct {
	...
	Status      SentenceGroup_Status `protobuf:"varint,6,opt,name=status,proto3,enum=library.SentenceGroup_Status" json:"status,omitempty"`
}
...
var file_library_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x22, 0x81, 0x02, 0x0a, 0x03, 0x54, 0x61, 0x67, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	...
	0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x6c, 0x61, 0x74, 0x65, 0x22,
	0x35, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x11, 0x0a, 0x0d, 0x64, 0x65, 0x66,
	0x61, 0x75, 0x6c, 0x74, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x10, 0x00, 0x12, 0x0c, 0x0a, 0x08,
	0x64, 0x65, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x10, 0x01, 0x12, 0x0a, 0x0a, 0x06, 0x61, 0x63,
	...
	0x65, 0x73, 0x22, 0x84, 0x02, 0x0a, 0x0d, 0x53, 0x65, 0x6e, 0x74, 0x65, 0x6e, 0x63, 0x65, 0x47,
	...
	0x61, 0x70, 0x68, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x18, 0x05,
	...
	0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x10, 0x00, 0x12,
	0x0c, 0x0a, 0x08, 0x64, 0x65, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x10, 0x01, 0x12, 0x0a, 0x0a,
	0x06, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x10, 0x02, 0x22, 0xa5, 0x02, 0x0a, 0x14, 0x53, 0x65,
	...
	0x68, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x18, 0x05, 0x20, 0x01,
	...
	0x05, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x32, 0xa6, 0x0b, 0x0a, 0x0e, 0x4c, 0x69, 0x62,
...
var file_library_proto_depIdxs = []int32{
	...
	28,  // 81: library.SentenceGroup.status:type_name -> library.SentenceGroup.Status
	107, // 82: library.SentenceGroups.setence_groups:type_name -> library.SentenceGroup
	...
	36,  // 85: library.LibraryService.ListParagraph:input_type -> library.ParagraphRequest
	36,  // 86: library.LibraryService.FindParagraph:input_type -> library.ParagraphRequest
	49,  // 87: library.LibraryService.GetDataSearchEngine:input_type -> library.SearchEngineRequest
	39,  // 88: library.LibraryService.ListSentence:input_type -> library.SentenceRequest
	39,  // 89: library.LibraryService.StartLearnListen:input_type -> library.SentenceRequest
	29,  // 90: library.LibraryService.EndLearnListen:input_type -> library.Listen
	58,  // 91: library.LibraryService.GetPos:input_type -> library.PosRequest
	37,  // 92: library.LibraryService.ApproveParagraph:input_type -> library.Paragraph
	52,  // 93: library.LibraryService.ListSentencePos:input_type -> library.SentencePosRequest
	39,  // 94: library.LibraryService.GetSentenceDetail:input_type -> library.SentenceRequest
	81,  // 95: library.LibraryService.ListPronounce:input_type -> library.PronounceRequest
	81,  // 96: library.LibraryService.GetPronounce:input_type -> library.PronounceRequest
	52,  // 97: library.LibraryService.ListSentencePoses:input_type -> library.SentencePosRequest
	84,  // 98: library.LibraryService.ListKnowledge:input_type -> library.KnowledgeRequest
	83,  // 99: library.LibraryService.GetKnowledge:input_type -> library.Knowledge
	93,  // 100: library.LibraryService.ListTagDetail:input_type -> library.TagDetailRequest
	99,  // 101: library.LibraryService.ListQuestion:input_type -> library.QuestionRequest
	102, // 102: library.LibraryService.ListAnswer:input_type -> library.AnswerRequest
	105, // 103: library.LibraryService.ListQuiz:input_type -> library.QuizRequest
	108, // 104: library.LibraryService.ListSentenceGroup:input_type -> library.SentenceGroupRequest
	90,  // 105: library.LibraryService.ListTag:input_type -> library.TagRequest
	32,  // 106: library.LibraryService.ListCourses:output_type -> library.Courses
	35,  // 107: library.LibraryService.ListDocument:output_type -> library.Documents
	38,  // 108: library.LibraryService.ListParagraph:output_type -> library.Paragraphs
	37,  // 109: library.LibraryService.FindParagraph:output_type -> library.Paragraph
	50,  // 110: library.LibraryService.GetDataSearchEngine:output_type -> library.SearchEngines
	41,  // 111: library.LibraryService.ListSentence:output_type -> library.Sentences
	41,  // 112: library.LibraryService.StartLearnListen:output_type -> library.Sentences
	29,  // 113: library.LibraryService.EndLearnListen:output_type -> library.Listen
	57,  // 114: library.LibraryService.GetPos:output_type -> library.Pos
	37,  // 115: library.LibraryService.ApproveParagraph:output_type -> library.Paragraph
	53,  // 116: library.LibraryService.ListSentencePos:output_type -> library.SentencePoses
	40,  // 117: library.LibraryService.GetSentenceDetail:output_type -> library.Sentence
	82,  // 118: library.LibraryService.ListPronounce:output_type -> library.Pronounces
	80,  // 119: library.LibraryService.GetPronounce:output_type -> library.Pronounce
	53,  // 120: library.LibraryService.ListSentencePoses:output_type -> library.SentencePoses
	85,  // 121: library.LibraryService.ListKnowledge:output_type -> library.Knowledges
	83,  // 122: library.LibraryService.GetKnowledge:output_type -> library.Knowledge
	94,  // 123: library.LibraryService.ListTagDetail:output_type -> library.TagDetails
	100, // 124: library.LibraryService.ListQuestion:output_type -> library.Questions
	103, // 125: library.LibraryService.ListAnswer:output_type -> library.Answers
	106, // 126: library.LibraryService.ListQuiz:output_type -> library.Quizzes
	109, // 127: library.LibraryService.ListSentenceGroup:output_type -> library.SentenceGroups
	91,  // 128: library.LibraryService.ListTag:output_type -> library.Tags
