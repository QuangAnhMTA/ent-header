...
var file_library_proto_rawDesc = []byte{
	...
	0x57, 0x6f, 0x72, 0x64, 0x52, 0x05, 0x77, 0x6f, 0x72, 0x64, 0x73, 0x32, 0xbc, 0x05, 0x0a, 0x0e,
...
var file_library_proto_enumTypes = make([]protoimpl.EnumInfo, 16)
var file_library_proto_msgTypes = make([]protoimpl.MessageInfo, 48)
var file_library_proto_goTypes = []interface{}{
	...
	(*Listen)(nil),                // 16: library.Listen
	(*CourseRequest)(nil),         // 17: library.CourseRequest
	(*Course)(nil),                // 18: library.Course
	(*Courses)(nil),               // 19: library.Courses
	(*DocumentRequest)(nil),       // 20: library.DocumentRequest
	(*Document)(nil),              // 21: library.Document
	(*Documents)(nil),             // 22: library.Documents
	(*ParagraphRequest)(nil),      // 23: library.ParagraphRequest
	(*Paragraph)(nil),             // 24: library.Paragraph
	(*Paragraphs)(nil),            // 25: library.Paragraphs
	(*SentenceRequest)(nil),       // 26: library.SentenceRequest
	(*Sentence)(nil),              // 27: library.Sentence
	(*Sentences)(nil),             // 28: library.Sentences
	(*AudioRequest)(nil),          // 29: library.AudioRequest
	(*Audio)(nil),                 // 30: library.Audio
	(*Audios)(nil),                // 31: library.Audios
	(*CourseTagRequest)(nil),      // 32: library.CourseTagRequest
	(*CourseTag)(nil),             // 33: library.CourseTag
	(*CourseTags)(nil),            // 34: library.CourseTags
	(*SearchEngine)(nil),          // 35: library.SearchEngine
	(*SearchEngineRequest)(nil),   // 36: library.SearchEngineRequest
	(*SearchEngines)(nil),         // 37: library.SearchEngines
	(*SentencePos)(nil),           // 38: library.SentencePos
	(*SentencePosRequest)(nil),    // 39: library.SentencePosRequest
	(*SentencePoses)(nil),         // 40: library.SentencePoses
	(*Mean)(nil),                  // 41: library.Mean
	(*MeanRequest)(nil),           // 42: library.MeanRequest
	(*Means)(nil),                 // 43: library.Means
	(*Pos)(nil),                   // 44: library.Pos
	(*PosRequest)(nil),            // 45: library.PosRequest
	(*Poses)(nil),                 // 46: library.Poses
	(*Translation)(nil),           // 47: library.Translation
	(*Translations)(nil),          // 48: library.Translations
	(*TranslationRequest)(nil),    // 49: library.TranslationRequest
	(*Character)(nil),             // 50: library.Character
	(*CharacterRequest)(nil),      // 51: library.CharacterRequest
	(*Characters)(nil),            // 52: library.Characters
	(*VoiceUsing)(nil),            // 53: library.VoiceUsing
	(*Voice)(nil),                 // 54: library.Voice
	(*Phrase)(nil),                // 55: library.Phrase
	(*PhraseRequest)(nil),         // 56: library.PhraseRequest
	(*Phrases)(nil),               // 57: library.Phrases
	(*Example)(nil),               // 58: library.Example
	(*ExampleRequest)(nil),        // 59: library.ExampleRequest
	(*Examples)(nil),              // 60: library.Examples
	(*Word)(nil),                  // 61: library.Word
	(*WordRequest)(nil),           // 62: library.WordRequest
	(*Words)(nil),                 // 63: library.Words
	(*transaction.Speak)(nil),     // 64: transaction.Speak
}
var file_library_proto_depIdxs = []int32{
	0,  // 0: library.Course.status:type_name -> library.Course.Status
	21, // 1: library.Course.documents:type_name -> library.Document
	18, // 2: library.Courses.courses:type_name -> library.Course
	1,  // 3: library.Document.status:type_name -> library.Document.Status
	24, // 4: library.Document.paragraphs:type_name -> library.Paragraph
	18, // 5: library.Document.course:type_name -> library.Course
	21, // 6: library.Documents.documents:type_name -> library.Document
	18, // 7: library.Documents.course:type_name -> library.Course
	...
	27, // 11: library.Paragraph.sentences:type_name -> library.Sentence
	21, // 12: library.Paragraph.document:type_name -> library.Document
	24, // 13: library.Paragraphs.paragraphs:type_name -> library.Paragraph
	21, // 14: library.Paragraphs.document:type_name -> library.Document
	5,  // 15: library.Sentence.status:type_name -> library.Sentence.Status
	30, // 16: library.Sentence.audios:type_name -> library.Audio
	47, // 17: library.Sentence.translation:type_name -> library.Translation
	64, // 18: library.Sentence.speak:type_name -> transaction.Speak
	24, // 19: library.Sentence.paragraph:type_name -> library.Paragraph
	38, // 20: library.Sentence.sentence_poses:type_name -> library.SentencePos
	55, // 21: library.Sentence.phrases:type_name -> library.Phrase
	27, // 22: library.Sentences.sentences:type_name -> library.Sentence
	50, // 23: library.Sentences.characters:type_name -> library.Character
	24, // 24: library.Sentences.pragraph:type_name -> library.Paragraph
	6,  // 25: library.Audio.status:type_name -> library.Audio.Status
	30, // 26: library.Audios.audios:type_name -> library.Audio
	33, // 27: library.CourseTags.courseTags:type_name -> library.CourseTag
	7,  // 28: library.SearchEngine.status:type_name -> library.SearchEngine.Status
	18, // 29: library.SearchEngine.courses:type_name -> library.Course
	21, // 30: library.SearchEngine.documents:type_name -> library.Document
	24, // 31: library.SearchEngine.paragraphs:type_name -> library.Paragraph
	35, // 32: library.SearchEngines.search_engines:type_name -> library.SearchEngine
	8,  // 33: library.SentencePos.status:type_name -> library.SentencePos.Status
	38, // 34: library.SentencePoses.sentence_poses:type_name -> library.SentencePos
	9,  // 35: library.Mean.status:type_name -> library.Mean.Status
	41, // 36: library.Means.means:type_name -> library.Mean
	41, // 37: library.Pos.means:type_name -> library.Mean
	61, // 38: library.Pos.word:type_name -> library.Word
	44, // 39: library.Poses.poses:type_name -> library.Pos
	10, // 40: library.Translation.status:type_name -> library.Translation.Status
	47, // 41: library.Translations.translations:type_name -> library.Translation
	11, // 42: library.Character.status:type_name -> library.Character.Status
	50, // 43: library.Characters.characters:type_name -> library.Character
	...
	55, // 46: library.Phrases.phrases:type_name -> library.Phrase
	14, // 47: library.Example.status:type_name -> library.Example.Status
	58, // 48: library.Examples.examples:type_name -> library.Example
	15, // 49: library.Word.status:type_name -> library.Word.Status
	61, // 50: library.Words.words:type_name -> library.Word
	17, // 51: library.LibraryService.ListCourses:input_type -> library.CourseRequest
	20, // 52: library.LibraryService.ListDocument:input_type -> library.DocumentRequest
	23, // 53: library.LibraryService.ListParagraph:input_type -> library.ParagraphRequest
	36, // 54: library.LibraryService.GetDataSearchEngine:input_type -> library.SearchEngineRequest
	26, // 55: library.LibraryService.ListSentence:input_type -> library.SentenceRequest
	26, // 56: library.LibraryService.StartLearnListen:input_type -> library.SentenceRequest
	16, // 57: library.LibraryService.EndLearnListen:input_type -> library.Listen
	45, // 58: library.LibraryService.GetPos:input_type -> library.PosRequest
	24, // 59: library.LibraryService.ApproveParagraph:input_type -> library.Paragraph
	39, // 60: library.LibraryService.ListSentencePos:input_type -> library.SentencePosRequest
	26, // 61: library.LibraryService.GetSentenceDetail:input_type -> library.SentenceRequest
	19, // 62: library.LibraryService.ListCourses:output_type -> library.Courses
	22, // 63: library.LibraryService.ListDocument:output_type -> library.Documents
	25, // 64: library.LibraryService.ListParagraph:output_type -> library.Paragraphs
	37, // 65: library.LibraryService.GetDataSearchEngine:output_type -> library.SearchEngines
	28, // 66: library.LibraryService.ListSentence:output_type -> library.Sentences
	28, // 67: library.LibraryService.StartLearnListen:output_type -> library.Sentences
	16, // 68: library.LibraryService.EndLearnListen:output_type -> library.Listen
	44, // 69: library.LibraryService.GetPos:output_type -> library.Pos
	24, // 70: library.LibraryService.ApproveParagraph:output_type -> library.Paragraph
	40, // 71: library.LibraryService.ListSentencePos:output_type -> library.SentencePoses
	27, // 72: library.LibraryService.GetSentenceDetail:output_type -> library.Sentence
