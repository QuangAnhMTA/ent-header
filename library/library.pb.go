...
var file_library_proto_rawDesc = []byte{
	...
	0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x22, 0x8b,
	...
	0x09, 0x52, 0x08, 0x6b, 0x65, 0x79, 0x77, 0x6f, 0x72, 0x64, 0x73, 0x12, 0x38, 0x0a, 0x06, 0x73,
	...
	0x61, 0x6c, 0x32, 0xff, 0x07, 0x0a, 0x0e, 0x4c, 0x69, 0x62, 0x72, 0x61, 0x72, 0x79, 0x53, 0x65,
	...
	0x65, 0x64, 0x67, 0x65, 0x42, 0x2b, 0x5a, 0x29, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_library_proto_enumTypes = make([]protoimpl.EnumInfo, 22)
var file_library_proto_msgTypes = make([]protoimpl.MessageInfo, 60)
var file_library_proto_goTypes = []interface{}{
	...
	(*Listen)(nil),                  // 22: library.Listen
	(*CourseRequest)(nil),           // 23: library.CourseRequest
	(*Course)(nil),                  // 24: library.Course
	(*Courses)(nil),                 // 25: library.Courses
	(*DocumentRequest)(nil),         // 26: library.DocumentRequest
	(*Document)(nil),                // 27: library.Document
	(*Documents)(nil),               // 28: library.Documents
	(*ParagraphRequest)(nil),        // 29: library.ParagraphRequest
	(*Paragraph)(nil),               // 30: library.Paragraph
	(*Paragraphs)(nil),              // 31: library.Paragraphs
	(*SentenceRequest)(nil),         // 32: library.SentenceRequest
	(*Sentence)(nil),                // 33: library.Sentence
	(*Sentences)(nil),               // 34: library.Sentences
	(*AudioRequest)(nil),            // 35: library.AudioRequest
	(*Audio)(nil),                   // 36: library.Audio
	(*Audios)(nil),                  // 37: library.Audios
	(*CourseTagRequest)(nil),        // 38: library.CourseTagRequest
	(*CourseTag)(nil),               // 39: library.CourseTag
	(*CourseTags)(nil),              // 40: library.CourseTags
	(*SearchEngine)(nil),            // 41: library.SearchEngine
	(*SearchEngineRequest)(nil),     // 42: library.SearchEngineRequest
	(*SearchEngines)(nil),           // 43: library.SearchEngines
	(*SentencePos)(nil),             // 44: library.SentencePos
	(*SentencePosRequest)(nil),      // 45: library.SentencePosRequest
	(*SentencePoses)(nil),           // 46: library.SentencePoses
	(*Mean)(nil),                    // 47: library.Mean
	(*MeanRequest)(nil),             // 48: library.MeanRequest
	(*Means)(nil),                   // 49: library.Means
	(*Pos)(nil),                     // 50: library.Pos
	(*PosRequest)(nil),              // 51: library.PosRequest
	(*Poses)(nil),                   // 52: library.Poses
	(*Translation)(nil),             // 53: library.Translation
	(*Translations)(nil),            // 54: library.Translations
	(*TranslationRequest)(nil),      // 55: library.TranslationRequest
	(*Character)(nil),               // 56: library.Character
	(*CharacterRequest)(nil),        // 57: library.CharacterRequest
	(*Characters)(nil),              // 58: library.Characters
	(*VoiceUsing)(nil),              // 59: library.VoiceUsing
	(*Voice)(nil),                   // 60: library.Voice
	(*Phrase)(nil),                  // 61: library.Phrase
	(*PhraseRequest)(nil),           // 62: library.PhraseRequest
	(*Phrases)(nil),                 // 63: library.Phrases
	(*Example)(nil),                 // 64: library.Example
	(*ExampleRequest)(nil),          // 65: library.ExampleRequest
	(*Examples)(nil),                // 66: library.Examples
	(*Word)(nil),                    // 67: library.Word
	(*WordRequest)(nil),             // 68: library.WordRequest
	(*Words)(nil),                   // 69: library.Words
	(*Phonetic)(nil),                // 70: library.Phonetic
	(*PhoneticRequest)(nil),         // 71: library.PhoneticRequest
	(*SentenceJob)(nil),             // 72: library.SentenceJob
	(*Pronounce)(nil),               // 73: library.Pronounce
	(*PronounceRequest)(nil),        // 74: library.PronounceRequest
	(*Pronounces)(nil),              // 75: library.Pronounces
	(*Knowledge)(nil),               // 76: library.Knowledge
	(*KnowledgeRequest)(nil),        // 77: library.KnowledgeRequest
	(*Knowledges)(nil),              // 78: library.Knowledges
	(*KnowledgeExample)(nil),        // 79: library.KnowledgeExample
	(*KnowledgeExampleRequest)(nil), // 80: library.KnowledgeExampleRequest
	(*KnowledgeExamples)(nil),       // 81: library.KnowledgeExamples
}
var file_library_proto_depIdxs = []int32{
	0,  // 0: library.Course.status:type_name -> library.Course.Status
	27, // 1: library.Course.documents:type_name -> library.Document
	24, // 2: library.Courses.courses:type_name -> library.Course
	1,  // 3: library.Document.status:type_name -> library.Document.Status
	30, // 4: library.Document.paragraphs:type_name -> library.Paragraph
	24, // 5: library.Document.course:type_name -> library.Course
	27, // 6: library.Documents.documents:type_name -> library.Document
	24, // 7: library.Documents.course:type_name -> library.Course
	...
	33, // 11: library.Paragraph.sentences:type_name -> library.Sentence
	27, // 12: library.Paragraph.document:type_name -> library.Document
	30, // 13: library.Paragraphs.paragraphs:type_name -> library.Paragraph
	27, // 14: library.Paragraphs.document:type_name -> library.Document
	5,  // 15: library.Sentence.status:type_name -> library.Sentence.Status
	36, // 16: library.Sentence.audios:type_name -> library.Audio
	53, // 17: library.Sentence.translation:type_name -> library.Translation
	30, // 18: library.Sentence.paragraph:type_name -> library.Paragraph
	44, // 19: library.Sentence.sentence_poses:type_name -> library.SentencePos
	61, // 20: library.Sentence.phrases:type_name -> library.Phrase
	33, // 21: library.Sentences.sentences:type_name -> library.Sentence
	56, // 22: library.Sentences.characters:type_name -> library.Character
	30, // 23: library.Sentences.pragraph:type_name -> library.Paragraph
	6,  // 24: library.Audio.status:type_name -> library.Audio.Status
	36, // 25: library.Audios.audios:type_name -> library.Audio
	39, // 26: library.CourseTags.courseTags:type_name -> library.CourseTag
	7,  // 27: library.SearchEngine.status:type_name -> library.SearchEngine.Status
	24, // 28: library.SearchEngine.courses:type_name -> library.Course
	27, // 29: library.SearchEngine.documents:type_name -> library.Document
	30, // 30: library.SearchEngine.paragraphs:type_name -> library.Paragraph
	41, // 31: library.SearchEngines.search_engines:type_name -> library.SearchEngine
	8,  // 32: library.SentencePos.status:type_name -> library.SentencePos.Status
	44, // 33: library.SentencePoses.sentence_poses:type_name -> library.SentencePos
	9,  // 34: library.Mean.status:type_name -> library.Mean.Status
	47, // 35: library.Means.means:type_name -> library.Mean
	47, // 36: library.Pos.means:type_name -> library.Mean
	67, // 37: library.Pos.word:type_name -> library.Word
	50, // 38: library.Poses.poses:type_name -> library.Pos
	10, // 39: library.Translation.status:type_name -> library.Translation.Status
	53, // 40: library.Translations.translations:type_name -> library.Translation
	11, // 41: library.Character.status:type_name -> library.Character.Status
	56, // 42: library.Characters.characters:type_name -> library.Character
	...
	61, // 45: library.Phrases.phrases:type_name -> library.Phrase
	14, // 46: library.Example.status:type_name -> library.Example.Status
	64, // 47: library.Examples.examples:type_name -> library.Example
	15, // 48: library.Word.status:type_name -> library.Word.Status
	67, // 49: library.Words.words:type_name -> library.Word
	...
	70, // 54: library.Pronounce.phonetics:type_name -> library.Phonetic
	73, // 55: library.Pronounces.pronounces:type_name -> library.Pronounce
	20, // 56: library.Knowledge.status:type_name -> library.Knowledge.Status
	79, // 57: library.Knowledge.knowledge_examples:type_name -> library.KnowledgeExample
	76, // 58: library.Knowledges.knowledges:type_name -> library.Knowledge
	21, // 59: library.KnowledgeExample.status:type_name -> library.KnowledgeExample.Status
	79, // 60: library.KnowledgeExamples.knowledge_examples:type_name -> library.KnowledgeExample
	23, // 61: library.LibraryService.ListCourses:input_type -> library.CourseRequest
	26, // 62: library.LibraryService.ListDocument:input_type -> library.DocumentRequest
	29, // 63: library.LibraryService.ListParagraph:input_type -> library.ParagraphRequest
	42, // 64: library.LibraryService.GetDataSearchEngine:input_type -> library.SearchEngineRequest
	32, // 65: library.LibraryService.ListSentence:input_type -> library.SentenceRequest
	32, // 66: library.LibraryService.StartLearnListen:input_type -> library.SentenceRequest
	22, // 67: library.LibraryService.EndLearnListen:input_type -> library.Listen
	51, // 68: library.LibraryService.GetPos:input_type -> library.PosRequest
	30, // 69: library.LibraryService.ApproveParagraph:input_type -> library.Paragraph
	45, // 70: library.LibraryService.ListSentencePos:input_type -> library.SentencePosRequest
	32, // 71: library.LibraryService.GetSentenceDetail:input_type -> library.SentenceRequest
	74, // 72: library.LibraryService.ListPronounce:input_type -> library.PronounceRequest
	74, // 73: library.LibraryService.GetPronounce:input_type -> library.PronounceRequest
	45, // 74: library.LibraryService.ListSentencePoses:input_type -> library.SentencePosRequest
	77, // 75: library.LibraryService.ListKnowledge:input_type -> library.KnowledgeRequest
	76, // 76: library.LibraryService.GetKnowledge:input_type -> library.Knowledge
	25, // 77: library.LibraryService.ListCourses:output_type -> library.Courses
	28, // 78: library.LibraryService.ListDocument:output_type -> library.Documents
	31, // 79: library.LibraryService.ListParagraph:output_type -> library.Paragraphs
	43, // 80: library.LibraryService.GetDataSearchEngine:output_type -> library.SearchEngines
	34, // 81: library.LibraryService.ListSentence:output_type -> library.Sentences
	34, // 82: library.LibraryService.StartLearnListen:output_type -> library.Sentences
	22, // 83: library.LibraryService.EndLearnListen:output_type -> library.Listen
	50, // 84: library.LibraryService.GetPos:output_type -> library.Pos
	30, // 85: library.LibraryService.ApproveParagraph:output_type -> library.Paragraph
	46, // 86: library.LibraryService.ListSentencePos:output_type -> library.SentencePoses
	33, // 87: library.LibraryService.GetSentenceDetail:output_type -> library.Sentence
	75, // 88: library.LibraryService.ListPronounce:output_type -> library.Pronounces
	73, // 89: library.LibraryService.GetPronounce:output_type -> library.Pronounce
	46, // 90: library.LibraryService.ListSentencePoses:output_type -> library.SentencePoses
	78, // 91: library.LibraryService.ListKnowledge:output_type -> library.Knowledges
	76, // 92: library.LibraryService.GetKnowledge:output_type -> library.Knowledge
