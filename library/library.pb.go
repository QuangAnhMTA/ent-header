...
type TagDetails struct {
	...
	Total      int32  `protobuf:"varint,1,opt,name=total,proto3" json:"total,omitempty"`
	TagDetails []*Tag `protobuf:"bytes,2,rep,name=tag_details,json=tagDetails,proto3" json:"tag_details,omitempty"`
...
func (x *TagDetails) GetTagDetails() []*Tag {
	if x != nil {
		return x.TagDetails
	}
	return nil
...
var file_library_proto_rawDesc = []byte{
	...
	0x22, 0xed, 0x01, 0x0a, 0x09, 0x54, 0x61, 0x67, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x12, 0x0e,
	...
	0x2e, 0x54, 0x61, 0x67, 0x52, 0x03, 0x54, 0x61, 0x67, 0x22, 0x35, 0x0a, 0x06, 0x53, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x12, 0x11, 0x0a, 0x0d, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x5f, 0x73,
	0x74, 0x61, 0x74, 0x65, 0x10, 0x00, 0x12, 0x0c, 0x0a, 0x08, 0x64, 0x65, 0x61, 0x63, 0x74, 0x69,
	0x76, 0x65, 0x10, 0x01, 0x12, 0x0a, 0x0a, 0x06, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x10, 0x02,
	...
	0x28, 0x09, 0x52, 0x04, 0x63, 0x6f, 0x6c, 0x73, 0x12, 0x1a, 0x0a, 0x08, 0x69, 0x6e, 0x63, 0x6c,
	0x75, 0x64, 0x65, 0x73, 0x18, 0x13, 0x20, 0x03, 0x28, 0x09, 0x52, 0x08, 0x69, 0x6e, 0x63, 0x6c,
	0x75, 0x64, 0x65, 0x73, 0x22, 0x71, 0x0a, 0x0a, 0x54, 0x61, 0x67, 0x44, 0x65, 0x74, 0x61, 0x69,
	0x6c, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x05, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x12, 0x2d, 0x0a, 0x0b, 0x74, 0x61, 0x67, 0x5f,
	0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0c, 0x2e,
	0x6c, 0x69, 0x62, 0x72, 0x61, 0x72, 0x79, 0x2e, 0x54, 0x61, 0x67, 0x52, 0x0a, 0x74, 0x61, 0x67,
...
var file_library_proto_depIdxs = []int32{
	...
	84, // 66: library.TagDetails.tag_details:type_name -> library.Tag
	84, // 67: library.TagDetails.tag:type_name -> library.Tag
	90, // 68: library.Labels.labels:type_name -> library.Label
	25, // 69: library.LibraryService.ListCourses:input_type -> library.CourseRequest
	28, // 70: library.LibraryService.ListDocument:input_type -> library.DocumentRequest
	31, // 71: library.LibraryService.ListParagraph:input_type -> library.ParagraphRequest
	44, // 72: library.LibraryService.GetDataSearchEngine:input_type -> library.SearchEngineRequest
	34, // 73: library.LibraryService.ListSentence:input_type -> library.SentenceRequest
	34, // 74: library.LibraryService.StartLearnListen:input_type -> library.SentenceRequest
	24, // 75: library.LibraryService.EndLearnListen:input_type -> library.Listen
	53, // 76: library.LibraryService.GetPos:input_type -> library.PosRequest
	32, // 77: library.LibraryService.ApproveParagraph:input_type -> library.Paragraph
	47, // 78: library.LibraryService.ListSentencePos:input_type -> library.SentencePosRequest
	34, // 79: library.LibraryService.GetSentenceDetail:input_type -> library.SentenceRequest
	76, // 80: library.LibraryService.ListPronounce:input_type -> library.PronounceRequest
	76, // 81: library.LibraryService.GetPronounce:input_type -> library.PronounceRequest
	47, // 82: library.LibraryService.ListSentencePoses:input_type -> library.SentencePosRequest
	79, // 83: library.LibraryService.ListKnowledge:input_type -> library.KnowledgeRequest
	78, // 84: library.LibraryService.GetKnowledge:input_type -> library.Knowledge
	88, // 85: library.LibraryService.ListTagDetail:input_type -> library.TagDetailRequest
	27, // 86: library.LibraryService.ListCourses:output_type -> library.Courses
	30, // 87: library.LibraryService.ListDocument:output_type -> library.Documents
	33, // 88: library.LibraryService.ListParagraph:output_type -> library.Paragraphs
	45, // 89: library.LibraryService.GetDataSearchEngine:output_type -> library.SearchEngines
	36, // 90: library.LibraryService.ListSentence:output_type -> library.Sentences
	36, // 91: library.LibraryService.StartLearnListen:output_type -> library.Sentences
	24, // 92: library.LibraryService.EndLearnListen:output_type -> library.Listen
	52, // 93: library.LibraryService.GetPos:output_type -> library.Pos
	32, // 94: library.LibraryService.ApproveParagraph:output_type -> library.Paragraph
	48, // 95: library.LibraryService.ListSentencePos:output_type -> library.SentencePoses
	35, // 96: library.LibraryService.GetSentenceDetail:output_type -> library.Sentence
	77, // 97: library.LibraryService.ListPronounce:output_type -> library.Pronounces
	75, // 98: library.LibraryService.GetPronounce:output_type -> library.Pronounce
	48, // 99: library.LibraryService.ListSentencePoses:output_type -> library.SentencePoses
	80, // 100: library.LibraryService.ListKnowledge:output_type -> library.Knowledges
	78, // 101: library.LibraryService.GetKnowledge:output_type -> library.Knowledge
	89, // 102: library.LibraryService.ListTagDetail:output_type -> library.TagDetails
